...
fn billing_checkout_portal_boundary_generated_typescript_matches_checked_in_file() {
    let generated = billing_checkout_portal_boundary_ts::BILLING_CHECKOUT_PORTAL_BOUNDARY_TYPESCRIPT;
    let file_path = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        .join("../../packages/schema-domain/src/generated-billing-checkout-portal-boundary.ts");
    let checked_in =
        read_to_string(file_path).expect("read generated billing checkout portal boundary ts");
