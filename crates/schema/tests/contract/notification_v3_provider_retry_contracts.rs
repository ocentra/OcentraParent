...
fn notification_v3_provider_retry_generated_typescript_matches_checked_in_file() {
    ...
    let checked_in = read_to_string(file_path).expect("read generated notification v3 provider retry ts");

    assert!(checked_in.starts_with("/* generated from crates/schema/src/notification_v3_provider_retry_ts.rs */"));
