...
fn browser_generated_values_typescript_stays_checked_in() {
    assert_eq!(
        include_str!("../../../../packages/schema-domain/src/generated-browser-ai-analysis-values.ts"),
        browser_ai_analysis_values_typescript()
    );
    assert_eq!(
        include_str!("../../../../packages/schema-domain/src/generated-browser-control-identifiers.ts"),
        browser_control_identifiers_typescript()
    );
    assert_eq!(
        include_str!("../../../../packages/schema-domain/src/generated-browser-control-manifest.ts"),
    ...
    assert_eq!(
        include_str!("../../../../packages/schema-domain/src/generated-browser-unmanaged-process-schemas.ts"),
