...
#[path = "../../src/billing_invoice_tax_refund_dispute_ts.rs"]
mod billing_invoice_tax_refund_dispute_ts;

#[test]
fn billing_invoice_tax_refund_dispute_generated_typescript_matches_checked_in_file() {
    let generated =
