...
pub fn data_custody_source_of_truth_contracts_typescript() -> String {
    ...
    let template = r#"/* generated from crates/schema/src/data_custody_source_of_truth.rs */
...
export const GeneratedDataCustodySourceOfTruthContractProof = __PROOF_JSON__ as const satisfies GeneratedDataCustodySourceOfTruthContractProof;
"#;
