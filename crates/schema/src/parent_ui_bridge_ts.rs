pub const PARENT_UI_BRIDGE_TYPESCRIPT: &str = r#"/* generated from crates/schema/src/parent_ui_bridge.rs */
...
#[cfg(test)]
mod tests {
    use super::PARENT_UI_BRIDGE_TYPESCRIPT;

    #[test]
    fn parent_ui_bridge_typescript_artifact_is_current() {
        assert_eq!(
            include_str!("../../../apps/portal/src/generated/parent-ui-bridge.ts"),
