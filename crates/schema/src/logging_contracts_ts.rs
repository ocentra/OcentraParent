...
const LOGGING_CONTRACTS_TYPESCRIPT_TEMPLATE: &str = r#"/* generated from crates/schema/src/logging_contracts.rs */

export const LoggingContractRuntime = {
  SchemaVersion: __LOG_SCHEMA_VERSION__,
  SnapshotSchemaVersion: __LOG_SNAPSHOT_SCHEMA_VERSION__,
} as const;
