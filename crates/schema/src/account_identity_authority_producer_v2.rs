...
pub const ACCOUNT_IDENTITY_AUTHORITY_PRODUCER_V2_PAYLOAD_DIGEST_PREFIX: &str = "sha256:";
pub const ACCOUNT_IDENTITY_AUTHORITY_PRODUCER_V2_SIGNED_TRANSPORT_DIGEST_PREFIX: &str =
    "sha256:signed-transport:";
