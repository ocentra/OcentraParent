pub fn social_video_ai_signal_aggregate_typescript() -> String {
    SocialVideoAiSignalAggregate_TYPESCRIPT.to_string()
}

const SocialVideoAiSignalAggregate_TYPESCRIPT: &str = r#"/* generated from crates/browser-core/src/social_video_ai_signal_aggregate.rs */
