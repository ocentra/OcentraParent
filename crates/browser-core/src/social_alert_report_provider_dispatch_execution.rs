pub fn social_alert_report_provider_dispatch_execution_typescript() -> String {
    SocialAlertReportProviderDispatchExecution_TYPESCRIPT.to_string()
}

const SocialAlertReportProviderDispatchExecution_TYPESCRIPT: &str = r#"/* generated from crates/browser-core/src/social_alert_report_provider_dispatch_execution.rs */
