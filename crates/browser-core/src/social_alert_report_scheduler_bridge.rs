pub fn social_alert_report_scheduler_bridge_typescript() -> String {
    SocialAlertReportSchedulerBridge_TYPESCRIPT.to_string()
}

const SocialAlertReportSchedulerBridge_TYPESCRIPT: &str = r#"/* generated from crates/browser-core/src/social_alert_report_scheduler_bridge.rs */
