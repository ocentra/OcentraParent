pub fn social_alert_report_local_outbox_bridge_typescript() -> String {
    SocialAlertReportLocalOutboxBridge_TYPESCRIPT.to_string()
}

const SocialAlertReportLocalOutboxBridge_TYPESCRIPT: &str = r#"/* generated from crates/browser-core/src/social_alert_report_local_outbox_bridge.rs */
