pub fn social_applied_schedule_time_budget_proof_typescript() -> String {
    SocialAppliedScheduleTimeBudgetProof_TYPESCRIPT.to_string()
}

const SocialAppliedScheduleTimeBudgetProof_TYPESCRIPT: &str = r#"/* generated from crates/browser-core/src/social_applied_schedule_time_budget_proof.rs */
