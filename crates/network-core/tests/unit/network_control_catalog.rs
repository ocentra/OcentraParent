use ocentra_network_core::network_control_catalog::{
    capability_requirement_for, capability_state_for, capability_state_from_source_state,
    card_kind_for, control_kind_for, effect_status_for, explicit_option_labels, fallback_for,
    helper_text_for, layout_hints_for, policy_lane_for, proof_requirement_for,
    question_from_source_text, runtime_owner_for, selection_mode_for, slug_token, title_from_token,
