...
#[path = "unit/browser_runtime_tests.rs"]
...
fn browser_runtime_harness_links_status_variants_and_inventory_payload() {
    ...
    assert_eq!(
        payload[ocentra_parent_agent_protocol::constants::field::RETURNED],
        ocentra_parent_agent_protocol::logging::LogFieldValue::Number(0.0)
    );
    assert_eq!(
        payload[ocentra_parent_agent_protocol::constants::field::BROWSER_FAMILY],
