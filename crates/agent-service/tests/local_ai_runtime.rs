...
#[path = "unit/local_ai_chat_generation_request_tests.rs"]
...
#[path = "unit/local_ai_chat_generation_tests.rs"]
...
#[path = "unit/local_ai_model_registry_tests.rs"]
mod local_ai_model_registry_tests;
#[path = "unit/local_ai_model_request_status_tests.rs"]
...
#[path = "unit/local_ai_provider_scheduler_tests.rs"]
...
#[path = "unit/local_ai_runtime_acceleration_tests.rs"]
...
#[path = "unit/local_ai_runtime_payload_tests.rs"]
...
#[path = "unit/local_ai_runtime_provider_proof_read_model_tests.rs"]
...
#[path = "unit/local_ai_runtime_status_tests.rs"]
...
fn local_ai_runtime_smoke_uses_event_builder_json_and_invariants_helpers() {
    ...
    let epoch = time::timestamp_from_epoch_seconds(0);
    let later = time::timestamp_after_epoch_seconds(0, 1);
    ...
    let log_field = LogFieldValue::String(serialized.clone());
