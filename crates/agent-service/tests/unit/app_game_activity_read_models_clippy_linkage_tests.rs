...
fn app_game_activity_read_models_clippy_linkage() {
    ...
    let _ = super::dev_log::write_agent_info;
    let _ = super::dev_log::write_agent_warn;
    let _ = super::dev_log::write_agent_error;
    let _ = super::dev_log::write_agent_debug;
    ...
    let _ = super::event_builder::build_event;
    ...
    let _ = super::time::timestamp_from_epoch_seconds;
    let _ = super::time::timestamp_after_epoch_seconds;
