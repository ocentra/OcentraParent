...
fn missing_browser_status_reports_typed_degraded_state() {
    ...
    assert_eq!(
        crate::test_invariants::log_field(&payload, constants::field::MANAGED_STATE, constants::error::AGENT_EVENT_SERIALIZES),
        LogFieldValue::String(constants::browser::MANAGED_STATE_NOT_INSTALLED.to_string())
    );
    assert_eq!(
        crate::test_invariants::log_field(&payload, constants::field::REASON, constants::error::AGENT_EVENT_SERIALIZES),
        LogFieldValue::String(constants::value::MANAGED_BROWSER_EXECUTABLE_MISSING.to_string())
    );
    assert_eq!(
        crate::test_invariants::log_field(&payload, constants::field::QUERY_VISIBILITY, constants::error::AGENT_EVENT_SERIALIZES),
...
fn unmanaged_browser_status_reports_discoverable_but_unmanaged_process() {
    ...
    assert_eq!(
        crate::test_invariants::log_field(&payload, constants::field::BROWSER_FAMILY, constants::error::AGENT_EVENT_SERIALIZES),
    ...
    assert_eq!(
        crate::test_invariants::log_field(&payload, constants::field::UNMANAGED_PROCESS_NAME, constants::error::AGENT_EVENT_SERIALIZES),
        LogFieldValue::String(constants::browser::EXECUTABLE_CHROME_WINDOWS.to_string())
    );
    assert_eq!(
        crate::test_invariants::log_field(&payload, constants::field::UNMANAGED_PROCESS_KIND, constants::error::AGENT_EVENT_SERIALIZES),
...
fn managed_profile_ready_status_is_headless_until_explicit_launch() {
    ...
    assert_eq!(
        crate::test_invariants::log_field(&payload, constants::field::PROCESS_ID, constants::error::AGENT_EVENT_SERIALIZES),
        LogFieldValue::Null(())
    );
    assert_eq!(
        crate::test_invariants::log_field(&payload, constants::field::STARTED_AT, constants::error::AGENT_EVENT_SERIALIZES),
        LogFieldValue::Null(())
    );
    assert_eq!(
        crate::test_invariants::log_field(&payload, constants::field::PROFILE_ROOT_REF, constants::error::AGENT_EVENT_SERIALIZES),
        LogFieldValue::String(constants::browser::PROFILE_ROOT_REF_MANAGED.to_string())
    );
    assert_eq!(
        crate::test_invariants::log_field(&payload, constants::field::PROFILE_LIFECYCLE_STATE, constants::error::AGENT_EVENT_SERIALIZES),
...
fn bridge_disconnected_status_reports_stale_bridge_state() {
    ...
    assert_eq!(
        crate::test_invariants::log_field(&payload, constants::field::CAPABILITY_STATUS, constants::error::AGENT_EVENT_SERIALIZES),
