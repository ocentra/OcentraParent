...
#[path = "windows_adapter_artifact_gate_read_model_tests.rs"]
...
#[path = "windows_adapter_artifact_ingestion_read_model_tests.rs"]
...
#[path = "windows_adapter_capability_read_model_tests.rs"]
