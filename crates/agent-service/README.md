...
- App/game live process, optional foreground, and Windows shortcut inventory
  capture have bounded service proof; subscribed foreground transitions,
  registry/Store inventory, policy consumption, portal source/status polish,
  and adapter execution remain separate gaps.
