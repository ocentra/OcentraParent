use ocentra_parent_agent_core::{ScreenRuntimeInput, ScreenRuntimeReport};
use ocentra_parent_agent_protocol::{
    ActivityScreenReadModelRow, SCREEN_DELETION_DELETED, SCREEN_DELETION_EXPIRED_DELETED,
};
