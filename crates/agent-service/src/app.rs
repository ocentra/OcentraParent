...
use crate::{
    ...
    lan_pairing_runtime_state::{
        ...
        passive_discovery::{
            LanPassiveDiscoveryServiceRuntime, start_lan_passive_discovery_service_runtime,
        },
    },
...
pub struct AppState {
    ...
    platform_probe_cache: PlatformProbeCache,
...
pub fn router(network: NetworkPolicy) -> Router {
    ...
    let state = AppState {
        ...
        platform_probe_cache: PlatformProbeCache::new(),
...
async fn websocket(
    ...
    let provenance = if peer_addr.ip().is_loopback() {
        ...
        PlatformProbeRequestProvenance::LocalNetwork
    };
