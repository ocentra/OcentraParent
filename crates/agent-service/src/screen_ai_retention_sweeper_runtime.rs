...
use ocentra_parent_agent_protocol::{
    ...
    SCREEN_DELETION_EXPIRED_DELETED, SCREEN_EVIDENCE_SCHEMA_VERSION,
    SCREEN_PROVIDER_SERVICE_METADATA, SCREEN_SERVICE_DEFAULT_QUEUE_DIR_NAME,
    SCREEN_SERVICE_METADATA_CONFIDENCE, SCREEN_SERVICE_QUEUE_DIR_ENV,
    SCREEN_SERVICE_RETENTION_DELETE_PROOF_ID_PREFIX, SCREEN_SERVICE_RETENTION_EVENT_ID_PREFIX,
    SCREEN_SERVICE_RETENTION_EVIDENCE_ID_PREFIX, SCREEN_SERVICE_RETENTION_MODEL_ID,
    SCREEN_SERVICE_RETENTION_MODEL_RUNTIME_REF, SCREEN_SERVICE_RETENTION_RESULT_ID_PREFIX,
...
fn expired_entry_event(
    ...
    let evidence = vec![ActivityEvidenceRef {
        evidence_id: prefixed_id(
            SCREEN_SERVICE_RETENTION_EVIDENCE_ID_PREFIX,
            &entry.queue_job_id,
        ),
    ...
    ActivityEvent {
        ...
        event_id: prefixed_id(SCREEN_SERVICE_RETENTION_EVENT_ID_PREFIX, &entry.queue_job_id),
        ...
        subject: ActivitySubject {
            ...
            display_name: SCREEN_SERVICE_RETENTION_SWEEPER_SOURCE_ID.to_string(),
        },
...
fn expired_entry_fields(entry: &ScreenEvidenceExpiredQueueEntry) -> Vec<(&'static str, LogFieldValue)> {
    vec![
        string_field(
            constants::field::SCREEN_ANALYSIS_RESULT_ID,
            prefixed_id(SCREEN_SERVICE_RETENTION_RESULT_ID_PREFIX, &entry.queue_job_id),
        ),
        string_field(
        ...
        string_field(constants::field::SCREEN_CUSTODY_STATE, SCREEN_CUSTODY_JOURNAL),
    ]
}
