    ...
    C: IntoEventCorrelationIdText,
{
    ...
    event_id.push(ocentra_parent_agent_protocol::constants::delimiter::HYPHEN);
    ...
    ocentra_parent_agent_protocol::transport::AgentEventEnvelope {
        ...
        sent_at: crate::time::timestamp_now(),
        source: ocentra_parent_agent_protocol::transport::AgentPeer {
            peer_id: ocentra_parent_agent_protocol::constants::peer::LOCAL_DEV_AGENT.to_string(),
            role: ocentra_parent_agent_protocol::transport::AgentPeerRole::AgentService,
        },
        target,
        event,
        severity,
