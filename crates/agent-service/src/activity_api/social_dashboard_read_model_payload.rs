use ocentra_parent_agent_protocol::{
    ...
    SOCIAL_DASHBOARD_CAPABILITY_READY, SOCIAL_DASHBOARD_CHILD_PROFILE_ID,
    ...
    SOCIAL_DASHBOARD_EVIDENCE_NATIVE_APP_CAPABILITY, SOCIAL_DASHBOARD_FAMILY_ID,
    SOCIAL_DASHBOARD_PANEL_ACCOUNT_APPROVAL_QUEUE, SOCIAL_DASHBOARD_PANEL_CONNECTOR_BOUNDARIES,
    SOCIAL_DASHBOARD_PANEL_DECISION_MEMORY, SOCIAL_DASHBOARD_PANEL_FEED_VIDEO_GATES,
    SOCIAL_DASHBOARD_PANEL_MANUAL_REQUIRED_GAPS, SOCIAL_DASHBOARD_PANEL_NATIVE_APP_CAPABILITY,
    ...
    SOCIAL_DASHBOARD_SEVERITY_WARNING, SOCIAL_DASHBOARD_STATUS_CONTRACT_ONLY,
    SOCIAL_DASHBOARD_STATUS_MANUAL_REQUIRED, SOCIAL_DASHBOARD_STATUS_READY_FOR_REVIEW,
};
