use ocentra_parent_agent_protocol::{
    ...
    LogLevel, SocialDashboardClaimBoundaries, SocialDashboardPanel, SocialDashboardUxSnapshot,
    SOCIAL_DASHBOARD_ACTION_MANUAL_REVIEW, SOCIAL_DASHBOARD_ACTION_OPEN_PARENT_APPROVAL,
    SOCIAL_DASHBOARD_ACTION_REVIEW_CONNECTOR_BOUNDARY, SOCIAL_DASHBOARD_ACTION_REVIEW_FEED_GATE,
    SOCIAL_DASHBOARD_ACTION_REVIEW_MEMORY_ENTRY, SOCIAL_DASHBOARD_ACTION_REVIEW_NATIVE_CAPABILITY,
    SOCIAL_DASHBOARD_ACTION_REVIEW_SETTINGS_CUSTODY, SOCIAL_DASHBOARD_CAPABILITY_READY,
    SOCIAL_DASHBOARD_CHILD_PROFILE_ID, SOCIAL_DASHBOARD_CLAIM_NOT_CLAIMED,
    SOCIAL_DASHBOARD_CUSTODY_CHILD_DEVICE_QUERY_STORE,
    SOCIAL_DASHBOARD_EVIDENCE_ACCOUNT_APPROVAL_QUEUE,
    SOCIAL_DASHBOARD_EVIDENCE_CONNECTOR_BOUNDARIES, SOCIAL_DASHBOARD_EVIDENCE_DECISION_MEMORY,
    SOCIAL_DASHBOARD_EVIDENCE_FEED_VIDEO_GATES, SOCIAL_DASHBOARD_EVIDENCE_MANUAL_REQUIRED_GAPS,
    SOCIAL_DASHBOARD_EVIDENCE_NATIVE_APP_CAPABILITY, SOCIAL_DASHBOARD_EVIDENCE_SETTINGS_CUSTODY,
    SOCIAL_DASHBOARD_FAMILY_ID, SOCIAL_DASHBOARD_PANEL_ACCOUNT_APPROVAL_QUEUE,
    SOCIAL_DASHBOARD_PANEL_CONNECTOR_BOUNDARIES, SOCIAL_DASHBOARD_PANEL_DECISION_MEMORY,
    SOCIAL_DASHBOARD_PANEL_FEED_VIDEO_GATES, SOCIAL_DASHBOARD_PANEL_MANUAL_REQUIRED_GAPS,
    SOCIAL_DASHBOARD_PANEL_NATIVE_APP_CAPABILITY, SOCIAL_DASHBOARD_PANEL_SETTINGS_CUSTODY,
    ...
    SOCIAL_DASHBOARD_REASON_PARENT_REVIEW_NEEDED, SOCIAL_DASHBOARD_REASON_PLATFORM_PROOF_GAP,
    SOCIAL_DASHBOARD_REASON_SETTINGS_CUSTODY_RUNTIME_GAP, SOCIAL_DASHBOARD_SCHEMA_VERSION,
    SOCIAL_DASHBOARD_SEVERITY_INFO, SOCIAL_DASHBOARD_SEVERITY_WARNING,
    SOCIAL_DASHBOARD_STATUS_CONTRACT_ONLY, SOCIAL_DASHBOARD_STATUS_MANUAL_REQUIRED,
