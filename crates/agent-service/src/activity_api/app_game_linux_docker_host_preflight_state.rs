use ocentra_parent_agent_protocol::{
    ...
    app_game_platform_proof_status::{
        AppGameLinuxDockerHostPreflight, APP_GAME_LINUX_DOCKER_PREFLIGHT_DAEMON_UNAVAILABLE,
        APP_GAME_LINUX_DOCKER_PREFLIGHT_NOT_DETECTED, APP_GAME_LINUX_DOCKER_PREFLIGHT_PARTIAL,
        APP_GAME_LINUX_DOCKER_PREFLIGHT_PROBE_UNAVAILABLE, APP_GAME_LINUX_DOCKER_PREFLIGHT_READY,
...
impl DockerPreflightState {
    ...
    pub(super) const NOT_DETECTED: Self = Self(APP_GAME_LINUX_DOCKER_PREFLIGHT_NOT_DETECTED);
