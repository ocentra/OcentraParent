...
#[test]
fn windows_adapter_artifact_gate_refuses_missing_app_artifacts() {
...
#[test]
fn windows_adapter_artifact_gate_allows_manual_review_only_after_app_artifact_refs() {
...
#[test]
fn windows_adapter_artifact_gate_keeps_browser_and_unsupported_claims_blocked() {
    let proof = windows_adapter_artifact_gate_proof(policy::TEST_EVALUATED_AT);
...
#[test]
fn windows_adapter_artifact_gate_rejects_audit_artifacts_without_custody_event_ids() {
