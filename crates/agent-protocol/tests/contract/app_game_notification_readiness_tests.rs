...
fn app_game_notification_readiness_read_model_serializes_no_delivery_claims() {
    let read_model = AppGameNotificationReadinessReadModel {
        ...
        rows: vec![AppGameNotificationReadinessRow {
            ...
            readiness_state: APP_GAME_NOTIFICATION_READINESS_STATE_READY_FOR_LOCAL_INTENT
                .to_string(),
            row_count: 1,
            minimal_payload_ref: APP_GAME_NOTIFICATION_READINESS_MINIMAL_PAYLOAD_TIME_LIMIT
                .to_string(),
