...
fn social_alert_report_snapshot_serializes_no_claim_boundaries() {
    let snapshot = SocialAlertReportReadModelSnapshot {
        ...
        provider_status_rows: vec![
            ocentra_parent_agent_protocol::SocialAlertReportProviderStatusRow {
                status_entry_id: SOCIAL_ALERT_REPORT_PROVIDER_STATUS_MANUAL.to_string(),
                source_intent_ref: SOCIAL_ALERT_REPORT_PROVIDER_PREFLIGHT_MANUAL_REQUIRED
                    .to_string(),
                ...
                status_proof_state: SOCIAL_ALERT_REPORT_PROVIDER_STATUS_PROOF_MANUAL_ACTION
                    .to_string(),
                delivery_claim_state: SOCIAL_ALERT_REPORT_PROVIDER_DELIVERY_NOT_OBSERVED
                    .to_string(),
    ...
    assert!(json.contains("providerStatusRows"));
    assert!(json.contains("providerReceiptRefs"));
