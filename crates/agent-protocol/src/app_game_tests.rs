use super::{
    ...
    APP_GAME_TEST_FILE_HASH_REF, APP_GAME_TEST_LAUNCHER_APP_ID,
    APP_GAME_TEST_LAUNCHER_MANIFEST_ID, APP_GAME_TEST_LAUNCHER_REF,
    APP_GAME_TEST_LAUNCHER_SOURCE_REF, APP_GAME_TEST_PARENT_PROCESS_ID,
    APP_GAME_TEST_PROCESS_ID, APP_GAME_TEST_PROCESS_IDENTITY, APP_GAME_TEST_PROCESS_NAME,
    APP_GAME_TEST_PUBLISHER_SIGNATURE_REF, APP_GAME_TEST_RUNTIME_EVIDENCE_ID,
    APP_GAME_TEST_REGISTRY_SOURCE_REF, APP_GAME_TEST_STORE_GAME_BUNDLE_ID,
...
fn app_game_runtime_evidence_row_serializes_process_runtime_without_foreground_claim() {
    ...
    assert_eq!(serialized["processIdentity"], APP_GAME_TEST_PROCESS_IDENTITY);
