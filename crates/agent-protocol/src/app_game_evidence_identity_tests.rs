use super::{
    constants, AppGameAiClassificationDigest, AppGameAiDigestReference, AppGameEvidenceClaim,
    AppGameIdentity, AppGameIdentityMergeProof, APP_GAME_AI_ACTION_HINT_CLASSIFY_ONLY,
    APP_GAME_AI_ACTION_HINT_PARENT_REVIEW, APP_GAME_CATALOG_READY,
    APP_GAME_CLASSIFICATION_KNOWN_GAME, APP_GAME_CLASSIFICATION_POSSIBLY_GAME,
    APP_GAME_EVIDENCE_CLAIM_KIND_INVENTORY, APP_GAME_FOREGROUND_NOT_CLAIMED,
    APP_GAME_IDENTITY_CONFIDENCE_DETERMINISTIC, APP_GAME_IDENTITY_DETERMINISTIC_REF_FILE_HASH_REF,
    APP_GAME_IDENTITY_DETERMINISTIC_REF_STORE_ID, APP_GAME_IDENTITY_STRENGTH_CATALOG_MATCHED,
    APP_GAME_OBSERVATION_MODE_INVENTORY_SCAN, APP_GAME_PRODUCT_NATIVE_GAME,
    APP_GAME_RUNTIME_NOT_CLAIMED, APP_GAME_SCHEMA_VERSION, APP_GAME_TEST_AI_DIGEST,
    APP_GAME_TEST_AI_DIGEST_REF, APP_GAME_TEST_CATALOG_REF, APP_GAME_TEST_DISPLAY_LABEL,
    APP_GAME_TEST_EVIDENCE_CLAIM_ID, APP_GAME_TEST_EXECUTABLE_PATH_REF,
    APP_GAME_TEST_FILE_HASH_REF, APP_GAME_TEST_IDENTITY_ID, APP_GAME_TEST_LAUNCHER_APP_ID,
    APP_GAME_TEST_LAUNCHER_CHILD_GAME_CLAIM_ID, APP_GAME_TEST_LAUNCHER_MANIFEST_ID,
    APP_GAME_TEST_LAUNCHER_REF, APP_GAME_TEST_LAUNCHER_SOURCE_REF, APP_GAME_TEST_MERGE_ID,
    APP_GAME_TEST_PARENT_LABEL, APP_GAME_TEST_PUBLISHER_SIGNATURE_REF,
    APP_GAME_TEST_RUNTIME_EVIDENCE_ID, APP_GAME_TEST_SECOND_IDENTITY_ID,
    APP_GAME_TEST_STORE_GAME_BUNDLE_ID, APP_GAME_TEST_STORE_GAME_PACKAGE_ID,
