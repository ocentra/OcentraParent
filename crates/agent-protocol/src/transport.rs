...
pub enum AgentCommandName {
    ...
    #[serde(rename = "agent.network.product-readiness.status.get")]
    AgentNetworkProductReadinessStatusGet,
...
pub enum AgentEventName {
    ...
    #[serde(rename = "agent.network.product-readiness.status.reported")]
    AgentNetworkProductReadinessStatusReported,
