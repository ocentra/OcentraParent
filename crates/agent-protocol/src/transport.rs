...
pub enum AgentCommandName {
    ...
    #[serde(rename = "agent.activity.tracking.retention-settings.mutate")]
    AgentActivityTrackingRetentionSettingsMutate,
...
pub enum AgentEventName {
    ...
    #[serde(rename = "agent.activity.tracking.retention-settings.mutation.reported")]
    AgentActivityTrackingRetentionSettingsMutationReported,
