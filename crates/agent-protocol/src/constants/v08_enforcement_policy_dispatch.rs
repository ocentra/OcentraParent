...
pub const INTENT_APP_GAME_CATEGORY_RISK_DRY_RUN: &str = "dispatch-app-game-category-risk-dry-run";
...
pub const MATRIX_APP_GAME_CATEGORY_RISK_DRY_RUN: &str = "matrix-app-game-category-risk-dry-run";
...
pub const TARGET_APP_GAME_CATEGORY_RISK_ROUTE: &str = "app-category:category-risk-route";
...
pub const EVIDENCE_APP_GAME_CATEGORY_RISK_POLICY_ROUTE: &str =
    "evidence-app-game-category-risk-policy-route";
...
pub const OUTCOME_DRY_RUN_ONLY: &str = "dry-run-only";
...
pub const CHILD_REASON_CATEGORY_RISK_POLICY_PREVIEW: &str =
    "child-reason-category-risk-policy-preview";
