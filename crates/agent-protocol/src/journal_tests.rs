...
fn activity_journal_line_serializes_to_typescript_contract_shape() {
    ...
    let serialized = serde_json::to_value(line).expect("journal line serializes");
...
fn activity_journal_status_serializes_to_typescript_contract_shape() {
    ...
    let serialized = serde_json::to_value(status).expect("journal status serializes");
...
fn activity_journal_rotation_policy_serializes_to_typescript_contract_shape() {
    ...
    let serialized = serde_json::to_value(policy).expect("journal rotation policy serializes");
