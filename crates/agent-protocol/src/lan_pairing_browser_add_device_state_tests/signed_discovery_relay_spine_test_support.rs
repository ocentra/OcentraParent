...
fn signed_proof_rows() -> Vec<LanSignedDiscoveryRelaySignedProofRow> {
    vec![
        ...
        manual_signed_proof_row(LanSignedDiscoveryRelaySignedProofCheck::SignedHeartbeatManualRequired),
...
fn manual_adapter_row(adapter: LanSignedDiscoveryRelayAdapterKind) -> LanSignedDiscoveryRelayAdapterRow {
...
fn manual_signed_proof_row(check: LanSignedDiscoveryRelaySignedProofCheck) -> LanSignedDiscoveryRelaySignedProofRow {
    signed_proof_row(
        check,
        LanPairingProductionDiscoveryState::ManualRequired,
...
fn accepted_route_safety_row(
    ...
    route_safety_row(check, discovery_state, LanPairingResponseState::Accepted, None)
}
