...
mod app_game_source_gated_policy_preview_timer_followthrough_protocol;
mod app_game_source_gated_policy_preview_timer_followthrough_parent_surface;
mod app_game_source_gated_policy_preview_timer_followthrough_parent_surface_status;
mod app_game_source_gated_policy_preview_timer_followthrough_tail;

use self::app_game_source_gated_policy_preview_timer_followthrough_protocol as timer_followthrough_protocol;
use self::app_game_source_gated_policy_preview_timer_followthrough_parent_surface as timer_followthrough_parent_surface;
use self::app_game_source_gated_policy_preview_timer_followthrough_parent_surface_status as timer_followthrough_parent_surface_status;
use self::app_game_source_gated_policy_preview_timer_followthrough_tail as timer_followthrough_tail;

pub fn build_app_game_source_gated_policy_preview_timer_service_readiness_protocol_read_model(
    options: &timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessProtocolReadModelOptions,
...
) -> timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessProtocolReadModel {
    timer_followthrough_protocol::build_app_game_source_gated_policy_preview_timer_service_readiness_protocol_read_model(options, handoff)
}

pub fn build_app_game_source_gated_policy_preview_timer_service_readiness_protocol_command_handoff(
    options: &timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessProtocolCommandHandoffOptions,
    read_model: &timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessProtocolReadModel,
) -> timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessProtocolCommandHandoff {
    timer_followthrough_protocol::build_app_game_source_gated_policy_preview_timer_service_readiness_protocol_command_handoff(options, read_model)
}

pub fn build_app_game_source_gated_policy_preview_timer_service_readiness_service_handler_handoff(
    options: &timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessServiceHandlerHandoffOptions,
    protocol_command_handoff: &timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessProtocolCommandHandoff,
) -> timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessServiceHandlerHandoff {
    timer_followthrough_protocol::build_app_game_source_gated_policy_preview_timer_service_readiness_service_handler_handoff(options, protocol_command_handoff)
}

pub fn build_app_game_source_gated_policy_preview_timer_service_readiness_service_read_api_handoff(
    options: &timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessServiceReadApiHandoffOptions,
    service_handler_handoff: &timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessServiceHandlerHandoff,
) -> timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessServiceReadApiHandoff {
    timer_followthrough_protocol::build_app_game_source_gated_policy_preview_timer_service_readiness_service_read_api_handoff(options, service_handler_handoff)
}

pub fn build_app_game_source_gated_policy_preview_timer_service_readiness_read_api_response_handoff(
    options: &timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessReadApiResponseHandoffOptions,
    service_read_api_handoff: &timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessServiceReadApiHandoff,
) -> timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessReadApiResponseHandoff {
    timer_followthrough_protocol::build_app_game_source_gated_policy_preview_timer_service_readiness_read_api_response_handoff(options, service_read_api_handoff)
}

pub fn build_app_game_source_gated_policy_preview_timer_service_readiness_read_api_response_consumer_handoff(
    options: &timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessReadApiResponseConsumerHandoffOptions,
    read_api_response_handoff: &timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessReadApiResponseHandoff,
) -> timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessReadApiResponseConsumerHandoff {
    timer_followthrough_protocol::build_app_game_source_gated_policy_preview_timer_service_readiness_read_api_response_consumer_handoff(options, read_api_response_handoff)
}

pub fn build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_handoff(
    options: &timer_followthrough_parent_surface::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceHandoffOptions,
    read_api_response_consumer_handoff: &timer_followthrough_protocol::AppGameSourceGatedPolicyPreviewTimerServiceReadinessReadApiResponseConsumerHandoff,
) -> timer_followthrough_parent_surface::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceHandoff {
    timer_followthrough_parent_surface::build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_handoff(options, read_api_response_consumer_handoff)
}
...
pub fn build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_read_model_handoff(
    options: &timer_followthrough_parent_surface::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceReadModelHandoffOptions,
    parent_surface_handoff: &timer_followthrough_parent_surface::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceHandoff,
) -> timer_followthrough_parent_surface::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceReadModelHandoff {
    timer_followthrough_parent_surface::build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_read_model_handoff(options, parent_surface_handoff)
}
...
pub fn build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_status_handoff(
    options: &timer_followthrough_parent_surface::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusHandoffOptions,
    parent_surface_read_model_handoff: &timer_followthrough_parent_surface::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceReadModelHandoff,
) -> timer_followthrough_parent_surface::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusHandoff {
    timer_followthrough_parent_surface::build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_status_handoff(options, parent_surface_read_model_handoff)
}
...
pub fn build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_status_read_model_handoff(
    options: &timer_followthrough_parent_surface_status::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelHandoffOptions,
    parent_surface_status_handoff: &timer_followthrough_parent_surface::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusHandoff,
) -> timer_followthrough_parent_surface_status::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelHandoff {
    timer_followthrough_parent_surface_status::build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_status_read_model_handoff(options, parent_surface_status_handoff)
}
...
pub fn build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_status_read_model_parent_surface_handoff(
    options: &timer_followthrough_tail::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceHandoffOptions,
    parent_surface_status_read_model_handoff: &timer_followthrough_parent_surface_status::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelHandoff,
) -> timer_followthrough_tail::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceHandoff {
    timer_followthrough_tail::build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_status_read_model_parent_surface_handoff(options, parent_surface_status_read_model_handoff)
}
...
pub fn build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_status_read_model_parent_surface_read_model_handoff(
    options: &timer_followthrough_tail::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoffOptions,
    parent_surface_handoff: &timer_followthrough_tail::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceHandoff,
) -> timer_followthrough_tail::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoff {
    timer_followthrough_tail::build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_status_read_model_parent_surface_read_model_handoff(options, parent_surface_handoff)
}
...
pub fn build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_status_read_model_parent_surface_read_model(
    options: &timer_followthrough_tail::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelOptions,
    handoff: &timer_followthrough_tail::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoff,
) -> timer_followthrough_tail::AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModel {
    timer_followthrough_tail::build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_status_read_model_parent_surface_read_model(options, handoff)
}

pub fn app_game_source_gated_policy_preview_timer_followthrough_typescript() -> &'static str {
    timer_followthrough_tail::app_game_source_gated_policy_preview_timer_followthrough_typescript()
}
