...
fn build_row(
    ...
    AppGameChildUxPreferencePreflightRow {
        ...
        provider_channel: Some(input.scheduler_record.provider_channel),
        reason_code: Some(input.scheduler_record.reason_code),
        severity: Some(input.scheduler_record.severity),
