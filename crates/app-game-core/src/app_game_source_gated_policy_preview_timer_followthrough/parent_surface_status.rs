...
pub fn build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_status_read_model_handoff(
    ...
    parent_surface_status_handoff: &AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusHandoff,
) -> AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelHandoff{
    let rows = parent_surface_status_handoff
        .rows
        .iter()
        .map(|row| {
    ...
    AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelHandoff {
        ...
        response_consumer_parent_surface_status_read_model_handoff_id: options
            .response_consumer_parent_surface_status_read_model_handoff_id
            .clone(),
        source_response_consumer_parent_surface_status_handoff_id:
            parent_surface_status_handoff
        ...
        parent_surface_status_read_model_ref: options
            ...
            .clone(),
        native_app_row_count: parent_surface_status_handoff.native_app_row_count,
        native_game_row_count: parent_surface_status_handoff.native_game_row_count,
        parent_surface_status_read_model_proof_required_count: count_state(
            &rows,
            |row| row
                .response_consumer_parent_surface_status_read_model_handoff_state
                .as_str(),
        ...
        response_consumer_parent_surface_status_read_model_handoff_non_claims:
            RESPONSE_CONSUMER_PARENT_SURFACE_STATUS_READ_MODEL_NON_CLAIMS
                .iter()
...
pub struct AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceHandoffOptions
{
    pub schema_version: String,
    pub response_consumer_parent_surface_status_read_model_parent_surface_handoff_id: String,
...
pub struct AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceHandoffRow
{
    pub schema_version: String,
    pub row_id: String,
    pub source_response_consumer_parent_surface_status_read_model_handoff_row_id: String,
    pub target_domain: String,
    pub response_consumer_parent_surface_status_read_model_parent_surface_handoff_state: String,
    pub inherited_parent_surface_status_read_model_proof_refs: Vec<String>,
    ...
    pub parent_surface_status_read_model_parent_surface_implemented: bool,
...
pub struct AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceHandoff
{
    pub schema_version: String,
    pub response_consumer_parent_surface_status_read_model_parent_surface_handoff_id: String,
    pub source_response_consumer_parent_surface_status_read_model_handoff_id: String,
    pub generated_at: String,
    pub source_contract_refs: Vec<String>,
    pub parent_surface_ref: String,
    pub rows:
        Vec<AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceHandoffRow>,
    ...
    pub response_consumer_parent_surface_status_read_model_parent_surface_handoff_non_claims:
        Vec<String>,
    pub service_command_registered: bool,
    pub service_handler_implemented: bool,
    pub service_read_api_implemented: bool,
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoffOptions
{
    pub schema_version: String,
    pub response_consumer_parent_surface_status_read_model_parent_surface_read_model_handoff_id:
        String,
    pub generated_at: String,
    pub source_contract_refs: Vec<String>,
...
pub struct AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoffRow
{
    ...
    pub source_response_consumer_parent_surface_status_read_model_handoff_row_id: String,
    pub target_domain: String,
    pub response_consumer_parent_surface_status_read_model_parent_surface_read_model_handoff_state:
        String,
    pub inherited_parent_surface_status_read_model_proof_refs: Vec<String>,
    ...
    pub parent_surface_status_read_model_implemented: bool,
    pub parent_surface_status_read_model_parent_surface_implemented: bool,
    pub parent_surface_status_read_model_parent_surface_read_model_implemented: bool,
    pub service_event_emitted: bool,
    pub agent_protocol_implemented: bool,
    pub rust_protocol_mirrored: bool,
    pub portal_ui_rendered: bool,
...
pub struct AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoff
{
    ...
    pub blocked_by_source_freshness_count: usize,
    pub blocked_by_compiler_decision_count: usize,
    pub response_consumer_parent_surface_status_read_model_parent_surface_read_model_handoff_non_claims:
        Vec<String>,
    pub service_command_registered: bool,
    pub service_handler_implemented: bool,
    pub service_read_api_implemented: bool,
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelOptions
{
    pub schema_version: String,
    pub parent_surface_read_model_id: String,
    pub generated_at: String,
    pub source_contract_refs: Vec<String>,
}
...
pub struct AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelRow
{
    pub schema_version: String,
    pub row_id: String,
    pub source_parent_surface_read_model_handoff_row_id: String,
    pub target_domain: String,
    pub parent_surface_read_model_state: String,
    pub parent_safe_summary: String,
    pub inherited_parent_surface_status_read_model_proof_refs: Vec<String>,
    pub required_parent_surface_read_model_proof_refs: Vec<String>,
    pub source_evidence_refs: Vec<String>,
    pub parent_surface_status_read_model_ref: String,
    ...
    pub portal_response_consumer_rendered: bool,
    pub parent_surface_rendered: bool,
    pub parent_surface_read_model_runtime_implemented: bool,
    pub parent_surface_read_model_persisted: bool,
    pub policy_evaluator_runtime_claimed: bool,
    pub timer_runtime_claimed: bool,
    pub timer_scheduled: bool,
    pub scheduler_persistence_runtime_claimed: bool,
...
pub struct AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModel
{
    pub schema_version: String,
    pub parent_surface_read_model_id: String,
    pub source_parent_surface_read_model_handoff_id: String,
    pub generated_at: String,
    pub source_contract_refs: Vec<String>,
    pub rows: Vec<
    ...
    pub native_app_row_count: usize,
    pub native_game_row_count: usize,
    pub ready_for_parent_surface_read_model_count: usize,
    pub blocked_by_source_freshness_count: usize,
    pub blocked_by_compiler_decision_count: usize,
    pub parent_surface_read_model_non_claims: Vec<String>,
    pub service_command_registered: bool,
    pub service_handler_implemented: bool,
    pub service_read_api_implemented: bool,
    pub service_read_api_response_implemented: bool,
...
pub fn build_app_game_source_gated_policy_preview_timer_service_readiness_response_consumer_parent_surface_status_read_model_parent_surface_handoff(
    options: &AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceHandoffOptions,
    source_handoff: &AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelHandoff,
    ...
    AppGameSourceGatedPolicyPreviewTimerServiceReadinessResponseConsumerParentSurfaceStatusReadModelParentSurfaceHandoff {
        schema_version: options.schema_version.clone(),
        response_consumer_parent_surface_status_read_model_parent_surface_handoff_id: options
            .response_consumer_parent_surface_status_read_model_parent_surface_handoff_id
            .clone(),
        ...
        response_consumer_parent_surface_status_read_model_parent_surface_handoff_non_claims:
            RESPONSE_CONSUMER_PARENT_SURFACE_STATUS_READ_MODEL_PARENT_SURFACE_NON_CLAIMS
                .iter()
                .map(|value| (*value).to_string())
                .collect(),
        rows,
