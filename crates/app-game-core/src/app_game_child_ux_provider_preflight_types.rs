...
pub enum AppGameChildUxProviderPreflightStatus {
...
pub struct AppGameChildUxProviderPreflightInput {
    ...
    pub adapter_requirement_ref: NotificationLocalOutboxReference,
    pub credential_requirement_ref: NotificationLocalOutboxReference,
    pub smoke_proof_requirement_ref: NotificationLocalOutboxReference,
}

#[derive(Clone, Debug, PartialEq)]
pub struct AppGameChildUxProviderPreflightRow {
    pub preflight_row_id: NotificationLocalOutboxReference,
    ...
    pub adapter_requirement_refs: Vec<NotificationLocalOutboxReference>,
