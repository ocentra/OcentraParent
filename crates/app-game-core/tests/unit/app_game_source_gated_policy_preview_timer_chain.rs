...
fn generated_timer_chain_helper_stays_checked_in() {
    let checked_in =
        include_str!("../../src/generated/app-game-source-gated-policy-preview-timer-chain.ts");
...
fn preview_row(
    ...
    preview_decision_ref: Option<&str>,
) -> AppGameSourceGatedPolicyPreviewReadModelRowInput {
    AppGameSourceGatedPolicyPreviewReadModelRowInput {
...
fn parent_surface_row(
    row_id: &str,
    target_domain: &str,
    parent_surface_intent_state: &str,
...
fn service_readiness_read_model_row(
    row_id: &str,
    target_domain: &str,
    service_readiness_read_model_state: &str,
    required_proof_refs: Vec<&str>,
) -> AppGameSourceGatedPolicyPreviewTimerServiceReadinessReadModelRowInput {
    AppGameSourceGatedPolicyPreviewTimerServiceReadinessReadModelRowInput {
        row_id: row_id.to_string(),
