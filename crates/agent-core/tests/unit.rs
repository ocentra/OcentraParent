...
#[path = "unit/activity_store_app_game.rs"]
mod activity_store_app_game;
#[path = "unit/activity_store_app_game_tests.rs"]
mod activity_store_app_game_tests;
#[path = "unit/activity_store_browser_intervention_tests.rs"]
mod activity_store_browser_intervention_tests;
#[path = "unit/activity_store_browser_tests.rs"]
mod activity_store_browser_tests;
#[path = "unit/activity_store_enforcement_audit_tests.rs"]
mod activity_store_enforcement_audit_tests;
#[path = "unit/activity_store_memory_graph_index_tests.rs"]
mod activity_store_memory_graph_index_tests;
#[path = "unit/activity_store_memory_graph_tests.rs"]
mod activity_store_memory_graph_tests;
#[path = "unit/activity_store_network_flow_tests.rs"]
mod activity_store_network_flow_tests;
#[path = "unit/activity_store_policy_preview_parent_rule_tests.rs"]
mod activity_store_policy_preview_parent_rule_tests;
#[path = "unit/activity_store_policy_preview_tests.rs"]
mod activity_store_policy_preview_tests;
#[path = "unit/activity_store_screen_evidence_tests.rs"]
mod activity_store_screen_evidence_tests;
#[path = "unit/activity_store_tests.rs"]
mod activity_store_tests;
#[path = "unit/browser_bridge_cdp_adapter_tests.rs"]
mod browser_bridge_cdp_adapter_tests;
#[path = "unit/browser_bridge_native_host_tests.rs"]
mod browser_bridge_native_host_tests;
#[path = "unit/browser_bridge_poll_security_tests.rs"]
mod browser_bridge_poll_security_tests;
#[path = "unit/browser_bridge_poll_tests.rs"]
mod browser_bridge_poll_tests;
#[path = "unit/browser_bridge_tests.rs"]
mod browser_bridge_tests;
#[path = "unit/browser_event_runtime_tests.rs"]
mod browser_event_runtime_tests;
#[path = "unit/browser_managed_session_tests.rs"]
mod browser_managed_session_tests;
#[path = "unit/browser_windows_inventory_source_tests.rs"]
mod browser_windows_inventory_source_tests;
#[path = "unit/browser_windows_inventory_tests.rs"]
mod browser_windows_inventory_tests;
#[path = "unit/crate_name_tests.rs"]
mod crate_name_tests;
#[path = "unit/enforcement_app_time_limit_tests.rs"]
mod enforcement_app_time_limit_tests;
#[path = "unit/enforcement_approval_audit_tests.rs"]
mod enforcement_approval_audit_tests;
#[path = "unit/enforcement_audit_boundary_tests.rs"]
mod enforcement_audit_boundary_tests;
#[path = "unit/enforcement_permission_dependency_tests.rs"]
...
#[path = "unit/enforcement_readiness_tests.rs"]
mod enforcement_readiness_tests;
#[path = "unit/enforcement_tests.rs"]
mod enforcement_tests;
#[path = "unit/enforcement_timer_state_tests.rs"]
mod enforcement_timer_state_tests;
#[path = "unit/enforcement_timer_tests.rs"]
mod enforcement_timer_tests;
#[path = "unit/enforcement_unavailable_adapter_tests.rs"]
mod enforcement_unavailable_adapter_tests;
#[path = "unit/household_ai_provider_route_tests.rs"]
mod household_ai_provider_route_tests;
#[path = "unit/household_mesh_event_bridge_tests.rs"]
mod household_mesh_event_bridge_tests;
#[path = "unit/journal_tests.rs"]
mod journal_tests;
#[path = "unit/network_capture_tests.rs"]
mod network_capture_tests;
#[path = "unit/network_event_runtime.rs"]
...
#[path = "unit/network_event_runtime_cross_process_replay_tests.rs"]
mod network_event_runtime_cross_process_replay_tests;
#[path = "unit/network_event_runtime_delete_export_propagation_tests.rs"]
mod network_event_runtime_delete_export_propagation_tests;
#[path = "unit/network_event_runtime_fixture_transport_tests.rs"]
...
#[path = "unit/network_event_runtime_remote_delivery_tests.rs"]
mod network_event_runtime_remote_delivery_tests;
#[path = "unit/network_event_runtime_tests.rs"]
mod network_event_runtime_tests;
#[path = "unit/parent_child_event_runtime_tests.rs"]
mod parent_child_event_runtime_tests;
#[path = "unit/policy_dry_run_evaluator_edge_tests.rs"]
mod policy_dry_run_evaluator_edge_tests;
#[path = "unit/policy_dry_run_evaluator_rule_tests.rs"]
mod policy_dry_run_evaluator_rule_tests;
#[path = "unit/process_capture_tests.rs"]
mod process_capture_tests;
#[path = "unit/screen_event_runtime_tests.rs"]
mod screen_event_runtime_tests;
#[path = "unit/screen_evidence_queue_tests.rs"]
mod screen_evidence_queue_tests;
#[path = "unit/screen_household_mesh_runtime_tests.rs"]
mod screen_household_mesh_runtime_tests;
#[path = "unit/tracking_read_model.rs"]
mod tracking_read_model;
#[path = "unit/trusted_device_registry.rs"]
mod trusted_device_registry;
#[path = "unit/window_capture_tests.rs"]
