...
#[test]
fn browser_runtime_parent_surface_topology_covers_named_event_and_subscriber() {
    let manifest = browser_runtime_parent_surface_status_topology_manifest().unwrap();
