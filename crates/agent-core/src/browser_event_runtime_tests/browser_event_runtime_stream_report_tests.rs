use crate::browser_event_runtime::topology::browser_runtime_stream_report_topology_manifest;
use ocentra_eventing::topology::EventTopologyStatus;
use ocentra_parent_agent_protocol::constants;

#[test]
fn browser_runtime_stream_report_topology_covers_named_event_and_subscriber() {
    let manifest = browser_runtime_stream_report_topology_manifest().unwrap();
