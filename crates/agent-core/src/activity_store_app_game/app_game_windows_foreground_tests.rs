use ocentra_parent_agent_protocol::{
    ...
    APP_GAME_OBSERVATION_MODE_PROCESS_START, APP_GAME_RUNTIME_RUNNING, APP_GAME_RUNTIME_UNKNOWN,
    APP_GAME_TEST_CATALOG_REF, APP_GAME_TEST_FOREGROUND_CLOSED_EVIDENCE_ID,
    APP_GAME_TEST_FOREGROUND_EVIDENCE_ID, APP_GAME_TEST_FOREGROUND_PERMISSION_EVIDENCE_ID,
    ...
    APP_GAME_TEST_REGISTRY_SOURCE_REF, APP_GAME_TEST_RUNTIME_EVIDENCE_ID,
    APP_GAME_TEST_RUNTIME_EXIT_EVIDENCE_ID, APP_GAME_TEST_RUNTIME_LAUNCHER_EVIDENCE_ID,
    APP_GAME_TEST_WINDOW_REF, APP_GAME_TEST_WINDOW_TITLE_REF,
