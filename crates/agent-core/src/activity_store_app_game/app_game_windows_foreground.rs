...
use ocentra_parent_agent_protocol::app_game::{
    AppGameForegroundEvidenceRow, AppGameSessionSummary, APP_GAME_CAPABILITY_STATUS_ADAPTER_ERROR,
    ...
    APP_GAME_CONFIDENCE_UNKNOWN, APP_GAME_CONTENT_KNOWLEDGE_NOT_CLAIMED,
