...
use ocentra_parent_agent_protocol::{
    ...
    APP_GAME_FOREGROUND_FOREGROUND, APP_GAME_OBSERVATION_MODE_FOREGROUND_WINDOW,
    APP_GAME_RUNTIME_RUNNING, APP_GAME_TEST_FOREGROUND_CLOSED_EVIDENCE_ID,
    APP_GAME_TEST_FOREGROUND_PERMISSION_EVIDENCE_ID, APP_GAME_TITLE_CAPTURE_TITLE_OMITTED,
