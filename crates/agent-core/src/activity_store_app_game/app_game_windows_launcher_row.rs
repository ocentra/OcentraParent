use ocentra_parent_agent_protocol::app_game::{
    AppGameLauncherEvidenceRow, APP_GAME_CLASSIFICATION_LAUNCHER_GAME_CANDIDATE,
    ...
    APP_GAME_LAUNCHER_PROOF_DETERMINISTIC_CHILD_GAME, APP_GAME_LAUNCHER_PROOF_MANIFEST_CANDIDATE,
    APP_GAME_LAUNCHER_PROOF_PERMISSION_LIMITED, APP_GAME_RUNTIME_PERMISSION_LIMITED,
