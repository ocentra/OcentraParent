use ocentra_parent_agent_protocol::app_game::{
    ...
    APP_GAME_FOREGROUND_NOT_CLAIMED, APP_GAME_INVENTORY_SOURCE_LAUNCHER_MANIFEST,
    APP_GAME_INVENTORY_SOURCE_UNKNOWN, APP_GAME_PRODUCT_LAUNCHER, APP_GAME_PRODUCT_NATIVE_APP,
    APP_GAME_PRODUCT_NATIVE_GAME, APP_GAME_PRODUCT_UNKNOWN_EXECUTABLE,
