use ocentra_parent_agent_protocol::{
    ...
    APP_GAME_INVENTORY_STATE_INSTALLED, APP_GAME_PRODUCT_NATIVE_APP, APP_GAME_PRODUCT_NATIVE_GAME,
    APP_GAME_RUNTIME_NOT_CLAIMED, APP_GAME_TEST_EXECUTABLE_PATH_REF,
    APP_GAME_TEST_STORE_APP_BUNDLE_ID, APP_GAME_TEST_STORE_APP_CATALOG_REF,
    APP_GAME_TEST_STORE_APP_DISPLAY_LABEL, APP_GAME_TEST_STORE_APP_PACKAGE_ID,
    APP_GAME_TEST_STORE_APP_SOURCE_REF, APP_GAME_TEST_STORE_APP_STORE_ID,
    APP_GAME_TEST_STORE_APP_USER_MODEL_ID, APP_GAME_TEST_STORE_GAME_BUNDLE_ID,
