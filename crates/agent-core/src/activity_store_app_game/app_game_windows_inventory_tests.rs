use ocentra_parent_agent_protocol::{
    constants, APP_GAME_CLASSIFICATION_KNOWN_APP, APP_GAME_CLASSIFICATION_KNOWN_GAME,
    ...
    APP_GAME_INVENTORY_CUSTODY_LOCAL_AGENT, APP_GAME_INVENTORY_CUSTODY_UNKNOWN,
    APP_GAME_INVENTORY_SOURCE_LAUNCHER_MANIFEST, APP_GAME_INVENTORY_SOURCE_OS_INSTALLED_RECORD,
    APP_GAME_INVENTORY_SOURCE_SHORTCUT, APP_GAME_INVENTORY_SOURCE_UNKNOWN,
    APP_GAME_INVENTORY_STATE_DETECTABLE, APP_GAME_INVENTORY_STATE_INSTALLED,
    APP_GAME_PRODUCT_NATIVE_APP, APP_GAME_PRODUCT_NATIVE_GAME, APP_GAME_PRODUCT_UNKNOWN_EXECUTABLE,
    APP_GAME_RUNTIME_NOT_CLAIMED, APP_GAME_TEST_APP_USER_MODEL_ID, APP_GAME_TEST_CATALOG_REF,
    APP_GAME_TEST_DESKTOP_ENTRY_ID, APP_GAME_TEST_DISPLAY_LABEL, APP_GAME_TEST_EXECUTABLE_PATH_REF,
    APP_GAME_TEST_GAME_DISPLAY_LABEL, APP_GAME_TEST_LAUNCHER_APP_ID,
    APP_GAME_TEST_LAUNCHER_MANIFEST_ID, APP_GAME_TEST_LAUNCHER_REF,
    APP_GAME_TEST_LAUNCHER_SOURCE_REF, APP_GAME_TEST_REGISTRY_SOURCE_REF,
    APP_GAME_TEST_SECOND_EXECUTABLE_PATH_REF, APP_GAME_TEST_SECOND_SHORTCUT_SOURCE_REF,
    APP_GAME_TEST_SECOND_UNKNOWN_SOURCE_REF, APP_GAME_TEST_SHORTCUT_SOURCE_REF,
    APP_GAME_TEST_STORE_ID, APP_GAME_TEST_UNKNOWN_SOURCE_REF,
};
