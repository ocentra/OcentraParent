...
use ocentra_parent_agent_protocol::app_game::{
    ...
    APP_GAME_LAUNCHER_PROCESS_NAME_EPIC, APP_GAME_LAUNCHER_PROCESS_NAME_GALAXY,
    APP_GAME_LAUNCHER_PROCESS_NAME_GAMING_SERVICES, APP_GAME_LAUNCHER_PROCESS_NAME_ITCH,
    APP_GAME_LAUNCHER_PROCESS_NAME_ITCH_IO, APP_GAME_LAUNCHER_PROCESS_NAME_MINECRAFT,
    APP_GAME_LAUNCHER_PROCESS_NAME_ORIGIN, APP_GAME_LAUNCHER_PROCESS_NAME_RIOT,
    APP_GAME_LAUNCHER_PROCESS_NAME_RIOT_UI, APP_GAME_LAUNCHER_PROCESS_NAME_ROBLOX,
    APP_GAME_LAUNCHER_PROCESS_NAME_ROBLOX_PLAYER, APP_GAME_LAUNCHER_PROCESS_NAME_STEAM,
    APP_GAME_LAUNCHER_PROCESS_NAME_UBISOFT, APP_GAME_LAUNCHER_PROCESS_NAME_UBISOFT_CONNECT,
    APP_GAME_LAUNCHER_PROCESS_NAME_XBOX, APP_GAME_LAUNCHER_PROOF_CHILD_PROCESS_CANDIDATE,
    APP_GAME_LAUNCHER_PROOF_LAUNCHER_ONLY, APP_GAME_LAUNCHER_REF_PREFIX,
    APP_GAME_OBSERVATION_MODE_PROCESS_SNAPSHOT, APP_GAME_RUNTIME_RUNNING, APP_GAME_SCHEMA_VERSION,
};
#[cfg(windows)]
