use ocentra_parent_agent_protocol::{
    ...
    APP_GAME_CATALOG_PERMISSION_LIMITED, APP_GAME_CATALOG_READY,
    ...
    APP_GAME_FOREGROUND_PERMISSION_LIMITED, APP_GAME_LAUNCHER_KIND_STEAM,
    ...
    APP_GAME_LAUNCHER_PROOF_PERMISSION_LIMITED, APP_GAME_OBSERVATION_MODE_PROCESS_SNAPSHOT,
    APP_GAME_RUNTIME_PERMISSION_LIMITED, APP_GAME_RUNTIME_RUNNING, APP_GAME_TEST_LAUNCHER_APP_ID,
    APP_GAME_TEST_LAUNCHER_CANDIDATE_EVIDENCE_ID, APP_GAME_TEST_LAUNCHER_CHILD_GAME_CLAIM_ID,
    APP_GAME_TEST_LAUNCHER_CHILD_INVENTORY_ENTRY_ID, APP_GAME_TEST_LAUNCHER_CHILD_PROCESS_IDENTITY,
    APP_GAME_TEST_LAUNCHER_EVIDENCE_ID, APP_GAME_TEST_LAUNCHER_KNOWN_GAME_EVIDENCE_ID,
    ...
    APP_GAME_TEST_LAUNCHER_REF, APP_GAME_TEST_LAUNCHER_SOURCE_REF,
    APP_GAME_TEST_STORE_GAME_CATALOG_REF,
};
