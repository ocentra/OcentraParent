...
> {
    ...
    Ok(NetworkRuntimeRemoteDeliveryOutboxHandoffReport {
        ...
        lifecycle_blocker_ref_count: lifecycle_blocker_ref_count(&remote_delivery_status),
        durable_envelope_ref_count: durable_envelope_ref_count(&remote_delivery_status),
...
fn lifecycle_blocker_ref_count(report: &super::NetworkRuntimeRemoteDeliveryStatusReport) -> usize {
    [
...
fn durable_envelope_ref_count(report: &super::NetworkRuntimeRemoteDeliveryStatusReport) -> usize {
    [
