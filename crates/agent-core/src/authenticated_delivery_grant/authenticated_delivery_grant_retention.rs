...
const MIGRATE_REPLAY_RETENTION_CLOCK: &str = "INSERT OR IGNORE INTO authenticated_delivery_grant_replay_retention_v2 (singleton, highest_trusted_now_nanos, confirmed) SELECT singleton, highest_trusted_now_nanos, 0 FROM authenticated_delivery_grant_replay_retention_v1";
