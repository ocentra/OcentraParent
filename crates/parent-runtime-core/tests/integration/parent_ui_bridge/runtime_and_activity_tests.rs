...
fn replace_timer_parent_surface_response(
...
fn app_game_timer_parent_surface_response_with_valid_row() -> AgentEventEnvelope {
...
fn app_game_timer_parent_surface_response_with_unknown_target() -> AgentEventEnvelope {
    app_game_timer_parent_surface_response_with_mutation(|read_model| {
        read_model["capabilityStatus"] = json!("timer-parent-surface-ready");
        read_model["returned"] = json!(1);
        read_model["readyForParentSurfaceCount"] = json!(1);
...
fn app_game_timer_parent_surface_response_with_unknown_state() -> AgentEventEnvelope {
    app_game_timer_parent_surface_response_with_mutation(|read_model| {
        read_model["capabilityStatus"] = json!("timer-parent-surface-ready");
        read_model["returned"] = json!(1);
        read_model["readyForParentSurfaceCount"] = json!(1);
...
fn app_game_timer_parent_surface_response_with_inconsistent_counts() -> AgentEventEnvelope {
    app_game_timer_parent_surface_response_with_mutation(|read_model| {
...
fn app_game_timer_parent_surface_response_with_state_count_mismatch() -> AgentEventEnvelope {
    app_game_timer_parent_surface_response_with_mutation(|read_model| {
        read_model["capabilityStatus"] = json!("timer-parent-surface-ready");
        read_model["returned"] = json!(2);
...
fn app_game_timer_parent_surface_response_with_duplicate_row_id() -> AgentEventEnvelope {
    app_game_timer_parent_surface_response_with_mutation(|read_model| {
        read_model["capabilityStatus"] = json!("timer-parent-surface-ready");
        read_model["returned"] = json!(2);
        read_model["readyForParentSurfaceCount"] = json!(2);
...
fn app_game_timer_parent_surface_response_with_duplicate_evidence_id() -> AgentEventEnvelope {
    app_game_timer_parent_surface_response_with_mutation(|read_model| {
        read_model["capabilityStatus"] = json!("timer-parent-surface-ready");
        read_model["returned"] = json!(1);
        read_model["readyForParentSurfaceCount"] = json!(1);
...
fn app_game_timer_parent_surface_response_with_unowned_runtime_claim() -> AgentEventEnvelope {
    app_game_timer_parent_surface_response_with_mutation(|read_model| {
        read_model["capabilityStatus"] = json!("timer-parent-surface-ready");
        read_model["returned"] = json!(1);
        read_model["readyForParentSurfaceCount"] = json!(1);
...
fn app_game_timer_parent_surface_response_with_unowned_adapter_dispatch_claim() -> AgentEventEnvelope
{
    app_game_timer_parent_surface_response_with_mutation(|read_model| {
        read_model["capabilityStatus"] = json!("timer-parent-surface-ready");
        read_model["returned"] = json!(1);
...
fn app_game_timer_parent_surface_response_with_unowned_platform_enforcement_claim(
) -> AgentEventEnvelope {
    app_game_timer_parent_surface_response_with_mutation(|read_model| {
        read_model["capabilityStatus"] = json!("timer-parent-surface-ready");
        read_model["returned"] = json!(1);
...
fn app_game_timer_parent_surface_response_with_mutation(
