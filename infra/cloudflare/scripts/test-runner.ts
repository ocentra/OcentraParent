...
const FAMILY_CONFIG: Record<TestFamily, FamilyConfig> = {
  unit: {
    ...
    files: [
      ...
      'tests/unit/account-browser-session-routes.test.ts',
      'tests/unit/account-browser-session-store.test.ts',
    ...
    assertionIds: [
      ...
      'UT-ACCOUNT-BROWSER-SESSION-ROUTES-01',
      'UT-ACCOUNT-BROWSER-SESSION-ROUTES-02',
      'UT-ACCOUNT-BROWSER-SESSION-ROUTES-03',
      'UT-ACCOUNT-BROWSER-SESSION-STORE-01',
      'UT-ACCOUNT-BROWSER-SESSION-STORE-02',
      'UT-ACCOUNT-BROWSER-SESSION-STORE-03',
      'UT-ROUTE-01',
      'UT-ROUTE-02',
      'UT-ROUTE-03',
      'UT-ROUTE-04',
