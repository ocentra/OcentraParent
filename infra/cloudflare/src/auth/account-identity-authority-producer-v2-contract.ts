...
export const ACCOUNT_IDENTITY_AUTHORITY_PRODUCER_V2_MAX_PAYLOAD_BYTES = (16 * 1_024) as const;
export const ACCOUNT_IDENTITY_AUTHORITY_PRODUCER_V2_MAX_LIFETIME_SECONDS = (5 * 60) as const;
...
export const ACCOUNT_ISSUER_MAX_INNER_BYTES = (64 * 1_024) as const;
export const ACCOUNT_ISSUER_MAX_WIRE_BYTES = (128 * 1_024) as const;
