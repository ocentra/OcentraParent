...
const apkName = `ocentra-parent-mobile-android-debug-v${version}.apk`;
const apkPath = join(packageRoot, apkName);
const latestPath = join(packageRoot, 'ocentra-parent-mobile-android-debug-latest.apk');
...
function runGradle() {
  const projectPath = join(repoRoot, 'platforms', 'android', 'parent');
