...
const sourceFiles = [
  ...
  'crates/agent-core/src/network_event_runtime_fixture_transport_tests.rs',
...
function assertSourceContracts() {
  ...
  const coreTests = readText('crates/agent-core/src/network_event_runtime_fixture_transport_tests.rs');
