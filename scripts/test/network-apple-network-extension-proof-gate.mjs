...
const commands = [
  {
    ...
    command: 'cargo',
    args: ['test', '-p', 'ocentra-network-evidence', 'apple_network_extension_gate'],
...
console.log('network-apple-network-extension-proof-gate-ok:network-extension-gate-tests,clippy,source-shape');
...
function sourceStatusShort() {
  return runText('git', [
    ...
    '--',
    '.',
    ':(exclude)output/network-plan-proof/41-apple-network-extension-proof-gate',
    ':(exclude)test-results/network-apple-network-extension-proof-gate',
  ]);
}
