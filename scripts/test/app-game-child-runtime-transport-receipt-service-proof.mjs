...
async function main() {
  ...
  const proof = {
    ...
    evidence: {
      protocolContract: 'packages/agent-protocol-domain/src/app-game-child-runtime-transport-receipt.ts',
      protocolContractTest: 'packages/agent-protocol-domain/tests/app-game-child-runtime-transport-receipt.test.ts',
      ...
      rustPayloadTest:
        'crates/agent-service/src/activity_api/app_game_child_runtime_transport_receipt_payload_tests.rs',
      rustServiceTest:
        'crates/agent-service/src/activity_api/app_game_child_runtime_transport_receipt_service_tests.rs',
    ...
    claimsProved: [
      ...
      'The TypeScript protocol parser accepts the reported payload field and rejects malformed or overclaiming payloads',
  ...
  await writeFile(
    ...
    [
      ...
      '- TypeScript protocol: packages/agent-protocol-domain/src/app-game-child-runtime-transport-receipt.ts',
      ...
      '',
      'Evidence:',
      '- The command/event pair is registered in TypeScript and Rust protocol contracts.',
