...
async function main() {
  ...
  const proof = {
    ...
    claimsProved: [
      'The schema-domain contract owns the app/game child runtime transport receipt payload field and read-model shape',
  ...
  await writeFile(
    ...
    [
      ...
      '- TypeScript parser consumer: packages/agent-protocol-domain/src/app-game-child-runtime-transport-receipt-event-parser.ts',
