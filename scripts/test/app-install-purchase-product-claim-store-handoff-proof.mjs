...
async function main() {
  ...
  await runCommand('cmd', [
    ...
    '--',
    'tests/app-install-purchase-product-claim-store-handoff-proof.test.ts',
  ]);
  ...
  const proof = {
    ...
    commands,
    packageExportState: 'deferred-current-codex-b-packages-parent-domain-package-json-lock',
    ...
    evidence: {
      ...
      contractTest:
        'packages/parent-domain/tests/app-install-purchase-product-claim-store-handoff-proof.test.ts',
