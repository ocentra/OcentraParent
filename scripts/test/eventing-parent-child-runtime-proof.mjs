...
async function main() {
  ...
  const proof = {
    ...
    linkedArtifacts: {
      ...
      runtimeTests: 'crates/agent-core/src/parent_child_event_runtime_tests.rs',
...
async function assertRuntimeContracts() {
  ...
  const tests = await readText('crates/agent-core/src/parent_child_event_runtime_tests.rs');
