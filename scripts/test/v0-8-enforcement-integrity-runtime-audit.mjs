...
async function main() {
  ...
  const proof = {
    ...
    evidence: {
      ...
      rustServiceTest:
        'crates/agent-service/src/enforcement_api/enforcement_integrity_runtime_audit_read_model_tests.rs',
    ...
    counts: summary,
    claimsProved: [
      'Enforcement action/result/audit outcomes are represented in a schema-backed TypeScript read model',
