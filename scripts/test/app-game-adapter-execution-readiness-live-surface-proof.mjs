...
async function main() {
  ...
  const proof = {
    ...
    evidence: {
      agentProtocolDomain: 'packages/agent-protocol-domain/src/app-game-adapter-execution-readiness.ts',
    ...
    claimsProved: [
      'agent-protocol-domain parses a dedicated app/game adapter execution readiness event',
