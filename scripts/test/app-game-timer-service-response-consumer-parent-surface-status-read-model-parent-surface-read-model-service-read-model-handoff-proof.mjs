...
const proofSlug =
  '116-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-service-read-model-handoff';
const testOutputDir = join(
  repoRoot,
  'test-results',
  'app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-service-read-model-handoff-proof'
);
...
run('cmd', [
  ...
  '--',
  'app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-service-read-model-handoff',
...
const contract = await importDist(
  'app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-service-read-model-handoff.js'
);
const serviceHandoffContract = await importDist(
  'app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-service-handoff.js'
);
const refs = await importDist('reference-primitives.js');
const sourceServiceHandoff =
  serviceHandoffContract.AppGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelServiceHandoffSchema.parse(
    await readJson(
      join(
        repoRoot,
        'test-results',
...
const serviceReadModelHandoff =
  contract.buildAppGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelServiceReadModelHandoff(
...
const proof = {
  ...
  stackedOn: {
    wp115Branch:
      'codex/app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-service-handoff',
    reason:
      'WP116 consumes WP115 parent-domain service handoff rows and records the future service read-model proof needed before runtime service emission, events, read APIs, protocol, portal rendering, adapters, child delivery, platform enforcement, or raw source rows are claimed.',
  },
  ...
  proofPaths: {
    ...
    rules:
      'packages/parent-domain/src/app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-service-read-model-handoff-rules.ts',
    test: 'packages/parent-domain/tests/app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-service-read-model-handoff.test.ts',
    harness:
    ...
    evidence:
      'test-results/app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-service-read-model-handoff-proof/proof.json',
...
await writeProofPack(appGameProofDir, proof, 'app-game WP116');
await writeProofPack(appProofDir, proof, 'app WP116');

console.log(
  'app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-service-read-model-handoff-proof-ok'
);
console.log(
  `evidence=${join('test-results', 'app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-service-read-model-handoff-proof', 'proof.json')}`
);
...
function assertProof(proof) {
  ...
  if (Object.values(proof.nonClaims).some((value) => value !== false)) {
    throw new Error(
      'Expected WP116 proof to avoid service read-model runtime emission, events, API/runtime, protocol, read-model persistence, portal UI, evaluator, timer, scheduler storage, audit log, rollback execution, adapter, child, platform, and raw-source claims'
    );
  }
}
