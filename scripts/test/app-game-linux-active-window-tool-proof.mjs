...
async function main() {
  ...
  const proof = {
    ...
    summary,
    evidence: {
      contract: 'packages/parent-domain/src/app-game-linux-active-window-tool-proof.ts',
      contractTest: 'packages/parent-domain/tests/app-game-linux-active-window-tool-proof.test.ts',
