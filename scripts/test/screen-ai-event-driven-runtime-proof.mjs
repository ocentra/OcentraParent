...
async function main() {
  ...
  const proof = {
    ...
    evidence: {
      ...
      screenRuntimeTests: 'crates/agent-core/src/screen_event_runtime_tests.rs',
...
async function assertSourceContracts() {
  ...
  const testsSource = await readText('crates/agent-core/src/screen_event_runtime_tests.rs');
