...
async function main() {
  ...
  const proof = {
    ...
    evidence: {
      ...
      rustProtocolTest: 'crates/agent-protocol/src/windows_adapter_artifact_gate_tests.rs',
      rustServiceReadModel: 'crates/agent-service/src/windows_adapter_artifact_gate_read_model.rs',
      rustServiceReadModelTest: 'crates/agent-service/src/windows_adapter_artifact_gate_read_model_tests.rs',
