...
function proof() {
  return {
    ...
    evidence: {
      ...
      agentProtocolContract: 'packages/schema-domain/src/lan-pairing-browser-runtime.ts',
      agentProtocolCommandRegistry: 'packages/schema-domain/src/agent-command-event-contracts.ts',
