...
const testOutputDir = join(repoRoot, 'test-results', 'app-game-timer-parent-read-model-proof');
...
assertProof(proof);
await writeJson(join(testOutputDir, 'handoff.json'), parentSurfaceReadModel);
