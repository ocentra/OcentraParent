...
const sourceFiles = [
  ...
  'crates/agent-core/src/network_event_runtime_delete_export_propagation_tests.rs',
...
function assertSourceContracts() {
  ...
  const coreTests = readText('crates/agent-core/src/network_event_runtime_delete_export_propagation_tests.rs');
