...
async function main() {
  ...
  const proof = {
    ...
    evidence: {
      ...
      meshRuntimeTests: 'crates/agent-core/src/screen_household_mesh_runtime_tests.rs',
...
async function assertSourceContracts() {
  ...
  const testsSource = await readText('crates/agent-core/src/screen_household_mesh_runtime_tests.rs');
