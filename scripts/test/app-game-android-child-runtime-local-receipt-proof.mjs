...
async function main() {
  ...
  const contractModule = await import(
    pathToFileURL(
      join(repoRoot, 'packages', 'parent-domain', 'dist', 'app-game-android-child-runtime-local-receipt-proof.js')
    ).href
  );
  ...
  const proof = {
    ...
    evidence: {
      ...
      contract: 'packages/parent-domain/src/app-game-android-child-runtime-local-receipt-proof.ts',
      contractTest: 'packages/parent-domain/tests/app-game-android-child-runtime-local-receipt-proof.test.ts',
    ...
    claimsProved: [
      ...
      'Parent-domain accepts the Android local receipt proof only when package-local write/readback evidence is present',
    ],
    claimsNotProved: [
