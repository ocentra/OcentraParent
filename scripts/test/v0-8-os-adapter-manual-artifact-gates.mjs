...
async function main() {
  ...
  const proof = {
    ...
    proofLabels,
    evidence: {
      tsContract: 'packages/parent-domain/src/v0-8-os-adapter-manual-artifact-gates.ts',
      tsContractTest: 'packages/parent-domain/tests/v0-8-os-adapter-manual-artifact-gates.test.ts',
