...
async function main() {
  ...
  const proof = {
    ...
    evidence: {
      ...
      contractTest:
        'packages/app-game-domain/tests/unit/app-install-purchase-external-runtime-writer-readiness-proof.test.ts',
      featureDoc: 'docs/features/app-install-purchase-approval.md',
      expectationDoc: 'docs/expectations/app-install-purchase-approval.md',
      platformExpectationDoc: 'docs/expectations/platforms.md',
      packageExport: '@ocentra-parent/app-game-domain/app-install-purchase-external-runtime-writer-readiness-proof',
