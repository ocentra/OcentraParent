...
const journalTests = [
  'crates/ocentra-eventing/src/tests/journal_replay/file.rs',
  'crates/ocentra-eventing/src/tests/journal_replay/bus_policy.rs',
  'crates/ocentra-eventing/src/tests/journal_replay/replay.rs',
]
