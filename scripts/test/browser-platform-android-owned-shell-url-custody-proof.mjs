...
async function main() {
  ...
  const proof = {
    ...
    source: 'packages/browser-domain/src/browser-android-owned-shell-url-custody.ts',
    test: 'packages/browser-domain/tests/unit/browser-android-owned-shell-url-custody.test.ts',
    summary: {
