...
async function main() {
  ...
  const proof = {
    ...
    evidence: {
      ...
      contract: 'packages/schema-domain/src/app-game-android-child-runtime-local-delivery-intake-proof.ts',
      contractTest:
        'packages/app-game-domain/tests/unit/app-game-android-child-runtime-local-delivery-intake-proof.test.ts',
