...
function assertSourceContracts() {
  ...
  const bridgeTests = readText('crates/agent-core/src/household_mesh_event_bridge_tests.rs');
  ...
  const lanAiTests = readText('crates/agent-service/src/lan_pairing/lan_ai_job_tests.rs');
