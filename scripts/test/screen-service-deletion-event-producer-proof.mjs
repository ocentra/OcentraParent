...
async function main() {
  ...
  const proof = {
    ...
    evidence: {
      ...
      coreRuntimeTests: 'crates/agent-core/src/screen_event_runtime_tests.rs',
...
async function assertSourceContracts() {
  ...
  const coreTests = await readText('crates/agent-core/src/screen_event_runtime_tests.rs');
