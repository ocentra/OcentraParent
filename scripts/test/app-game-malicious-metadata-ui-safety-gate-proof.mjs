...
async function main() {
  ...
  const truncateSlice = sourceSlice(surfaceSource, 'function truncateTextForWidth', 'function wrapSvgTextLines');
  ...
  assertIncludes(
    appGameFeatureDoc,
    'raw executable path UI leak gate',
    'feature doc records the adjacent app/game UI safety proof chain'
  );
