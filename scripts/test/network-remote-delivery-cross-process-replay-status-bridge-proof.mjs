...
const sourceFiles = [
  ...
  'crates/agent-core/src/network_event_runtime_cross_process_replay_tests.rs',
...
function assertSourceContracts() {
  ...
  const coreProofTests = readText('crates/agent-core/src/network_event_runtime_cross_process_replay_tests.rs');
  ...
  const requiredSnippets = [
    ...
    [tsReadme, 'row10s'],
    [tsReadme, 'cross-process replay status bridge'],
