...
async function main() {
  ...
  const proof = {
    ...
    linkedArtifacts: {
      ...
      parentControllerTests: 'crates/agent-protocol/src/parent_controller_event_tests.rs',
      childAgentTests: 'crates/agent-protocol/src/child_agent_event_tests.rs',
...
async function assertSourceContracts() {
  ...
  const parentTests = await readText('crates/agent-protocol/src/parent_controller_event_tests.rs');
  const childTests = await readText('crates/agent-protocol/src/child_agent_event_tests.rs');
