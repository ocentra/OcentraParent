...
const commands = [
  {
    ...
    command: 'cargo',
    args: ['test', '-p', 'ocentra-network-evidence', 'app_game_session_correlation'],
...
console.log('network-app-game-session-correlation-proof-ok:session-tests,clippy,source-shape');
