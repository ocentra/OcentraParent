...
const proofMode = 'app-game-android-child-runtime-local-delivery-intake-physical-proof';
...
async function main() {
  ...
  const proof = {
    ...
    evidence: {
      ...
      proof: 'test-results/app-game-android-child-runtime-local-delivery-intake-physical-proof/proof.json',
      outputProof:
    ...
    claimsProved: [
      ...
      'The activity-triggered in-package broadcast records the package-local delivery intake marker',
...
function sourceSnapshot(proof) {
  return [
    '# WP216 Android child runtime local delivery intake physical proof snapshot',
    '',
