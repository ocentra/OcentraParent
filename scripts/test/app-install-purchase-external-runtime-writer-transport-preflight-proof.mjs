...
async function main() {
  ...
  await runCommand('cmd', [
    ...
    '--',
    'tests/app-install-purchase-external-runtime-writer-transport-preflight-proof.test.ts',
  ]);
  ...
  const proof = {
    ...
    evidence: {
      ...
      contractTest:
        'packages/parent-domain/tests/app-install-purchase-external-runtime-writer-transport-preflight-proof.test.ts',
