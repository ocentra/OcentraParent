...
const recentMemoryModule = await import('@ocentra-parent/schema-domain/local-ai-recent-memory-window-proof');
...
writeFileSync(
  ...
  [
    ...
    'cmd /c npm run test --workspace @ocentra-parent/ai-domain -- local-ai-recent-memory-window-proof',
  ].join('\n') + '\n'
);
