...
async function main() {
  ...
  const proof = {
    ...
    evidence: {
      ...
      routeTests: 'crates/agent-core/src/household_ai_provider_route_tests.rs',
...
async function assertSourceContracts() {
  ...
  const routeTestsSource = await readText('crates/agent-core/src/household_ai_provider_route_tests.rs');
