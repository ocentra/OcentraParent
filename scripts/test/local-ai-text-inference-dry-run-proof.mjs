...
const dryRunModule = await import('@ocentra-parent/schema-domain/local-ai-text-inference-dry-run-proof');
...
writeFileSync(
  ...
  [
    ...
    'cmd /c npm run test --workspace @ocentra-parent/ai-domain -- local-ai-text-inference-dry-run-proof',
  ].join('\n') + '\n'
);
