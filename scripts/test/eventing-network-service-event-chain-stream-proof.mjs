...
const commands = [
  ...
  {
    name: 'agent-protocol-domain-network-runtime-tests',
    command: npmCommand(),
    args: npmArgs([
      '--workspace',
...
function assertSourceContracts() {
  ...
  const streamTests = readText('crates/agent-service/src/network_runtime_stream_tests.rs');
  ...
  assertIncludes(
    ...
    'TypeScript runtime-event parser preserves stream entry event type'
  );
