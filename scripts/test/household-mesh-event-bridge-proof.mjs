...
async function main() {
  ...
  const proof = {
    ...
    evidence: {
      ...
      bridgeTests: 'crates/agent-core/src/household_mesh_bridge_runtime_tests.rs',
...
async function assertSourceContracts() {
  ...
  const testsSource = await readText('crates/agent-core/src/household_mesh_bridge_runtime_tests.rs');
