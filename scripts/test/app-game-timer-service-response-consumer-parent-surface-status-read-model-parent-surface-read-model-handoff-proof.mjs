...
const proofSlug = '113-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model';
...
const timestamp = '2026-06-06T18:50:00Z';
const commands = [];
...
const parentSurfaceContract = await importDist(
  'app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-handoff.js'
);
const refs = await importDist('reference-primitives.js');
const sourceParentSurfaceHandoff =
  parentSurfaceContract.AppGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceHandoffSchema.parse(
    await readJson(
      join(
        repoRoot,
        'test-results',
...
const parentSurfaceReadModelHandoff =
  contract.buildAppGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoff(
    parentSurfaceReadModelHandoffOptions(refs),
    sourceParentSurfaceHandoff
  );
const proof = {
  proofMode:
    'app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-handoff',
  ...
  stackedOn: {
    wp112Branch:
      'codex/app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-handoff-wp112',
    reason:
      'WP113 consumes WP112 parent-domain service response-consumer parent-surface status read-model parent-surface handoff rows and records the future parent-surface read-model proof needed before parent-surface read-model runtime, persistence, rendering, portal UI, adapters, child delivery, platform enforcement, or raw source rows are claimed.',
  },
  summary: summarize(parentSurfaceReadModelHandoff),
  nonClaims: pickNonClaims(parentSurfaceReadModelHandoff),
  proofPaths: {
    source:
    ...
    rules:
      'packages/parent-domain/src/app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-handoff-rules.ts',
    test: 'packages/parent-domain/tests/app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-handoff.test.ts',
    harness:
    ...
    evidence:
      'test-results/app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-handoff-proof/proof.json',
...
await writeProofPack(appGameProofDir, proof, 'app-game WP113');
await writeProofPack(appProofDir, proof, 'app WP113');

console.log(
  'app-game-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-handoff-proof-ok'
);
console.log(
  `evidence=${join(
    'test-results',
...
function summarize(parentSurfaceReadModelHandoff) {
  return {
    sourceServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceHandoffId:
      parentSurfaceReadModelHandoff.sourceServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceHandoffId,
...
function pickNonClaims(parentSurfaceReadModelHandoff) {
  return {
    ...
    serviceReadModelRuntimeEmitted: parentSurfaceReadModelHandoff.serviceReadModelRuntimeEmitted,
    serviceEventRuntimeEmitted: parentSurfaceReadModelHandoff.serviceEventRuntimeEmitted,
    ...
    parentSurfaceReadModelRuntimeImplemented: parentSurfaceReadModelHandoff.parentSurfaceReadModelRuntimeImplemented,
    parentSurfaceReadModelPersisted: parentSurfaceReadModelHandoff.parentSurfaceReadModelPersisted,
    parentSurfaceStatusRuntimeImplemented: parentSurfaceReadModelHandoff.parentSurfaceStatusRuntimeImplemented,
    parentSurfaceStatusPersisted: parentSurfaceReadModelHandoff.parentSurfaceStatusPersisted,
    parentSurfaceStatusReadModelRuntimeImplemented:
      parentSurfaceReadModelHandoff.parentSurfaceStatusReadModelRuntimeImplemented,
    parentSurfaceStatusReadModelPersisted: parentSurfaceReadModelHandoff.parentSurfaceStatusReadModelPersisted,
    parentSurfaceStatusReadModelParentSurfaceRuntimeImplemented:
      parentSurfaceReadModelHandoff.parentSurfaceStatusReadModelParentSurfaceRuntimeImplemented,
    parentSurfaceStatusReadModelParentSurfacePersisted:
      parentSurfaceReadModelHandoff.parentSurfaceStatusReadModelParentSurfacePersisted,
    parentSurfaceStatusReadModelParentSurfaceReadModelRuntimeImplemented:
      parentSurfaceReadModelHandoff.parentSurfaceStatusReadModelParentSurfaceReadModelRuntimeImplemented,
    parentSurfaceStatusReadModelParentSurfaceReadModelPersisted:
      parentSurfaceReadModelHandoff.parentSurfaceStatusReadModelParentSurfaceReadModelPersisted,
...
function assertProof(proof) {
  ...
  if (Object.values(proof.nonClaims).some((value) => value !== false)) {
    throw new Error(
      'Expected WP113 proof to avoid service runtime, parent-surface read-model runtime, rendering, portal UI, evaluator, timer, scheduler storage, audit log, rollback execution, adapter, child, platform, and raw-source claims'
    );
  }
}
