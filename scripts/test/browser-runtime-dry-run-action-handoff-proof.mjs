...
const sourceChecks = {
  protocolRequiresPolicyPreviewId: protocolSource.includes('policyPreviewId: NullableBrowserRuntimeText'),
  protocolRequiresActionIntentId: protocolSource.includes('assistantActionIntentId: NullableBrowserRuntimeText'),
  protocolRequiresDryRun: protocolSource.includes('dryRun: Schema.Boolean'),
  protocolRequiresAdapterDispatchClaim: protocolSource.includes('adapterDispatchClaimed: Schema.Boolean'),
  protocolRejectsDryRunDispatch: protocolSource.includes('browserRuntimeDryRunHasNoDispatch'),
  protocolTestCoversDryRunHandoff: protocolTestSource.includes('specifyDryRunActionHandoffParsing'),
...
writeFileSync(
  ...
  [
    ...
    `- Policy preview id carried: ${sourceChecks.protocolRequiresPolicyPreviewId}`,
    `- Action intent id carried: ${sourceChecks.protocolRequiresActionIntentId}`,
    `- Dry-run dispatch rejected: ${sourceChecks.protocolRejectsDryRunDispatch}`,
