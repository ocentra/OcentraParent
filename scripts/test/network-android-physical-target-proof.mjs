...
const sourceRefs = [
  ...
  'crates/ocentra-network-evidence/src/tests/android_physical_target.rs',
...
const commands = [
  {
    ...
    command: 'cargo',
    args: ['test', '-p', 'ocentra-network-evidence', 'android_physical_target'],
  },
  {
...
if (!observation.physicalDeviceIdentityProved) {
  throw new Error(
...
console.log('network-android-physical-target-proof-ok:adb-identity,cargo-tests,clippy,source-shape,diff-check');
