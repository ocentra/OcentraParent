# WP11 iOS Core Location Foreground Adapter Source Snapshot
...
- Scope: parent-domain iOS foreground authorization and sample gaps read model against existing simulator package/manual proof plans.
