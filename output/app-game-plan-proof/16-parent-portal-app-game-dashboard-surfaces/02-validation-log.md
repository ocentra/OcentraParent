...
The route rendered the dedicated App/Game Sessions dashboard with service-backed
App Use and Games read-model rows, capability matrix, evidence drawer, and game
budgets policy gap disclosure. Synthetic demo device names were absent on the
route.
