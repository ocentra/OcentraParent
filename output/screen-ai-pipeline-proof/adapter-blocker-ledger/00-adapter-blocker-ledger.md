...
Generated: 2026-06-08T06:46:43.166Z

Status: blocked-but-actionable

## Blocked Adapter Evidence

- broad-installed-app: screen-derived broad installed-app apply, rollback, and audit custody proof; source boundary: app-game/enforcement adapter layer; readiness: manual-required.
- host-network-domain: screen-derived domain or IP decision to host DNS/filter apply, rollback, and audit custody proof; source boundary: network/domain enforcement adapter layer; readiness: manual-required.
