...
const LeaderboardTabSchema = schema
  .object({
...
const LeaderboardNavItemSchema = schema
  .object({
    label: schema.string().min(1),
...
const LeaderboardGameOptionSchema = schema
  .object({
...
const LeaderboardQuickGameSchema = schema
  .object({
    id: schema.string().min(1),
    name: schema.string().min(1),
    detail: schema.string(),
...
const LeaderboardSeasonStatSchema = schema
  .object({
    label: schema.string(),
    value: schema.string(),
  })
...
const LeaderboardSeasonSchema = schema
  .object({
    label: schema.string(),
    title: schema.string(),
...
const LeaderboardModeContentSchema = schema
  .object({
...
const LeaderboardMetricLabelsSchema = schema
  .object({
...
const LeaderboardUiCopySchema = schema
  .object({
