  ...
  return {
    ...
    chrome: {
      ...
      panelStrokeWidth: clampNumber(
        ...
        0.4,
        3,
        DEFAULT_LEADERBOARD_PAGE_SVG_CONTROLS.chrome.panelStrokeWidth
      ),
      panelInnerInset: clampNumber(
        controls?.chrome?.panelInnerInset,
        0,
        12,
        DEFAULT_LEADERBOARD_PAGE_SVG_CONTROLS.chrome.panelInnerInset
      ),
      ...
      glowOpacity: clampNumber(
        ...
        0,
        0.6,
        DEFAULT_LEADERBOARD_PAGE_SVG_CONTROLS.chrome.glowOpacity
      ),
      buttonArrowWidth: clampNumber(
        controls?.chrome?.buttonArrowWidth,
        16,
        44,
        DEFAULT_LEADERBOARD_PAGE_SVG_CONTROLS.chrome.buttonArrowWidth
      ),
      rowHeight: clampNumber(
        controls?.chrome?.rowHeight,
        28,
        48,
        DEFAULT_LEADERBOARD_PAGE_SVG_CONTROLS.chrome.rowHeight
      ),
      ...
      avatarRadius: clampNumber(
        ...
        8,
        24,
        DEFAULT_LEADERBOARD_PAGE_SVG_CONTROLS.chrome.avatarRadius
      ),
    },
  };
}
