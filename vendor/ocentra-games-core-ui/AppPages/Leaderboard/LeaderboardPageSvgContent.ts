...
export type {
  ...
  LeaderboardGuideNote,
  LeaderboardGuidePage,
  LeaderboardGuideTopic,
  LeaderboardIconName,
...
export const DEFAULT_LEADERBOARD_PAGE_CONTENT: LeaderboardPageContentData = {
  ...
  navGroups: [
    ...
    { id: 'ladders', label: 'LADDERS', detail: 'Ranking views' },
    { id: 'events', label: 'EVENTS', detail: 'Season and social' },
  ],
  navItems: [
    { label: 'OVERVIEW', detail: 'Ranked play snapshot', icon: 'home', tabId: 'overall', groupId: 'today' },
    {
      label: 'OVERALL PLAYERS',
      detail: 'All-game player ladder',
      icon: 'shield',
      tabId: 'overall',
      groupId: 'ladders',
    },
    { label: 'GAME LEADERS', detail: 'Selected game players', icon: 'gamepad', tabId: 'perGame', groupId: 'ladders' },
    { label: 'CATEGORY LEADERS', detail: 'Overall by category', icon: 'grid', tabId: 'perGame', groupId: 'ladders' },
    { label: 'AI OVERALL', detail: 'All-game model ladder', icon: 'bot', tabId: 'aiBenchmarks', groupId: 'ladders' },
    { label: 'AI BY GAME', detail: 'Per-game models', icon: 'activity', tabId: 'aiBenchmarks', groupId: 'ladders' },
    {
      label: 'AI BY CATEGORY',
      detail: 'Category model ladder',
      icon: 'bot',
      tabId: 'aiBenchmarks',
      groupId: 'ladders',
    },
    {
      ...
      detail: 'Events and brackets',
      icon: 'trophy',
      tabId: 'tournaments',
      groupId: 'events',
    },
    { label: 'FRIENDS', detail: 'Friend-circle rank', icon: 'users', tabId: 'friends', groupId: 'events' },
  ],
  tabDetails: {
    overall: {
  ...
  topGames: [
    {
      ...
      tone: 'gold',
      category: 'Vying',
      subcategory: 'Comparing / Three-card',
      gameType: 1,
      routePath: '/games/three-card-brag/leaderboard',
    },
    {
      id: 'spades',
      rank: 2,
      ...
      subcategory: 'Point-trick / Bidding',
      gameType: 3,
      routePath: '/games/spades/leaderboard',
    },
    {
      id: 'poker',
      rank: 3,
      ...
      tone: 'red',
      category: 'Poker',
      subcategory: 'Vying / Betting',
      gameType: 4,
      routePath: '/games/poker/leaderboard',
    },
    {
      id: 'rummy',
      rank: 4,
      ...
      tone: 'purple',
      category: 'Rummy',
      subcategory: 'Matching / Sets and runs',
      gameType: 5,
      routePath: '/games/rummy/leaderboard',
    },
    {
      id: 'blackjack',
      rank: 5,
      ...
      tone: 'muted',
      category: 'Banking',
      subcategory: 'Casino / Hand total',
      gameType: 6,
      routePath: '/games/blackjack/leaderboard',
    },
  ],
  quickGames: [
    {
    ...
    },
    {
      ...
      subcategory: 'Comparing / Three-card',
      gameType: 7,
      routePath: '/games/teen-patti/leaderboard',
    },
  ],
  guideTopics: [],
  fallbackRows: [
    {
      ...
      wins: 1784,
      losses: 884,
      bestGame: 'Three Card Brag',
      trend: '+4',
      tone: 'gold',
    },
    {
      user_id: 'RoyalFlush21',
      rank: 2,
      score: 3640,
      wins: 1460,
      losses: 781,
    ...
    },
    {
      ...
      wins: 789,
      losses: 487,
      bestGame: '3 Card Brag',
      trend: '-2',
      tone: 'red',
    },
    {
      user_id: 'SilentPlayer',
      rank: 10,
      score: 2401,
      wins: 672,
      losses: 426,
  ...
  aiBenchmarkRows: [
    {
      user_id: 'ocentra-claim-strategist',
      rank: 1,
      score: 9812,
      wins: 1824,
      losses: 192,
    ...
    {
      user_id: 'baseline-random-policy',
      rank: 6,
      score: 6412,
      wins: 812,
      losses: 901,
...
export function resolveLeaderboardPageGameType(
  ...
  const selected =
    candidates.find((game) => normalizeId(game.id) === routeId) ??
