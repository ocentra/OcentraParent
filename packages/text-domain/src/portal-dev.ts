...
export const PortalDevText: Record<PortalDevTextTokenValue, DisplayText> = {
  ...
  [PortalDevTextToken.BrowserIntervention]: decodeDisplayText('Browser intervention'),
  [PortalDevTextToken.BrowserManagedStatus]: decodeDisplayText('Managed browser'),
  [PortalDevTextToken.ActivityMemoryGraph]: decodeDisplayText('Activity memory graph'),
  [PortalDevTextToken.NetworkFlow]: decodeDisplayText('Network flow'),
  [PortalDevTextToken.PolicyPreview]: decodeDisplayText('Policy preview'),
  ...
  [PortalDevTextToken.NoBrowserIntervention]: decodeDisplayText('No browser intervention rows returned yet.'),
  [PortalDevTextToken.NoBrowserManagedStatus]: decodeDisplayText('Managed browser status has not been reported yet.'),
  [PortalDevTextToken.NoActivityMemoryGraph]: decodeDisplayText('No activity memory graph edges returned yet.'),
  ...
  [PortalDevTextToken.NoLocalAiRuntimeStatus]: decodeDisplayText('Local AI runtime status has not been reported yet.'),
  [PortalDevTextToken.NoNetworkFlow]: decodeDisplayText('No network flow rows returned yet.'),
  [PortalDevTextToken.NoPolicyPreview]: decodeDisplayText(
    'Policy preview read path has not reported a dry-run decision yet.'
  ),
  [PortalDevTextToken.PolicyPreviewNoEnforcement]: decodeDisplayText('Enforcement disabled; preview only.'),
  ...
  [PortalDevTextToken.GetActivityMemoryGraph]: decodeDisplayText('Get activity memory graph'),
  [PortalDevTextToken.GetBrowserInterventionReadModel]: decodeDisplayText('Get browser intervention'),
