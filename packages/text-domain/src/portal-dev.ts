...
export const PortalDevTextToken = {
  ...
  TrackingStateFreshLive: decodeTextTokenId('portal.dev.trackingStateFreshLive'),
  ...
  TrackingStateTemporaryLiveExpired: decodeTextTokenId('portal.dev.trackingStateTemporaryLiveExpired'),
  ...
  TrackingStateRemoteSyncDisabled: decodeTextTokenId('portal.dev.trackingStateRemoteSyncDisabled'),
  TrackingStateRemoteAiDisabled: decodeTextTokenId('portal.dev.trackingStateRemoteAiDisabled'),
  TrackingStateUnsupportedManualRequired: decodeTextTokenId('portal.dev.trackingStateUnsupportedManualRequired'),
...
export const PortalDevText: Record<PortalDevTextTokenValue, DisplayText> = {
  ...
  [PortalDevTextToken.TrackingStateFreshLive]: decodeDisplayText('Fresh live'),
  ...
  [PortalDevTextToken.TrackingStateTemporaryLiveExpired]: decodeDisplayText('Temporary live expired'),
  ...
  [PortalDevTextToken.TrackingStateRemoteSyncDisabled]: decodeDisplayText('Remote sync disabled'),
  [PortalDevTextToken.TrackingStateRemoteAiDisabled]: decodeDisplayText('Remote AI disabled'),
  [PortalDevTextToken.TrackingStateUnsupportedManualRequired]: decodeDisplayText('Unsupported manual-required'),
