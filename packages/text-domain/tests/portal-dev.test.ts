...
describe('portal dev text', () => {
  it('PortalDevText: exposes schema-backed display text tokens', () => {
    ...
    expectPortalDevTextEntries([
      ...
      [PortalDevTextToken.TrackingStateFreshLive, 'Fresh live'],
      [PortalDevTextToken.TrackingStateTemporaryLiveExpired, 'Temporary live expired'],
      [PortalDevTextToken.TrackingStateRemoteSyncDisabled, 'Remote sync disabled'],
      [PortalDevTextToken.TrackingStateRemoteAiDisabled, 'Remote AI disabled'],
      [PortalDevTextToken.TrackingStateUnsupportedManualRequired, 'Unsupported manual-required'],
