...
type BrowserGameChildCheckingBlockSurfaceValidator = (
  surface: BrowserGameChildCheckingBlockSurfaceCandidate
) => boolean;

const BrowserGameChildCheckingBlockSurfaceValidators = {
  'checking-unknown-game': checkingUnknownGameSurfaceIsHonest,
  'approval-required-game': approvalRequiredGameSurfaceIsHonest,
  'blocked-game-candidate': blockedGameCandidateSurfaceIsHonest,
  'educational-game-allowed': educationalGameAllowedSurfaceIsHonest,
  'game-time-limit-candidate': gameTimeLimitCandidateSurfaceIsHonest,
  'cloud-gaming-manual-required': cloudGamingManualRequiredSurfaceIsHonest,
  'native-game-control-unavailable': nativeGameControlUnavailableSurfaceIsHonest,
} satisfies Record<BrowserGameChildCheckingBlockSurfaceKind, BrowserGameChildCheckingBlockSurfaceValidator>;
...
function browserGameChildCheckingBlockSurfaceIsHonest(surface: BrowserGameChildCheckingBlockSurfaceCandidate): boolean {
  ...
  return BrowserGameChildCheckingBlockSurfaceValidators[surface.surfaceKind](surface);
}

function checkingUnknownGameSurfaceIsHonest(surface: BrowserGameChildCheckingBlockSurfaceCandidate): boolean {
  return (
...
function approvalRequiredGameSurfaceIsHonest(surface: BrowserGameChildCheckingBlockSurfaceCandidate): boolean {
  return (
...
function blockedGameCandidateSurfaceIsHonest(surface: BrowserGameChildCheckingBlockSurfaceCandidate): boolean {
  return (
...
function educationalGameAllowedSurfaceIsHonest(surface: BrowserGameChildCheckingBlockSurfaceCandidate): boolean {
  return (
...
function gameTimeLimitCandidateSurfaceIsHonest(surface: BrowserGameChildCheckingBlockSurfaceCandidate): boolean {
  return (
    surface.state === 'child-readable' &&
    surface.primaryAction === 'acknowledge' &&
...
function cloudGamingManualRequiredSurfaceIsHonest(surface: BrowserGameChildCheckingBlockSurfaceCandidate): boolean {
  return surface.state === 'manual-required' && surface.reasons.includes('cloud-gaming-proof-manual-required');
}

function nativeGameControlUnavailableSurfaceIsHonest(surface: BrowserGameChildCheckingBlockSurfaceCandidate): boolean {
