...
function structuredTaxonomy() {
  return {
    ...
    taxonomyVersionRef: 'browser-ai-riskbenefit-taxonomy-v1',
...
function educationalAssessment() {
  return {
    schemaVersion: BrowserAiRiskBenefitModelSchemaVersion,
    assessmentId: 'browser-ai-riskbenefit-assessment-math-video',
    taxonomyVersionRef: 'browser-ai-riskbenefit-taxonomy-v1',
...
function adultAssessment() {
  return {
    ...educationalAssessment(),
    assessmentId: 'browser-ai-riskbenefit-assessment-adult-video',
