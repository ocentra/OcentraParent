...
export const AppGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoffState = {
...
export type AppGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoffStateValue =
  (typeof AppGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoffState)[keyof typeof AppGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoffState];

export const RequiredAppGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoffNonClaims =
  [
    ...
    'no-parent-surface-status-read-model-parent-surface-read-model-runtime',
    'no-parent-surface-status-read-model-parent-surface-read-model-persistence',
...
export const AppGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoffNoClaimFlags =
  {
    ...
    parentSurfaceStatusReadModelParentSurfaceReadModelRuntimeImplemented: false,
    parentSurfaceStatusReadModelParentSurfaceReadModelPersisted: false,
...
type ParentSurfaceReadModelHandoffCounts = {
  rows: ReadonlyArray<{
    ...
    serviceResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoffState: AppGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoffStateValue;
  }>;
...
export function appGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoffCountsMatch(
...
export function appGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoffHasNoRuntimeClaims(
...
export function appGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoffMatchesParentSurfaceHandoff(
  parentSurfaceHandoffState: AppGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceHandoffStateValue,
  parentSurfaceReadModelHandoffState: AppGameTimerServiceResponseConsumerParentSurfaceStatusReadModelParentSurfaceReadModelHandoffStateValue
): boolean {
  if (
