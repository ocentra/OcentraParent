...
const NonEmptySocialAndroidCapabilityText = Schema.String.pipe(Schema.minLength(1));
...
export const SocialAndroidNativeAppCapabilityBoundarySchema = NonEmptySocialAndroidCapabilityText.pipe(
  Schema.brand('SocialAndroidNativeAppCapabilityBoundary')
);
