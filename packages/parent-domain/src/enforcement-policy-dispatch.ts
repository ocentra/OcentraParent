...
export const EnforcementPolicyDispatchReadModel = EnforcementPolicyDispatchReadModelSchema.parse({
  ...
  entries: [
    ...
    dispatchEntry({
      intentId: 'dispatch-app-game-category-risk-dry-run',
      matrixId: 'matrix-app-game-category-risk-dry-run',
      surface: 'windows-policy-dry-run-preview',
      platform: 'windows',
      adapterKind: 'process-control',
      requestedAction: 'dry-run-preview',
      mode: 'observe-only',
      ...
      approvalState: 'not-required',
      timerState: 'not-required',
      childReasonCode: 'child-reason-category-risk-policy-preview',
      targetType: 'app',
      targetValue: 'app-category:category-risk-route',
      evidenceReferences: ['evidence-app-game-category-risk-policy-route'],
      auditRefs: ['audit-app-game-category-risk-dry-run'],
      timerRefs: [],
      dryRun: true,
    }),
    dispatchEntry({
