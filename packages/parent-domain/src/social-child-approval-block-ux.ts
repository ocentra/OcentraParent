...
function socialChildApprovalBlockSurfaceIsHonest(surface: SocialChildApprovalBlockSurfaceCandidate): boolean {
  ...
  if (surface.surfaceKind === 'approval-request-pending') {
    return (
