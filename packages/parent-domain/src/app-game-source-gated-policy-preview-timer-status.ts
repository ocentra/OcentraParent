...
export const AppGameSourceGatedPolicyPreviewTimerStatusIdSchema =
  SourceGatedPolicyPreviewTimerStatusText.pipe(
    Schema.brand('AppGameSourceGatedPolicyPreviewTimerStatusId')
  );
export const AppGameSourceGatedPolicyPreviewTimerStatusRowIdSchema =
  SourceGatedPolicyPreviewTimerStatusText.pipe(
    Schema.brand('AppGameSourceGatedPolicyPreviewTimerStatusRowId')
  );
export const AppGameSourceGatedPolicyPreviewTimerStatusContractRefSchema =
  SourceGatedPolicyPreviewTimerStatusText.pipe(
    Schema.brand('AppGameSourceGatedPolicyPreviewTimerStatusContractRef')
  );
export const AppGameSourceGatedPolicyPreviewTimerProofRefSchema =
  SourceGatedPolicyPreviewTimerStatusText.pipe(
...
>;
export type AppGameSourceGatedPolicyPreviewTimerStatus = Infer<
  typeof AppGameSourceGatedPolicyPreviewTimerStatusSchema
>;
