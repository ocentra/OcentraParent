...
const NonEmptySyncExportText = Schema.String.pipe(Schema.minLength(1));
...
const ParentOwnedSyncExportManifestIdSchema = NonEmptySyncExportText.pipe(
  Schema.brand('ParentOwnedSyncExportManifestId')
);
const ParentOwnedSyncExportItemIdSchema = NonEmptySyncExportText.pipe(Schema.brand('ParentOwnedSyncExportItemId'));
const ParentOwnedSyncExportVersionLabelSchema = NonEmptySyncExportText.pipe(
  Schema.brand('ParentOwnedSyncExportVersionLabel')
);
const ParentOwnedSyncExportConnectorIdSchema = NonEmptySyncExportText.pipe(
  Schema.brand('ParentOwnedSyncExportConnectorId')
);
const ParentOwnedSyncExportConnectorRefSchema = NonEmptySyncExportText.pipe(
  Schema.brand('ParentOwnedSyncExportConnectorRef')
);
const ParentOwnedSyncExportCursorRefSchema = NonEmptySyncExportText.pipe(
  Schema.brand('ParentOwnedSyncExportCursorRef')
);
const ParentOwnedSyncExportBatchRefSchema = NonEmptySyncExportText.pipe(Schema.brand('ParentOwnedSyncExportBatchRef'));
const ParentOwnedSyncExportConflictRefSchema = NonEmptySyncExportText.pipe(
  Schema.brand('ParentOwnedSyncExportConflictRef')
);
const ParentOwnedSyncExportResultRefSchema = NonEmptySyncExportText.pipe(
  Schema.brand('ParentOwnedSyncExportResultRef')
);
const ParentOwnedSyncExportPolicyRefSchema = NonEmptySyncExportText.pipe(
  Schema.brand('ParentOwnedSyncExportPolicyRef')
);
const ParentOwnedSyncExportProofRequirementSchema = NonEmptySyncExportText.pipe(
  Schema.brand('ParentOwnedSyncExportProofRequirement')
);
