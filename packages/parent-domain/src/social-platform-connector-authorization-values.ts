...
const NonEmptySocialPlatformConnectorText = Schema.String.pipe(Schema.minLength(1));
...
export const SocialPlatformConnectorAuthorizationIdSchema = withParser(
  NonEmptySocialPlatformConnectorText.pipe(Schema.brand('SocialPlatformConnectorAuthorizationId'))
);
...
export const SocialPlatformConnectorBoundarySchema = NonEmptySocialPlatformConnectorText.pipe(
  Schema.brand('SocialPlatformConnectorBoundary')
);
