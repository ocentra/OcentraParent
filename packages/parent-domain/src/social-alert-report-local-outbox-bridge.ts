...
import { FamilyReferenceSchema, type FamilyReference, type ParentActionReference } from './references';
import {
...
const NonEmptySocialAlertReportOutboxBridgeText = Schema.String.pipe(Schema.minLength(1));
...
export const SocialAlertReportLocalOutboxBridgeIdSchema = NonEmptySocialAlertReportOutboxBridgeText.pipe(
  Schema.brand('SocialAlertReportLocalOutboxBridgeId')
);
export const SocialAlertReportLocalOutboxBridgeReferenceSchema = NonEmptySocialAlertReportOutboxBridgeText.pipe(
  Schema.brand('SocialAlertReportLocalOutboxBridgeReference')
);
