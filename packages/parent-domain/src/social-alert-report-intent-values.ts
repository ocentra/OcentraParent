...
const NonEmptySocialAlertReportText = Schema.String.pipe(Schema.minLength(1));
...
export const SocialAlertReportIntentIdSchema = withParser(
  NonEmptySocialAlertReportText.pipe(Schema.brand('SocialAlertReportIntentId'))
);
export const SocialAlertReportReferenceSchema = withParser(
  NonEmptySocialAlertReportText.pipe(Schema.brand('SocialAlertReportReference'))
);
