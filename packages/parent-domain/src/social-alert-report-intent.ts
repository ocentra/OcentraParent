...
import { ParentActionReferenceSchema, ParentDeviceReferenceSchema, ParentEvidenceReferenceSchema } from './references';
...
export const decodeSocialAlertReportIntent = Schema.decodeUnknownSync(SocialAlertReportIntentSchema);
