...
import { V08NotificationProviderStatusSchema } from './v0-8-notification-provider-status-boundary';
...
export const SocialAlertReportProviderReceiptBoundaryIdSchema = withParser(
  ReceiptBoundaryText.pipe(Schema.brand('SocialAlertReportProviderReceiptBoundaryId'))
);
export const SocialAlertReportProviderReceiptBoundaryReferenceSchema = withParser(
  ReceiptBoundaryText.pipe(Schema.brand('SocialAlertReportProviderReceiptBoundaryReference'))
);
