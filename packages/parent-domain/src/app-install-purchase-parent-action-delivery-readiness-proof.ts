...
const ParentActionDeliveryReadinessProofVersion =
  'app-install-purchase-parent-action-delivery-readiness-proof';
const SourceParentActionRuntimeHandoffProofVersion =
  'app-install-purchase-parent-action-runtime-handoff-proof';
...
const AppInstallPurchaseParentActionDeliveryReadinessDeliveryClaimSchema = withParser(
  Schema.Literal('not-delivered')
);
const AppInstallPurchaseParentActionDeliveryReadinessExecutionClaimSchema = withParser(
  Schema.Literal('not-executed')
);
const AppInstallPurchaseParentActionDeliveryReadinessIntegrationClaimSchema = withParser(
  Schema.Literal('not-claimed')
);
const AppInstallPurchaseParentActionDeliveryReadinessAdapterClaimSchema = withParser(
...
function parentActionDeliveryReadinessClaimsStayUnimplemented(
  row: ParentActionDeliveryReadinessRowCandidate
): boolean {
  return (
