...
const PreferenceText = Schema.String.pipe(Schema.minLength(1));
...
export const SocialAlertReportPreferencePreflightIdSchema = PreferenceText.pipe(
  Schema.brand('SocialAlertReportPreferencePreflightId')
);
export const SocialAlertReportPreferencePreflightReferenceSchema = PreferenceText.pipe(
  Schema.brand('SocialAlertReportPreferencePreflightReference')
);
