...
function browserGameAiResultPolicyInputIsSupported(value: BrowserGameAiAnalysisResultCandidate): boolean {
  ...
  if (
    value.recommendedPolicyInput === 'ask-parent-candidate' ||
    value.recommendedPolicyInput === 'block-candidate' ||
    value.recommendedPolicyInput === 'time-limit-candidate' ||
    value.recommendedPolicyInput === 'warn-candidate'
  ) {
...
function hasHighRisk(value: BrowserGameAiAnalysisResultCandidate): boolean {
  return value.riskSignals.some(
    (riskSignal) =>
      riskSignal === 'violence' ||
      riskSignal === 'adult-theme' ||
      riskSignal === 'gambling' ||
      riskSignal === 'purchase-risk' ||
      riskSignal === 'loot-box-risk'
  );
}
