...
const NonEmptySocialIosScreenTimeCapabilityText = Schema.String.pipe(Schema.minLength(1));
...
export const SocialIosScreenTimeCapabilityBoundarySchema = NonEmptySocialIosScreenTimeCapabilityText.pipe(
  Schema.brand('SocialIosScreenTimeCapabilityBoundary')
);
