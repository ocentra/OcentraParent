...
import {
  ...
  type BrowserGameReadModelSourceKind,
...
function browserGameJournalSqliteReadModelRowClaimsRuntime(
  ...
  return (
    row.rawUrlIncluded ||
    row.rawPageBodyIncluded ||
    row.rawGamePayloadIncluded ||
    row.rawGameTitleIncluded ||
    row.rawAccountOrPurchaseIncluded ||
    row.childCookieSessionReused ||
    row.cloudTitleCertaintyClaimed ||
    row.browserMutationClaimed ||
    row.renderedUiClaimed ||
