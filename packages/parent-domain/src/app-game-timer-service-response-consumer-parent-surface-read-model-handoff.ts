...
import {
  AppGameTimerServiceResponseConsumerParentSurfaceHandoffIdSchema,
  ...
  AppGameTimerServiceResponseConsumerParentSurfaceProofRefSchema,
  type AppGameTimerServiceResponseConsumerParentSurfaceHandoffRowSchema as ParentSurfaceHandoffRowSchema,
} from './app-game-timer-service-response-consumer-parent-surface-handoff';
import {
...
export function buildAppGameTimerServiceResponseConsumerParentSurfaceReadModelHandoff(
  ...
  return AppGameTimerServiceResponseConsumerParentSurfaceReadModelHandoffSchema.parse({
    ...
    sourceServiceResponseConsumerParentSurfaceHandoffId:
      parsedParentSurfaceHandoff.serviceResponseConsumerParentSurfaceHandoffId,
...
function mapParentSurfaceReadModelHandoffState(
  state: ParentSurfaceHandoffRow['serviceResponseConsumerParentSurfaceHandoffState']
