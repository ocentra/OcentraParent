...
import { BillingInvoiceTaxRefundDisputeProofReadModel } from '@ocentra-parent/billing-domain/billing-invoice-tax-refund-dispute';
...
describe('parent billing entitlement proof surface', () => {
  it(
