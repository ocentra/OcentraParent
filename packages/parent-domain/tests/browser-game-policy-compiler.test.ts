...
describe('browser game parent policy compiler contracts', () => {
  ...
  it('accepts ask-parent, time-limit, manual-review, and unknown fallback candidates', acceptsFallbacks);
  it(
...
function policyInput(overrides = {}) {
  return {
    ...
    analysisRefs: ['browser-game-risk-benefit-signal-set-cloud'],
