...
describe('social parent policy compiler contracts', () => {
  ...
  it('accepts ask-parent, manual-review, and unknown fallback candidates with required reasons', acceptsFallbacks);
...
function rejectsDecisionClaims() {
  ...
  const invalidRows = [
    ...
    { ...valid, actionCandidate: 'ask-parent-candidate', parentApprovalRequired: false },
...
function policyInput(overrides = {}) {
  return {
    ...
    signalSetRefs: ['social-risk-benefit-signal-set-video'],
