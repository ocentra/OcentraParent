...
function rejectsInconsistentStates() {
  const invalidRequests = [
    { managedRouteEvidenceRef: null },
    { expiresAt: null },
    { actionCandidate: 'ask-parent-candidate', parentApprovalRequestRef: null },
    { actionCandidate: 'ask-parent-candidate', reasonCodes: ['known-cloud-domain'] },
    ...
    { gateState: 'manual-required', actionCandidate: 'ask-parent-candidate' },
...
function cloudDecision(overrides = {}) {
  return {
    ...
    decisionKind: 'ask-parent-candidate',
