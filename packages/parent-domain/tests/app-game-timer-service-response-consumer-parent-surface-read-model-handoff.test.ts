...
import { AppGameTimerServiceResponseConsumerParentSurfaceHandoffSchema } from '../src/app-game-timer-service-response-consumer-parent-surface-handoff';
import {
...
const UpstreamParentSurfaceHandoffPath = new URL(
  '../../../test-results/app-game-timer-service-response-consumer-parent-surface-handoff-proof/handoff.json',
  import.meta.url
);
