...
const SetupFirstRunStateGraph: { [StateId in SetupFirstRunStateId]: SetupFirstRunStateDefinition } = {
  ...
  'setup-degraded': {
    ...
    baseNextStateIds: [SetupFirstRunStateId.DataCustody, SetupFirstRunStateId.ManualRequired, SetupFirstRunStateId.SetupBlocked],
    readinessGate: true,
    terminal: true,
  },
  'manual-required': {
...
export function getAllowedSetupFirstRunTransitions(input: SetupFirstRunStateId): readonly SetupFirstRunStateId[] {
  ...
  const nextStateIds = [...definition.baseNextStateIds, SetupFirstRunStateId.ManualRequired, SetupFirstRunStateId.SetupBlocked];
