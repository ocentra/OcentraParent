...
const NonEmptyPublicationStatusFreshnessText = Schema.String.pipe(Schema.minLength(1));
...
export const PublicationStatusFreshnessReferenceSchema = NonEmptyPublicationStatusFreshnessText.pipe(
  Schema.brand('ProductionSupportPublicationStatusFreshnessReference')
);
export const PublicationStatusFreshnessRequirementSchema = NonEmptyPublicationStatusFreshnessText.pipe(
  Schema.brand('ProductionSupportPublicationStatusFreshnessRequirement')
);
