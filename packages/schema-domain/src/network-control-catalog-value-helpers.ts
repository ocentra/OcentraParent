...
export function optionLabels(settingId: string, labels: readonly string[]) {
...
export function isDefaultOption(defaultValue: NetworkControlCatalogDefaultValue, optionValue: string) {
