...
type BrowserGameMetadataFieldStatusValidator = (field: BrowserGameMetadataFieldShapeCandidate) => boolean;

const BrowserGameMetadataFieldStatusValidators = {
  'extracted-shape': extractedMetadataFieldShapeIsHonest,
  'candidate-shape': candidateMetadataFieldShapeIsHonest,
  'manual-required': degradedMetadataFieldShapeIsHonest,
  unavailable: degradedMetadataFieldShapeIsHonest,
} satisfies Record<BrowserGameMetadataFieldShapeCandidate['status'], BrowserGameMetadataFieldStatusValidator>;
...
function browserGameMetadataFieldShapeIsHonest(field: BrowserGameMetadataFieldShapeCandidate): boolean {
  ...
  return BrowserGameMetadataFieldStatusValidators[field.status](field);
}

function extractedMetadataFieldShapeIsHonest(field: BrowserGameMetadataFieldShapeCandidate): boolean {
  return (
...
function candidateMetadataFieldShapeIsHonest(field: BrowserGameMetadataFieldShapeCandidate): boolean {
  return field.confidence !== 'high' && field.fieldKind !== 'unknown' && field.sourceKind !== 'unavailable';
}

function degradedMetadataFieldShapeIsHonest(field: BrowserGameMetadataFieldShapeCandidate): boolean {
  return field.confidence !== 'high' && metadataFieldHasDegradedMarker(field);
}

function metadataFieldHasDegradedMarker(field: BrowserGameMetadataFieldShapeCandidate): boolean {
  return (
    field.fieldKind === 'unknown' ||
    field.sourceKind === 'manual-review-ref' ||
    field.sourceKind === 'unavailable' ||
