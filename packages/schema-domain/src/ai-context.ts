...
import { PolicyRuleIdSchema, PolicyRuleSchema } from './policy-contracts';
import {
...
import { LocalAiGraphReferenceSchema, LocalAiMemoryReferenceSchema } from './ai-references';
...
import {
  ...
  type LocalAiConfidenceKind,
  type LocalAiContextBuildState,
  type LocalAiContextCapabilityStatus,
  type LocalAiContextReasonCode,
  type LocalAiEvidenceAdapterId,
  type LocalAiEvidenceContextId,
  ...
  type LocalAiEvidenceRetentionState,
  type LocalAiEvidenceSourceId,
  type LocalAiParentRuleContextRefId,
  type LocalAiRejectedField,
  type LocalAiRequestedEvaluationKind,
