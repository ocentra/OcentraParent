...
import { SocialAlertReportIntentSchema, type SocialAlertReportIntent } from './agent-social-alert-report-intent';

export const SocialAlertReportReadModelClaimBoundariesSchema = Schema.Struct({
...
export const SocialAlertReportProviderStatusRowSchema = Schema.Struct({
