...
export const ScreenAiEnforcementHandoffGuardPayloadIdSchema = brandedNonEmptyStringSchema(
  'ScreenAiEnforcementHandoffGuardPayloadId'
);
export const ScreenAiEnforcementHandoffGuardAuditEventIdSchema = brandedNonEmptyStringSchema(
  'ScreenAiEnforcementHandoffGuardAuditEventId'
);
export const ScreenAiEnforcementHandoffGuardBoundarySchema = brandedNonEmptyStringSchema(
  'ScreenAiEnforcementHandoffGuardBoundary'
);
