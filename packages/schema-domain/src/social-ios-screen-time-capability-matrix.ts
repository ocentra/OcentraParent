...
export const decodeSocialIosScreenTimeCapabilityMatrix = (input: unknown) =>
  SocialIosScreenTimeCapabilityMatrixSchema.parse(input);
...
function socialIosScreenTimeCapabilityRowIsHonest(row: SocialIosScreenTimeCapabilityRowCandidate): boolean {
  ...
  return SocialIosScreenTimeCapabilityRowValidators[row.surface as SocialIosScreenTimeCapabilitySurface](row);
}
