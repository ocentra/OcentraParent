import { AgentEventDeliveryMode, AgentEventEnvelopeSchema } from './event-primitives';
...
export const ChildDomainRuntimeEventTypeSchema = withParser(
  Schema.Literal(
    ...Object.values(ChildDomainRuntimeEventTypeLiteral) as [
      typeof ChildDomainRuntimeEventTypeLiteral[keyof typeof ChildDomainRuntimeEventTypeLiteral],
      ...Array<typeof ChildDomainRuntimeEventTypeLiteral[keyof typeof ChildDomainRuntimeEventTypeLiteral]>
    ]
  ).pipe(
    Schema.filter(
      (eventType) =>
...
export const ChildDomainRuntimeEventType = {
  ...
  AppAiAnalysisRequested: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.AppAiAnalysisRequested),
  AppPolicyEvaluationRequested: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.AppPolicyEvaluationRequested),
  AppGameObserved: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.AppGameObserved),
  AppGameEvidenceRecorded: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.AppGameEvidenceRecorded),
  AppGameAiAnalysisRequested: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.AppGameAiAnalysisRequested),
  AppGamePolicyEvaluationRequested: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.AppGamePolicyEvaluationRequested),
  BrowserObserved: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.BrowserObserved),
  BrowserEvidenceRecorded: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.BrowserEvidenceRecorded),
  BrowserAiAnalysisRequested: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.BrowserAiAnalysisRequested),
  BrowserPolicyEvaluationRequested: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.BrowserPolicyEvaluationRequested),
  ...
  LanAiAnalysisRequested: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.LanAiAnalysisRequested),
  LanPolicyEvaluationRequested: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.LanPolicyEvaluationRequested),
  NetworkObserved: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.NetworkObserved),
  NetworkEvidenceRecorded: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.NetworkEvidenceRecorded),
  NetworkAiAnalysisRequested: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.NetworkAiAnalysisRequested),
  NetworkPolicyEvaluationRequested: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.NetworkPolicyEvaluationRequested),
  ScreenObserved: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.ScreenObserved),
  ScreenEvidenceRecorded: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.ScreenEvidenceRecorded),
  ScreenAiAnalysisRequested: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.ScreenAiAnalysisRequested),
  ScreenPolicyEvaluationRequested: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.ScreenPolicyEvaluationRequested),
  ScreenLiveViewObserved: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.ScreenLiveViewObserved),
  ScreenLiveViewEvidenceRecorded: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.ScreenLiveViewEvidenceRecorded),
  ScreenLiveViewAiAnalysisRequested: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.ScreenLiveViewAiAnalysisRequested),
  ScreenLiveViewPolicyEvaluationRequested: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.ScreenLiveViewPolicyEvaluationRequested),
  AiAnalysisCompleted: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.AiAnalysisCompleted),
  PolicyViolationDetected: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.PolicyViolationDetected),
  NotificationRequested: ChildDomainRuntimeEventTypeSchema.parse(ChildDomainRuntimeEventTypeLiteral.NotificationRequested),
} as const;
...
export const ChildDomainPolicyEvaluationRequirement = {
  ...
  NotRequired: ChildDomainPolicyEvaluationRequirementSchema.parse(ChildDomainPolicyEvaluationRequirementLiteral.NotRequired),
} as const;
