...
export const GeneratedParentStorageSettingsApplyFlowContractProof = {
  ...
  "claimSafeCopy": [
    ...
    },
    {
      ...
      "statement": "Your selected storage provider may see encrypted file metadata such as file name, size, and modified time.",
      "forbiddenWithoutState": true,
      "notes": "Claim-safe copy only; no success-looking shorthand without proof state."
    },
    {
    ...
    },
    {
      ...
      "statement": "If you lose your recovery key or device keys, Ocentra may not be able to recover encrypted child activity data.",
      "forbiddenWithoutState": true,
      "notes": "Claim-safe copy only; no success-looking shorthand without proof state."
    },
    {
      "copyKey": "disconnect-does-not-delete",
      "statement": "Disconnecting a provider stops future sync but does not automatically delete files already written there unless you request deletion and proof succeeds.",
      "forbiddenWithoutState": true,
      "notes": "Claim-safe copy only; no success-looking shorthand without proof state."
    },
    {
