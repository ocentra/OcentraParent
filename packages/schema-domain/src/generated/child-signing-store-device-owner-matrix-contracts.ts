...
export type GeneratedChildArtifactMatrixSigningState =
  | 'unsigned'
  | 'debug-signed'
  | 'signing-disabled';
  ...
  "rows": [
    {
      ...
      "signingBoundary": "Windows MSI packaging script signs the updater manifest but does not Authenticode-sign the child MSI or service binaries in this proof surface",
      "storeBoundary": "Windows child artifact is a direct MSI download; no Microsoft Store or other store publication is claimed",
      "managementBoundary": "Windows child artifact has no device-owner, managed-profile, or supervision claim in this matrix",
      "claimBoundary": "Windows row proves MSI/service packaging and signed update-manifest wiring only; it does not prove signed child artifacts, store publication, or parent-client parity"
    },
    {
      "platform": "macos",
      ...
      "managedProfileState": "not-applicable",
      "supervisionState": "not-applicable",
      "signingBoundary": "macOS child package stays unsigned in this proof surface because no codesign or productsign artifact is attached",
      "storeBoundary": "macOS child artifact is a direct pkg download; no Mac App Store or other store publication is claimed",
      "managementBoundary": "macOS child artifact has no device-owner, managed-profile, or supervision claim in this matrix",
      "claimBoundary": "macOS row proves launchd pkg packaging only; it does not prove notarization, store publication, uninstall cleanup, or parent-client parity"
    },
    {
      "platform": "linux",
      ...
      "managedProfileState": "not-applicable",
      "supervisionState": "not-applicable",
      "signingBoundary": "the child Linux package is unsigned in this proof surface because no debsig, dpkg-sig, GPG, or repository signature artifact is attached",
      "storeBoundary": "Linux child artifact is a direct .deb download; no apt repository, Snap, or other store publication is claimed",
      "managementBoundary": "Linux child artifact has no device-owner, managed-profile, or supervision claim in this matrix",
      "claimBoundary": "Linux row proves systemd .deb packaging and baseline metadata only; it does not prove signed repositories, store publication, or parent-client parity"
    },
    {
      "platform": "android",
      ...
      "supervisionState": "not-applicable",
      "signingBoundary": "Android child artifact is a debug APK build; Play Store signing remains planned and not collected",
      "storeBoundary": "Android Play Store distribution remains planned and not collected; debug APK proof does not claim release-track publication",
      "managementBoundary": "Android device-owner and managed-profile states remain manual-required without enrollment evidence",
      "claimBoundary": "Android row proves debug APK package output only; it does not prove device-owner, managed-profile, Play Store distribution, or parent-client parity"
    },
    {
      "platform": "ios",
      ...
      "signingBoundary": "iOS simulator package is built with code signing disabled; Apple signing, provisioning, and entitlements remain manual-required",
      "storeBoundary": "iOS TestFlight and App Store distribution remain device-proof-required or planned; simulator ZIP proof does not claim store publication",
      "managementBoundary": "iOS supervision remains device-proof-required; no device-owner or managed-profile claim exists for the child iOS slice",
      "claimBoundary": "iOS row proves simulator scaffold packaging only; it does not prove Apple provisioning, supervision parity, hidden daemon authority, or parent-client parity"
    }
  ],
  "claimBoundaries": {
    "genericMatrix": "matrix rows summarize platform-specific package or proof artifacts only; they do not replace platform-specific package, device, or store proof",
    "signingParity": "artifact signing states stay row-specific; signed update manifests, debug APK signatures, or unsigned simulator builds do not imply cross-platform signing parity",
    "storeParity": "store states stay row-specific; direct-download rows do not claim Microsoft Store, Mac App Store, Linux repository publication, Play Store, TestFlight, or App Store publication",
