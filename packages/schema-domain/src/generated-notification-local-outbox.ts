...
export const GeneratedNotificationLocalOutboxProviderChannels = [
  "push",
  "email",
  "sms",
  "whatsapp",
...
export const GeneratedNotificationLocalOutboxProofRows = [
  ...
  },
  {
    ...
    "manualProofRequirements": [
      "real provider receipt artifact required before delivery can be claimed"
    ],
    "manualActionRequired": true,
  ...
  },
  {
    ...
    "providerReceiptRef": null,
    "manualProofRequirements": [
      "parent/provider preference setup required before send path can be enabled"
    ],
    "manualActionRequired": true,
...
export const GeneratedNotificationLocalOutboxSchedulerArtifactRef = "parent-owned-local-notification-outbox-scheduler-jsonl-ref" as const;
...
export const GeneratedNotificationLocalOutboxSchedulerProofRows = [
  ...
  },
  {
    ...
    "manualProofRequirements": [],
    "manualActionRequired": false,
    "schedulerPayloadPreview": "alert id, whatsapp channel, sync failure reason, quiet-hours hold, authenticated drill-in"
  },
  {
  ...
  },
  {
    ...
    "providerReceiptRef": null,
    "manualProofRequirements": [
      "provider setup review required before retry worker can be enabled"
    ],
    "manualActionRequired": true,
  ...
  },
  {
    ...
    "providerReceiptRef": "provider-receipt-required-ref",
    "manualProofRequirements": [
      "real provider receipt artifact required before delivered state can be claimed"
    ],
    "manualActionRequired": true,
  ...
  },
  {
    ...
    "providerReceiptRef": null,
    "manualProofRequirements": [
      "parent/provider preference setup required before notification worker can be enabled"
    ],
    "manualActionRequired": true,
    "schedulerPayloadPreview": "alert id, in-app channel, device offline reason, manual required, authenticated parent link"
  }
] as const;
