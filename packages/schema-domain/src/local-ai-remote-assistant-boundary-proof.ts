...
const PolicyActionStrictnessRank = Object.freeze({
...
function comparePolicyActionStrictness(
  left: keyof typeof PolicyActionStrictnessRank,
  right: keyof typeof PolicyActionStrictnessRank
): number {
  const leftRank = PolicyActionStrictnessRank[left] ?? 0;
