...
import { PortalDevTrackingReportText, PortalDevTrackingReportTextToken } from './text-portal-dev-tracking-report';
import {
  PortalDevTrackingUnsupportedText,
  PortalDevTrackingUnsupportedTextToken,
} from './text-portal-dev-tracking-unsupported';
import { PortalProductText, PortalProductTextToken } from './text-portal-product';
...
export const PortalDevTextToken = {
  ...
  GetLanPairingStatus: decodeTextTokenId('portal.dev.command.getLanPairingStatus'),
...
export const PortalDevText: Record<PortalDevTextTokenValue, DisplayText> = {
  ...
  [PortalDevTextToken.GetLanPairingStatus]: decodeDisplayText('Refresh LAN pairing status'),
