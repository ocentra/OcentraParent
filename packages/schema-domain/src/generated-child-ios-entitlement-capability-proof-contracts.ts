...
export const GeneratedChildIosEntitlementCapabilityReadModel =
  ...
  "protocolBridgeProof": {
    ...
    "proofRequirement": "iOS simulator scaffold status surface names capability-only launch, recovery, entitlement, provisioning, and supervision states",
    "claimBoundary": "status surface is capability-only; no hidden daemon, persistent background service, launch recovery, external child-agent transport, Apple entitlement, provisioning, or device proof is claimed"
  },
  "surfaceProofs": [
    {
  ...
  "packageLifecycleProofs": [
    {
      ...
      "claimBoundary": "xcode-project-target does not upgrade iOS child capability without entitlement signing or device evidence"
    },
    {
      ...
      "claimBoundary": "bundle-identifier does not upgrade iOS child capability without entitlement signing or device evidence"
    },
    {
      ...
      "claimBoundary": "simulator-build-script does not upgrade iOS child capability without entitlement signing or device evidence"
    },
    {
      "phase": "status-view",
      "proofState": "simulator-scaffold",
    ...
    },
    {
      ...
      "claimBoundary": "simulator-build does not upgrade iOS child capability without entitlement signing or device evidence"
    },
    {
      ...
      "claimBoundary": "simulator-launch does not upgrade iOS child capability without entitlement signing or device evidence"
    },
    {
      ...
      "claimBoundary": "device-install does not upgrade iOS child capability without entitlement signing or device evidence"
    },
    {
      "phase": "device-launch",
      "proofState": "device-proof-required",
      ...
      "claimBoundary": "device-launch does not upgrade iOS child capability without entitlement signing or device evidence"
    },
    {
      ...
      "claimBoundary": "testflight-install does not upgrade iOS child capability without entitlement signing or device evidence"
    },
    {
      ...
      "claimBoundary": "signing-profile does not upgrade iOS child capability without entitlement signing or device evidence"
    },
    {
      ...
      "claimBoundary": "entitlement-review does not upgrade iOS child capability without entitlement signing or device evidence"
    },
    {
      ...
      "claimBoundary": "recovery-behavior does not upgrade iOS child capability without entitlement signing or device evidence"
    }
  ],
  "claimBoundaries": {
    "simulatorPackage": "Xcode project target, bundle id, plist, status view, and package script are source proof only",
    "launchAvailability": "simulator and physical-device launch availability remain manual-required or device-proof-required without Apple host or device artifacts",
    ...
    "recoveryBehavior": "launch recovery remains not-implemented; no iOS daemon, relaunch, or persistent background recovery is claimed",
    "provisioningProfile": "provisioning remains manual-required without Apple signing credentials, provisioning profile artifacts, and install evidence",
    ...
    "capabilityOnlyState": "iOS child runtime remains capability-only; no hidden daemon or persistent background service is claimed",
