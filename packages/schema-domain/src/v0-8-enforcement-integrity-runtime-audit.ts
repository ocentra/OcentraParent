...
} satisfies Record<V08EnforcementIntegrityRuntimeAuditResult, readonly V08EnforcementIntegrityRuntimeAuditExecution[]>;
...
function executionIsAllowed(
  allowedExecutions: readonly V08EnforcementIntegrityRuntimeAuditExecution[],
...
function noExecutionEntry(
  input: Pick<
    V08EnforcementIntegrityRuntimeAuditEntryInput,
    'auditEntryId' | 'result' | 'execution' | 'intentState' | 'timerState' | 'rollbackState' | 'childState' | 'boundary'
  > &
...
function manualEntry(
  input: Pick<
    V08EnforcementIntegrityRuntimeAuditEntryInput,
    'auditEntryId' | 'surface' | 'manualProofRequirements' | 'boundary'
  > &
