...
export function decodeScreenAiBrowserTriggerProofRow(input: unknown): ScreenAiBrowserTriggerProofRow {
  return ScreenAiBrowserTriggerProofRowSchema.parse(input);
}

export function decodeScreenAiBrowserTriggerProof(input: unknown): ScreenAiBrowserTriggerProof {
  return ScreenAiBrowserTriggerProofSchema.parse(input);
}
