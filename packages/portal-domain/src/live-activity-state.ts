...
import { parsePortalLanAddDeviceReadModel, type PortalLanAddDeviceReadModel } from './live-activity-lan-add-device';
...
function resolveLanPairingState(events: readonly AgentEventEnvelope[]) {
  ...
  return {
    ...
    lanAddDeviceReadModel:
      lanPairingStatusEvent === null ? null : parsePortalLanAddDeviceReadModel(lanPairingStatusEvent.payload),
  };
}
