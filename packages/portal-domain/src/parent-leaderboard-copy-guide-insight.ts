...
export const PARENT_LEADERBOARD_COPY_INSIGHT_GUIDES: readonly ParentLeaderboardCopyGuideTopic[] = [
  {
    id: 'local-ai-assistant',
    navLabel: 'AI',
    rank: 7,
    title: 'AI And Assistant',
    subtitle: 'Local evaluator first, parent Q&A later',
    ...
    pages: [
      ...
      {
        eyebrow: 'PARENT CHAT',
        title: 'Parent Q&A should answer from evidence and reports',
        body: 'The portal can later include a parent chat surface where a parent asks questions such as what changed this week, why a rule fired, or whether a child spent time in games. That assistant must cite stored evidence or parent-owned report bundles and stay outside blocking decisions.',
        steps: [
          ...
          'Show when the assistant is unavailable, local-only, remote-authorized, or missing evidence.',
        ],
      },
      {
    ...
    actions: [
      ...
      },
      {
        ...
        body: 'Use Assistant later for evidence-cited parent explanations and summaries.',
        tone: 'purple',
        targetNavLabel: 'CHAT',
      },
    ],
