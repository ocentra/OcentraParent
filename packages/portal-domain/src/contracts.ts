...
const PortalDom = {
  ...
  BackgroundDevToolHashFlag: PortalDevToolWindow.BackgroundFrameTunerQuery,
  EmptyHashRoute: '',
  Ids: {
  ...
  Classes: {
    AppGameSessionsRoutePanel: 'app-game-sessions-route-panel',
    AppGameSessionsRoutePanelBody: 'app-game-sessions-route-panel-body',
    AppGameSessionsRoutePanelDisclosure: 'app-game-sessions-route-panel-disclosure',
    AppGameSessionsRoutePanelDrawers: 'app-game-sessions-route-panel-drawers',
    AppGameSessionsRoutePanelShell: 'app-game-sessions-route-panel-shell',
    AppGameSessionsRoutePanelState: 'app-game-sessions-route-panel-state',
    AppGameSessionsRoutePanelToolbar: 'app-game-sessions-route-panel-toolbar',
    ...
    ParentDesktopDistributionRoutePanel: 'parent-desktop-distribution-route-panel',
    ParentPortalRouteSurface: 'parent-portal-route-surface',
    ParentStatusDock: 'parent-status-dock',
    ParentStatusDockDisclosure: 'parent-status-dock-disclosure',
    ParentStatusDockState: 'parent-status-dock-state',
    ParentStatusDockToolbar: 'parent-status-dock-toolbar',
    ...
    PolicyCategoryRouteCopy: 'policy-category-route-copy',
    PolicyPreviewUnavailableCopy: 'policy-preview-unavailable-copy',
    ...
    State: 'state',
    SetupFirstRunDetailCard: 'setup-first-run-detail-card',
    SetupFirstRunDetailContent: 'setup-first-run-detail-content',
    SetupFirstRunDetailSummary: 'setup-first-run-detail-summary',
    SetupFirstRunDetailTitle: 'setup-first-run-detail-title',
    SetupFirstRunRoutePanel: 'setup-first-run-route-panel',
    Summary: 'summary',
