...
export const PARENT_PORTAL_NAV_GROUPS: readonly ParentPortalNavGroup[] = [
  ...
  { id: 'guide', label: PARENT_PORTAL_NAV_LABELS.Guide, detail: 'Policy, privacy, and local AI' },
  {
    ...
    detail: 'Portal, device, activity, policy, data, remote, AI, account',
  },
  {
    id: 'devTools',
...
export const PARENT_PORTAL_NAV_ITEMS: readonly ParentPortalNavItem[] = [
  ...
  },
  {
    ...
    detail: 'Service and control readiness',
    icon: 'policy',
    tabId: 'overall',
    groupId: 'quickGlance',
    tone: 'cyan',
  ...
  },
  {
    ...
    detail: 'Authenticated remote sessions',
    icon: 'remote',
    tabId: 'controls',
    groupId: 'manage',
    tone: 'purple',
  ...
  },
  {
    ...
    detail: 'Desktop package and platform status',
    icon: 'devices',
    tabId: 'support',
    groupId: 'manage',
    tone: 'cyan',
  ...
  },
  {
    ...
    detail: 'Update channel and rollback status',
    icon: 'updates',
    tabId: 'support',
    groupId: 'manage',
    tone: 'gold',
