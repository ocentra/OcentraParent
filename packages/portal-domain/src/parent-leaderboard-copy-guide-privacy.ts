...
export const PARENT_LEADERBOARD_COPY_PRIVACY_GUIDES: readonly ParentLeaderboardCopyGuideTopic[] = [
  {
    id: 'data-custody',
    navLabel: 'PRIVATE',
    rank: 10,
    ...
    actions: [
      ...
      },
      {
        ...
        body: 'Use Support only when you choose to share diagnostics or support bundles.',
        tone: 'cyan',
