...
} from '../../src/tracking-child-check-in-proof';
...
function trackingProjectionInput(readModel = TrackingReadModel): Parameters<typeof trackingStatusLiveSummary>[0] {
  return {
...
function parsedTrackingRetentionSettingsWriteResult(): Parameters<typeof trackingRetentionSettingsHostedUiProof>[0] {
  return {
    parseState: 'parsed',
