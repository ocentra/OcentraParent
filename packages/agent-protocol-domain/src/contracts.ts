...
export const AgentCommandNameSchema = withParser(
  Schema.Literal(
    ...
    'agent.activity.tracking.retention-settings.mutate',
...
export const AgentEventNameSchema = withParser(
  Schema.Literal(
    ...
    'agent.activity.tracking.retention-settings.mutation.reported',
...
export const AgentCommand = {
  ...
  ActivityTrackingRetentionSettingsMutate: AgentCommandNameSchema.parse(
    'agent.activity.tracking.retention-settings.mutate'
  ),
...
export const AgentEvent = {
  ...
  ActivityTrackingRetentionSettingsMutationReported: AgentEventNameSchema.parse(
    'agent.activity.tracking.retention-settings.mutation.reported'
  ),
