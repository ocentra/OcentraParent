...
describe('app game runtime evidence contracts', () => {
  it('AppGameRuntimeEvidenceSchema: accepts running process evidence with metadata refs', assertRunningProcessRuntimeEvidence);
  it('AppGameRuntimeEvidenceSchema: keeps launcher process evidence as launcher state', assertLauncherRuntimeStaysLauncher);
  it(
  ...
  it('AppGameRuntimeEvidenceSchema: rejects runtime evidence that claims foreground', assertRuntimeEvidenceCannotClaimForeground);
});
