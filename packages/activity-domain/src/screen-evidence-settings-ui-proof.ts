...
const ScreenSettingsUiCopy = {
  title: 'Writable screen-analysis settings proof',
  ...
  intentLegend: 'Screen-analysis intent',
  draftHeading: 'Draft setting fields',
  retentionHeading: 'Retention and live-view boundary',
