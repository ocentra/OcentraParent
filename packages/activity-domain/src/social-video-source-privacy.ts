...
import { BrowserAiConfidenceSchema, BrowserAiDegradedStateSchema } from './browser-ai-analysis-schemas';
...
export const SocialVideoSourcePrivacyEvidenceIdSchema = withParser(
  NonEmptySocialVideoSourcePrivacyText.pipe(Schema.brand('SocialVideoSourcePrivacyEvidenceId'))
);
export const SocialVideoParentProvidedTargetRefSchema = withParser(
  NonEmptySocialVideoSourcePrivacyText.pipe(Schema.brand('SocialVideoParentProvidedTargetRef'))
);
export const SocialVideoConnectorAuthorizationRefSchema = withParser(
  NonEmptySocialVideoSourcePrivacyText.pipe(Schema.brand('SocialVideoConnectorAuthorizationRef'))
);
