...
function socialUnmanagedBypassEvidenceClaimsRuntime(
  ...
  return (
    value.exactUrlClaimed ||
    value.routeEvidenceClaimed ||
    value.socialAccountProofClaimed ||
    value.feedVideoRouteClaimed ||
    ...
    value.processTerminatedClaimed ||
    value.managedBrowserRelaunchedClaimed ||
