...
import { ActivitySourceIdSchema, ActivityTimestampSchema } from './primitives';
...
function browserPerformanceHealthRowIsConsistent(value: Infer<typeof BrowserPerformanceHealthRowBaseSchema>) {
  ...
  return (
    value.observedMs === null &&
    value.manualRequiredReason !== null &&
    (value.proofSource === 'manual-platform' ||
      value.proofSource === 'not-implemented' ||
      value.proofSource === 'future-work')
  );
}
