...
function socialAccountIdentityEntryClaimsAuthority(
  ...
  return (
    value.rawHandleCaptured ||
    value.rawDisplayNameCaptured ||
    value.rawPlatformAccountIdCaptured ||
    value.credentialCaptured ||
    value.identityVerifiedByPlatform ||
    value.childDeclaredIdentity ||
    value.accountCreationClaimed ||
    value.loginSuccessClaimed ||
