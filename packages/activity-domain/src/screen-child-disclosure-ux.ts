...
function pausedDisclosureStatusIsConsistent(value: ScreenChildDisclosureStatusBase): boolean {
  return value.indicator === 'paused' && value.capabilityStatus === 'ready' && !value.captureActive && value.pausedByParent;
}

function readyDisclosureStatusIsConsistent(value: ScreenChildDisclosureStatusBase): boolean {
  return value.indicator === 'ready' && value.capabilityStatus === 'ready' && !value.captureActive && !value.pausedByParent;
}

function captureActiveDisclosureStatusIsConsistent(value: ScreenChildDisclosureStatusBase): boolean {
  return value.indicator === 'active' && value.capabilityStatus === 'ready' && value.captureActive && !value.pausedByParent;
}
