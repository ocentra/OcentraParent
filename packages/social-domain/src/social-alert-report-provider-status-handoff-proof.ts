...
} from './social-alert-report-provider-preflight-proof';
import {
...
export const SocialAlertReportProviderStatusHandoffIdSchema = withParser(
  HandoffText.pipe(Schema.brand('SocialAlertReportProviderStatusHandoffId'))
);
export const SocialAlertReportProviderStatusHandoffReferenceSchema = withParser(
  HandoffText.pipe(Schema.brand('SocialAlertReportProviderStatusHandoffReference'))
);
