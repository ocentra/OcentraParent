...
export const SocialAlertReportPreferenceStatusHandoffIdSchema = HandoffText.pipe(
  Schema.brand('SocialAlertReportPreferenceStatusHandoffId')
);
export const SocialAlertReportPreferenceStatusHandoffReferenceSchema = HandoffText.pipe(
  Schema.brand('SocialAlertReportPreferenceStatusHandoffReference')
);
