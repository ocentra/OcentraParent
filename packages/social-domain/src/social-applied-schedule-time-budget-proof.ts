...
const NonEmptySocialAppliedScheduleText = Schema.String.pipe(Schema.minLength(1));
const SocialAppliedScheduleReferenceSchema = withParser(
  NonEmptySocialAppliedScheduleText.pipe(Schema.brand('SocialAppliedScheduleReference'))
);
