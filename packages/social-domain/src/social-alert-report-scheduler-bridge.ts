...
// prettier-ignore
export const SocialAlertReportSchedulerBridgeIdSchema = BridgeText.pipe(Schema.brand('SocialAlertReportSchedulerBridgeId'));
// prettier-ignore
export const SocialAlertReportSchedulerBridgeReferenceSchema = BridgeText.pipe(Schema.brand('SocialAlertReportSchedulerBridgeReference'));
