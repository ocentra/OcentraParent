...
evidence rows into parent-owned external runtime handoff packet/queue refs, and
link those receipts to parent-owned runtime report writer delivery-ready rows
and report receipts, expose
