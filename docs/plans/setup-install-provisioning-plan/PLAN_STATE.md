...
- WP05 pairing/readiness/recovery proof root now exists, but pairing/bootstrap redaction ownership proof is still blocker-only.
- WP06 rollout blocker pack now consumes WP07 and the repaired WP03 build state, but whole-plan rollout remains blocked by sibling owner proofs plus the remaining WP05 redaction-ownership gap.
