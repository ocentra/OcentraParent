...
- Plan owner: `setup-install-provisioning-plan/AGENTS.md` with account/portal onboarding, bootstrap, and install-readiness lanes.
- Ownership boundary: family website boundary, invite/code handoff, install/setup proof states, and deployment surface constraints.
...
- Decision path:
  ...
  - If install/readiness/bootstrap states are undefined -> block rollout planning and keep plan claims at "proof open".
...
- Failure modes:
  ...
  - Parent bootstrap and child pairing merged into one download claim.
...
- [ ] Define parent bootstrap code and child pairing bootstrap code as separate state machines.
