...
- [x] Before-state source snapshot recorded in `output/browser-plan-proof/08-bridge-custody-and-security/00-source-snapshot.md`.
...
- [x] Raw evidence artifacts captured where applicable: `output/browser-plan-proof/08-bridge-custody-and-security/03-runtime-evidence.json`.
...
- [x] UI snapshots captured for every touched parent portal, child UX, block/warn, policy authoring, or dashboard state; no UI changed, so `output/browser-plan-proof/08-bridge-custody-and-security/06-ui-snapshots/ui-not-applicable.md` records why.
- [x] Security/no-claim negative proof captured where applicable: `output/browser-plan-proof/08-bridge-custody-and-security/08-security-negative-proof.log`.
- [x] Manual platform proof captured for real browser/OS claims, including OS/browser version, command steps, screenshots/logs, and manual-required labels in `output/browser-plan-proof/08-bridge-custody-and-security/09-manual-platform-proof.md`.
