...
- [x] Before-state source snapshot recorded in `output/browser-plan-proof/11-active-tab-proof-model/00-source-snapshot.md`.
...
- [x] Raw evidence artifacts captured where applicable: bridge/read-model/service proof records active proof source; no real-browser focus source is claimed.
...
- [x] Security/no-claim negative proof captured where applicable: target-list-only cannot claim known-active or known-inactive.
