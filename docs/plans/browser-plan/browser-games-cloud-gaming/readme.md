...
manual-required states. Results classify educational, entertainment, misleading
educational claim, unknown, manual-required, or unavailable candidates, and
recommend allow-during-homework, allow-with-time-limit, ask-parent,
...
`packages/parent-domain/src/browser-game-risk-benefit-signal.ts`. The signal
set models evidence-backed risk rows for violence, horror, adult themes,
...
unavailable states. Candidate actions remain block-during-school, ask-parent,
...
assessment models UGC game pages, experience pages, multiplayer lobbies,
...
remain candidates only: approved-experience-only, ask-parent, block-chat,
...
accepts parent-owned refs for browser-game evidence, analysis, mobile capability,
parent rule, and schedule context rows, then returns candidate-only allow, warn,
ask-parent, block, time-limit, manual-review, or unknown decisions. It rejects
...
snapshot covers checking unknown games, parent approval, blocked game
...
GAME-02/GAME-04/GAME-05/GAME-06/GAME-07/GAME-08/GAME-09/GAME-11/GAME-12/GAME-13/GAME-14/GAME-16/GAME-17/GAME-18/GAME-21/GAME-23/GAME-24 as
partial/manual-required, and all other browser-game rows as open/manual-required.
Product checklist
upgrade is not claimed; route contracts, runtime signals, metadata, AI, memory,
