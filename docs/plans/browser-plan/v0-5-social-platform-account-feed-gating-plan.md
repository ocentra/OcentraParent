...
- SOCIAL-11 now adds social risk/benefit signal model contracts in
  activity-domain: `browser-social-risk-benefit-values.ts` and
  `browser-social-risk-benefit-signals.ts`. Signal rows model candidate social
...
- SOCIAL-12 now adds parent-domain social policy compiler contracts in
  ...
  schedule refs and produces decision candidates for allow, warn, ask-parent,
...
- SOCIAL-14 now adds managed-browser feed/short/video route gate contracts in
  ...
  ask-parent, block, limit, manual-review, and unknown-warn route candidates.
