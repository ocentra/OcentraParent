...
| reviewed safe read/manual boundary; trusted producer verifier/transport and expected tests open | [WP06 Storage DO D1 KV R2 Queue Bindings](workpacks/06-storage-do-d1-kv-r2-queue-bindings.md) | D1 read/current-authority and parameterless mutation readiness retained; writer create/CAS/revoke stays producer-gated; trusted transport, migration/tests/proof open | `STORAGE_BINDING_MODEL.md`; Account WP08 `v0.7`; Account WP02 target authority; isolated account D1 migration/config | no tracked root |
