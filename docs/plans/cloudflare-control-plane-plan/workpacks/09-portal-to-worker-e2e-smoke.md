...
- The owned command has no retained WP09 route-execution proof. WP01's pinned module dependency graph is available; the worker imports module-local generated billing contracts rather than private billing-domain source.
...
- Use the restored WP01 resolver graph, then retain the actual portal-to-worker boot or route blocker if one remains.
