...
| 01. Module scaffold | WP01 | `infra/cloudflare/package.json` | Plan route is selected | Module tree and current concentrated source shape are documented honestly | `output/cloudflare-control-plane-plan-proof/01-cloudflare-module-scaffold/` | Remove unsupported files or mark them manual-required |
