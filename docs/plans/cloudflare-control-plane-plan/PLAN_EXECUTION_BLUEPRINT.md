...
| 08. Test runner and test pyramid | WP08 | `infra/cloudflare/scripts/test-runner.ts`; `TESTING_STRATEGY.md` | Local dev path exists | Test families, commands, and blocker states are explicit | `docs/proof/cloudflare-control-plane-plan/wp08-testing-runner-and-test-pyramid/test-pyramid-proof.md` | Revert any fake “implemented” test claims |
