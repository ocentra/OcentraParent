...
| ------------------------------------------- | ------------------ | -------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Real captured screens analyzed by local VLM | P3 proved          | `output/ai-plan-proof/real-analysis/proof-summary.json`                                      | Uses controlled local fixtures for video/social/game/shopping/bypass/risk text where account/live URL proof is not required yet; live operator external URL proof remains before a product-complete claim. |
...
| Parent policy dry-run decision              | P3 contract proved | `output/ai-plan-proof/real-analysis/browser-game/07-policy-decision.json`                    | The proof covers allow, warn, ask-parent, time-limit, and block dry-run decisions; real enforcement adapter dispatch remains separate proof.                                                               |
...
- [ ] Adapter unavailable/rollback states tested as part of the screen+AI delivery, with real adapters where the target platform is available.
