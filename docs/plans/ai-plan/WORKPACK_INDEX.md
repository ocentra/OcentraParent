...
| source integrated / tests + caller open | [04 - Rust Protocol Parity For AI Contracts](workpacks/04-rust-protocol-parity-for-ai-contracts.md) | 821 | adapter reviewed at `d72e1617d`; required Rust contract test absent/unregistered; no general caller/provider-owner composition; tests, proof, CI, PR, READY, and DONE open |
