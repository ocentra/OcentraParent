...
| source integrated / tests open | [03 - Contract Boundary And Effect Schemas](workpacks/03-contract-boundary-and-effect-schemas.md) | 928 | neutral leaf accepted at `6318d5e3d`; schema export is the only consumer; no agent-protocol/service provider-owner composition; 3 expected tests, WP04 contract test/caller, proof, and completion open |
| validation / bounded request+enum tests written; owner composition blocked | [04 - Rust Protocol Parity For AI Contracts](workpacks/04-rust-protocol-parity-for-ai-contracts.md) | 821 | adapter reviewed at `d72e1617d`; canonical `191e0d8a0` registers real request/schema/enum/hostile-input tests. Context/result/journal owner construction, general caller/provider-owner composition, execution, proof, CI, PR, READY, and DONE remain open |
