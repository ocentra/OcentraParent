...
| 32   | [Family AI hub and remote assistant boundary](workpacks/32-family-ai-hub-and-remote-assistant-boundary.md)       | Household LAN provider mesh and remote/API assistant are separate, with child-agent authority preserved.            |
