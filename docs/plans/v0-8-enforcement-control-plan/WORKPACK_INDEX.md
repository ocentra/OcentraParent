...
| open    | [10 Parent Approval And Override](workpacks/10-parent-approval-override.md)                       | 1,181 | 0/5 checked; 5 open; parent-resolution plus approved-request artifact/target binding is focused-tested, but transport/child-delivery/adapter execution remains open |
