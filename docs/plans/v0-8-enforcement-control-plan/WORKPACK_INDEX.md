...
| open    | [04 Owned-Process Time Limit](workpacks/04-owned-process-time-limit.md)                           | 1,096 | 0/5 checked; 5 open; schedule only after the WP11/eventing durable-journal handoff is available or precisely blocked |
...
| open    | [11 Audit And Journal Events](workpacks/11-audit-journal-events.md)                               | 1,123 | 0/5 checked; 5 open; owns the durable enforcement-journal handoff required before WP04 dispatch-ready work |
...
- Action authority and adapter execution: eventing-plan generic mechanics -> WP11 durable journal handoff -> WP04, then WP05, WP06, WP08.
