...
| open    | [10 Parent Approval And Override](workpacks/10-parent-approval-override.md)                       | 1,181 | 0/5 checked; 5 open; parent-resolution contract/service/UI slice is focused-tested, but artifact/child-delivery/adapter execution remains open |
