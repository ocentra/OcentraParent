...
WP04 has complete recorded local proof evidence regenerated against source commit `dba6df3ab05db3186068ffaf4d57d6c66fcfd83f`; its generated output root is intentionally ignored and is not expected in a fresh checkout. WP03, WP06, WP07, WP08, and WP10 have the separately documented proof states for their current checkout.
