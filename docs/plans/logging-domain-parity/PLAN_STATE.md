...
WP05 local validation evidence: the canonical proof root proves controlled pass/fail wrapper behavior, compact query/evidence output, local artifacts, NDJSON, and DuckDB persistence; full diagnostic-parser and checklist closure remain open
