...
| Tracking service read-model command                                       | P2_HOSTED_CI                 | P2_HOSTED_CI          | proved             | `output/tracking-plan-proof/32-journal-sqlite-and-read-model-proof/18-service-read-model-proof.json`                                                                                                                                                                                                                                                                               | narrow portal summary consumption proved; richer product read models, deletion/tombstone replay, full UI, and platform replay proof remain pending                       |
| Hosted parent tracking route screenshot/accessibility proof               | P2_HOSTED_CI                 | P2_HOSTED_CI          | proved             | `output/tracking-plan-proof/30-parent-and-child-ui-ux-surfaces/17-hosted-ui-proof.json`; `output/tracking-plan-proof/30-parent-and-child-ui-ux-surfaces/12-playwright-proof.log`; `output/tracking-plan-proof/30-parent-and-child-ui-ux-surfaces/11-ui-snapshots/hosted-policy-tracking-live-summary.png`; `test-results/tracking-plan-hosted-ui-proof/accessibility-summary.json` | full child-device UI, broader product UI, physical-device behavior, provider delivery, authority, and production proof remain pending                                    |
| Tracking pre-device proof gate                                            | P2_HOSTED_CI                 | P2_HOSTED_CI          | proved             | `output/tracking-plan-proof/pre-device-gap-closure/proof-summary.json`                                                                                                                                                                                                                                                                                                             | Android Studio/emulator, iOS simulator, WSL/local replay, physical-device, authority, full child/parent UI accessibility, and production-pilot artifacts remain separate |
...
| 30   | Parent and child UI/UX surfaces                  | [ ] P2 hosted parent route proof partial | P2_HOSTED_CI          | P2_HOSTED_CI          | proved               | `output/tracking-plan-proof/30-parent-and-child-ui-ux-surfaces/11-ui-fixture-state-matrix.json`; `output/tracking-plan-proof/30-parent-and-child-ui-ux-surfaces/11-ui-snapshots/policy-tracking-parent-fixture.png`; `output/tracking-plan-proof/30-parent-and-child-ui-ux-surfaces/17-hosted-ui-proof.json`; `output/tracking-plan-proof/30-parent-and-child-ui-ux-surfaces/12-playwright-proof.log`; `output/tracking-plan-proof/30-parent-and-child-ui-ux-surfaces/11-ui-snapshots/hosted-policy-tracking-live-summary.png`; `output/tracking-plan-proof/30-parent-and-child-ui-ux-surfaces/11-ui-snapshots/hosted-policy-tracking-live-summary-mobile.png`; `test-results/tracking-plan-hosted-ui-proof/accessibility-summary.json` | full service-data UI beyond the narrow parent summary, child-device UI, broader accessibility, richer live service-backed citations, and physical-device proof remain pending |
...
| 32   | Journal SQLite and read-model proof              | [ ] P2 service proof partial             | P2_HOSTED_CI          | P2_HOSTED_CI          | proved               | `output/tracking-plan-proof/32-journal-sqlite-and-read-model-proof/10-journal-sqlite-proof.json`; `output/tracking-plan-proof/32-journal-sqlite-and-read-model-proof/18-service-read-model-proof.json`; companion hosted route proof `output/tracking-plan-proof/30-parent-and-child-ui-ux-surfaces/17-hosted-ui-proof.json`                                                                                                                                                                                                                                                                                                                                                                                                            | narrow portal summary and hosted parent-route rendering proved; deletion/tombstone replay, richer read models, full UI, and platform replay proof remain pending              |
| 33   | Proof gates fixtures rollout and PR gate         | [x] Pre-device proof gate complete       | P2_HOSTED_CI          | P2_HOSTED_CI          | proved               | `output/tracking-plan-proof/33-proof-gates-fixtures-rollout-and-pr-gate/proof-summary.json`; generated runtime artifact `output/tracking-plan-proof/33-proof-gates-fixtures-rollout-and-pr-gate/00-run-metadata.json`; `output/tracking-plan-proof/pre-device-gap-closure/proof-summary.json`; companion hosted route proof `output/tracking-plan-proof/30-parent-and-child-ui-ux-surfaces/17-hosted-ui-proof.json`                                                                                                                                                                                                                                                                                                                     | full child/parent UI beyond the narrow hosted parent route, platform-local, physical-device, authority, and production proof remain pending                                   |
...
exist. WP30 additionally has P1 parent portal fixture evidence in
`11-ui-fixture-state-matrix.json`; the repeatable
`node scripts/test/tracking-plan-runtime-proof.mjs` command also captures a
local rendered route screenshot at
`11-ui-snapshots/policy-tracking-parent-fixture.png`; and
`npm run test:tracking-plan-hosted-ui-proof` now writes the narrow P2 hosted
parent-route proof in `17-hosted-ui-proof.json`, the Playwright log in
`12-playwright-proof.log`, desktop/mobile screenshots, and
`test-results/tracking-plan-hosted-ui-proof/accessibility-summary.json`. Child
UI, broader accessibility, richer service-data UI, and richer service-backed
...
`18-service-read-model-proof.json`; the WP30 hosted route proof now captures
that summary in the portal, while richer product read models and full portal
...
- [x] Local parent-defined place database has P1 CRUD/import/export/delete
      ...
      policy signals; platform adapters, provider delivery, full live UI,
      broader accessibility, physical-device behavior, and production
      persistence remain unclaimed.
...
- [x] Tracking service read-model command has P2 proof for SQLite tracking rows,
      ...
      consumption. The hosted parent route now captures that summary through
      Playwright, desktop/mobile screenshots, and accessibility summary output;
      deletion/tombstone replay, richer read models, full UI, and platform
      replay proof remain pending.
- [ ] Tracking UI/UX is not product-complete. A P1 parent portal tracking-state
      fixture and local parent-route screenshot exist, and P2 hosted
      parent-route screenshot/accessibility proof now covers the narrow
      service-backed summary. Full live parent/child UI, broader accessibility,
      richer service-data, and physical-device proof remain pending.
- [x] Minimum Serious MVP first-checkpoint audit exists in tracked
      ...
      until the remaining full live UI, platform, authority, and production
...
- [x] Pre-device proof gate exists in
      ...
      physical-device, authority, full hosted child/parent UI accessibility, and
      production proof as separate gates.
- [x] Product capability checklist row update is queued through the hub
      ...
      pre-device proof gate and should be extended with the hosted parent-route
      proof while preserving Android Studio/emulator, iOS simulator, WSL/local,
      physical-device, authority, full child/parent UI, and production gaps.
...
- [x] Parent route fixture covers tracking off, permission-required, stale,
      ...
      full live-data UI and child UI remain pending.
- [x] Hosted parent-route proof captures the service-backed tracking summary at
      P2 with Playwright, desktop/mobile screenshots, accessibility summary
      output, and no product-claim status.
...
- [ ] Screenshots are stored under the assigned proof root. The runtime proof
      ...
      hosted parent-route desktop/mobile screenshots now exist; child and full
      live-data screenshots remain pending.
- [x] Accessibility output is stored with the narrow hosted parent-route UI
      proof at `test-results/tracking-plan-hosted-ui-proof/accessibility-summary.json`;
      broader child/parent UI accessibility remains pending.
