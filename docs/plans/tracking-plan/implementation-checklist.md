...
| 32   | Journal SQLite and read-model proof              | [ ] P2 service proof partial       | P2_HOSTED_CI          | P2_HOSTED_CI          | proved               | `output/tracking-plan-proof/32-journal-sqlite-and-read-model-proof/10-journal-sqlite-proof.json`; `output/tracking-plan-proof/32-journal-sqlite-and-read-model-proof/18-service-read-model-proof.json`                                                                                                    | consolidated service citations, latest-row detail rendering, and retention tombstone accounting proved; full deletion replay, full product read models, full evidence drawer UI, and platform replay proof remain pending |
...
evidence refs, and retention tombstone accounting. Full product read models,
full deletion replay, evidence drawer UI, and platform replay proof remain
pending.
...
- [x] Tracking service read-model command has P2 proof for SQLite tracking rows,
      ...
      plus latest-row detail consumption; full deletion replay, full product
      read models, evidence drawer UI, and platform replay proof remain
      pending.
- [ ] Tracking UI/UX is not product-complete. A P1 parent portal tracking-state
      ...
      latest-row evidence details, and retention tombstone citation accounting.
