...
| 30   | Parent and child UI/UX surfaces                  | [ ] Fixture/service citation proof partial   | P2_HOSTED_CI          | P2_HOSTED_CI          | simulated            | `output/tracking-plan-proof/30-parent-and-child-ui-ux-surfaces/11-ui-fixture-state-matrix.json`; `output/tracking-plan-proof/30-parent-and-child-ui-ux-surfaces/11-ui-snapshots/policy-tracking-parent-fixture.png`; `output/tracking-plan-proof/32-journal-sqlite-and-read-model-proof/18-service-read-model-proof.json`                                                                                      | full service-data UI beyond the live citation rows, child-device UI, hosted Playwright/accessibility, and physical-device proof remain pending                                                                                                                   |
...
- [x] Product capability checklist row update is queued through the hub
      ...
      routing, and remaining Android foreground/background location,
      physical-device, authority, hosted UI, provider-delivery, and production
      gaps.
