...
- [x] Narrow service-row evidence drawer proof exists for the parent
      `policy-tracking` route. Service proof:
...
| Tracking service read-model command                                       | P2_HOSTED_CI                 | P2_HOSTED_CI          | proved             | `output/tracking-plan-proof/32-journal-sqlite-and-read-model-proof/18-service-read-model-proof.json`                                                                                                                                                                                                      | consolidated service citations, latest-row detail rendering, service-row evidence drawer rendering, and retention tombstone accounting proved; full product read models, full deletion replay, full product evidence drawer UI, and platform replay proof remain pending |
| Tracking hosted parent route UI/accessibility                             | P2_HOSTED_CI                 | P2_HOSTED_CI          | proved             | `output/tracking-plan-proof/30-parent-and-child-ui-ux-surfaces/17-accessibility-proof.json`; `output/tracking-plan-proof/30-parent-and-child-ui-ux-surfaces/11-ui-snapshots/policy-tracking-hosted-ui-proof.png`                                                                                       | first-target parent route, service-detail labels, and service-row evidence drawer rendering proved; child UI, browser-to-service live-data screenshot proof, full product accessibility, and physical-device proof remain pending |
...
| 32   | Journal SQLite and read-model proof              | [ ] P2 service proof partial       | P2_HOSTED_CI          | P2_HOSTED_CI          | proved               | `output/tracking-plan-proof/32-journal-sqlite-and-read-model-proof/10-journal-sqlite-proof.json`; `output/tracking-plan-proof/32-journal-sqlite-and-read-model-proof/18-service-read-model-proof.json`                                                                                                    | consolidated service citations, latest-row detail rendering, service-row evidence drawer rendering, and retention tombstone accounting proved; full deletion replay, full product read models, full product evidence drawer UI, and platform replay proof remain pending |
...
at `17-accessibility-proof.json`, including service-row evidence drawer labels;
child UI, richer live service-data UI, and full product accessibility remain
pending.
WP32 additionally has P2 service-command plus narrow portal summary/latest-row
detail/evidence drawer consumption proof from
`node scripts/test/tracking-plan-service-read-model-proof.mjs`, written to
`18-service-read-model-proof.json`; this includes consolidated service citation
IDs, latest-row kind/subject/device/platform/observer details, latest-row
evidence refs, service-row evidence drawer fields, and retention tombstone
accounting. Full product read models, full deletion replay, full product
...
- [x] Tracking service read-model command has P2 proof for SQLite tracking rows,
      ...
      plus latest-row detail/evidence drawer consumption; full deletion replay,
      full product read models, full product evidence drawer UI, and platform
...
- [ ] Tracking UI/UX is not product-complete. A P1 parent portal tracking-state
      ...
      parent/child UI, browser-to-service live-data screenshot proof, full
      product accessibility, and physical-device proof remain pending. The
      narrow live service summary now shows consolidated service citations,
      latest-row evidence details, service-row evidence drawer fields, and
      retention tombstone citation accounting.
