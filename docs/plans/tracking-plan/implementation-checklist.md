...
`11-ui-snapshots/hosted-policy-tracking-live-summary-mobile.png`, and
`test-results/tracking-plan-hosted-ui-proof/accessibility-summary.json`; child
UI, full service-data UI beyond the hosted parent route, and physical-device
...
- [ ] Tracking UI/UX is not product-complete. A P1 parent portal tracking-state
      fixture, local parent-route screenshot, and hosted parent
      `policy-tracking` route screenshot/accessibility proof exist; live
      parent/child UI beyond that route, child UI, full service-data UI,
      physical-device proof, authority, provider delivery, and production proof
      remain pending.
...
- [x] Product capability checklist row update is queued through the hub
      ...
      routing, hosted parent route screenshot/accessibility proof, and remaining
      Android foreground/background location, physical-device, authority,
      full child/parent UI beyond the hosted parent route, provider-delivery,
      and production gaps.
...
- [x] Parent route fixture covers tracking off, permission-required, stale,
      ...
      desktop/mobile screenshots; child UI and full parent/child UI beyond that
...
- [ ] Screenshots are stored under the assigned proof root. The runtime proof
      ...
      child and full parent/child screenshots remain pending.
- [ ] Accessibility output is stored for the hosted parent route proof in
      ...
      child/full UI accessibility remains pending.
