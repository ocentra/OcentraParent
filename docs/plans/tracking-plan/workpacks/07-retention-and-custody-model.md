...
while remote sync and remote AI stay disabled. Platform behavior, actual
writable live service-backed retention UI, and product claim readiness are not
claimed beyond the proof state recorded in
