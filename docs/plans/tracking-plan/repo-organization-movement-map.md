...
| WebSocket command/event contracts                                            | `packages/agent-protocol-domain/src/contracts.ts`                                                                                                  | Existing TypeScript owner. Keep.                                                                 |
...
| Portal rendering/projections                                                 | `apps/portal/src/*tracking*`, `apps/portal/src/live-activity-state.ts`                                                                             | Consumer only. Must not define canonical contract truth.                                         |
