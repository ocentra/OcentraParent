...
- `docs/proof/network-plan/01-foundation-contracts-and-eventing.md` is the tracked WP01 contract/eventing receipt; its current-main rerun is pending the coordinated `Cargo.lock` update.
