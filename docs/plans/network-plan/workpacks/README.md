...
| 36c | Parent UI manual/runtime network state rendering                                                                          | P3                  | Service activity-digest runtime delivery counts render in the typed portal read model; risk-budget/performance UI stays open.                                                                                                                                                                                                                |
