...
| open   | [04 Cross Slice Cascade And Parent Surface](workpacks/04-cross-slice-cascade-and-parent-surface.md) | 31-36             | P2/P3               | Fabricated product-path production code is removed; keep open until tests are rewritten and shipped cascade, AI, policy, notification, custody, and parent-surface owners are real. |
