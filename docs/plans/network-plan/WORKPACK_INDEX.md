...
| blocked | [04 Cross Slice Cascade And Parent Surface](workpacks/04-cross-slice-cascade-and-parent-surface.md) | 31-36             | P2/P3               | Shipped-call audit found no durable cascade/composition owner. Direct Eventing, AI, Policy, Custody, and Portal owner handoffs are required before WP04 can be READY; invalidated tests remain test-phase delete/rewrite debt. |
