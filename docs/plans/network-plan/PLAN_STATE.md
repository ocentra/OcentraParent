...
- `docs/proof/network-plan/PLAN_PROOF_MANIFEST.md` and the WP01 foundation-contract receipt preserve the reviewed contract/runtime slice; its 2026-07-31 current-main integration remains validation-pending on the coordinated `Cargo.lock` update, and broader plan proof bundles are still missing;
