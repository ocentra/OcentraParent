...
| 03   | [Current app/game snapshot and gap map](workpacks/03-current-app-game-snapshot-and-gap-map.md)                       | [ ]    |            |                  |                   |                        |
| 04   | [App/game identity model](workpacks/04-app-game-identity-model.md)                                                   | [ ]    |            |                  |                   |                        |
| 05   | [Inventory evidence model](workpacks/05-inventory-evidence-model.md)                                                 | [ ]    |            |                  |                   |                        |
| 06   | [Windows installed app/game inventory adapter](workpacks/06-windows-installed-inventory-adapter.md)                  | [ ]    |            |                  |                   |                        |
| 07   | [Windows Store/UWP/AppX/MSIX inventory adapter](workpacks/07-windows-store-uwp-appx-inventory-adapter.md)            | [ ]    |            |                  |                   |                        |
| 08   | [Windows process runtime evidence adapter](workpacks/08-windows-process-runtime-evidence-adapter.md)                 | [ ]    |            |                  |                   |                        |
| 09   | [Windows foreground app/game evidence adapter](workpacks/09-windows-foreground-evidence-adapter.md)                  | [ ]    |            |                  |                   |                        |
