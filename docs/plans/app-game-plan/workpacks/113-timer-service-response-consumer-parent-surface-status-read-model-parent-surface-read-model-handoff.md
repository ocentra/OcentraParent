...
Add a parent-domain service response-consumer parent-surface status read-model parent-surface read-model handoff that consumes WP112 parent-surface handoff rows and records which native app/native game rows still require parent-surface read-model proof before parent-visible surface read-model consumption can be claimed.
...
- [x] Add parent-domain service response-consumer parent-surface status read-model parent-surface read-model handoff schemas, builder, no-claim flags, and state rules.
- [x] Add focused parser/builder tests using the real WP112 proof output.
...
- `output/app-game-plan-proof/113-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model`
