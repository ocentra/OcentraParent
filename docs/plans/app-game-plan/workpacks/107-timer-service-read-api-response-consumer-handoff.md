...
> Agent Capsule
> Plan: `app-game-plan`
> Doc: `WP107 - Source-Gated Policy Preview Timer Service Read API Response Consumer Handoff`
...
- [ ] Add parent-domain service read API response consumer handoff schemas, builder, no-claim flags, and state rules.
- [ ] Add focused parser/builder tests using the real WP106 proof output.
