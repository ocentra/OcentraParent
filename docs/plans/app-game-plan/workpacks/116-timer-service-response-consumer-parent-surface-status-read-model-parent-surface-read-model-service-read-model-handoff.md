...
Add a parent-domain service read-model handoff contract that consumes WP115
service handoff rows and records which native app/native game rows require
future service read-model proof before runtime service read-model emission,
...
- [x] Add parent-domain service read-model handoff schemas, builder, no-claim flags, and
      state rules.
- [x] Add focused parser/builder tests using the real WP115 proof output.
...
- `output/app-game-plan-proof/116-timer-service-response-consumer-parent-surface-status-read-model-parent-surface-read-model-service-read-model-handoff`
