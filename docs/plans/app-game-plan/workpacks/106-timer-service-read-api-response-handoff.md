...
- [x] Add parent-domain service read API response handoff schemas, builder, no-claim flags, and state rules.
- [x] Add focused parser/builder tests using the real WP105 proof output.
