...
| [05-ask-parent-overrides](workpacks/05-ask-parent-overrides.md) | Ask-parent, bonus time, overrides, approvals. | Code drafted / unvalidated / tests deferred — Rust-owned typed decision staging/relay is mapped to `action_dispatch.rs`, `policy_preview.rs`, and `policy_preview/resolution.rs`; portal, account/identity, notification, WP11 durability, runtime, tests, and proof remain open |
