...
| [04-delivery-ack-audit](workpacks/04-delivery-ack-audit.md) | Delivery, ack, retry, rollback, and audit. | Contract checked / runtime blocked; request/artifact/target identity binding is now focused-tested |
| [05-ask-parent-overrides](workpacks/05-ask-parent-overrides.md) | Ask-parent, bonus time, overrides, approvals. | Open — parent-resolution contract/service/UI plus approved-request delivery binding now exist; transport wiring, notification, trusted adapter, and proof remain open |
