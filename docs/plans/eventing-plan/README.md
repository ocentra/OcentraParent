...
Household Mesh consumer proof uses `scripts/test/eventing-household-mesh-consumer-proof.mjs`
and writes `output/eventing-plan-proof/12-household-mesh-consumer/proof-summary.json`.
