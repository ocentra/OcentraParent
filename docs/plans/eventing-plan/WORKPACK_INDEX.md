...
| ready — implementation open; tests/proof open | [11 Type Safety And Ownership Hardening](workpacks/11-type-safety-and-ownership-hardening.md) | 63-68        | P2/P3 hardening                | EventEnvelope/store/decode code and focused tests exist, but the generic live boundary, aggregate/idempotency revalidation, negative audit families, and retained proof remain open. |
