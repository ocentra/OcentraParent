...
| done   | [10 LAN Household Mesh Consumer](workpacks/10-lan-household-mesh-consumer.md)                 | 79-87        | P6_NETWORK_CONSUMER_READY      | Consumer proof completed; proof summary recorded in `output/eventing-plan-proof/12-household-mesh-consumer/proof-summary.json`. |
