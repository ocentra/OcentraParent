...
| ready — implementation open; tests/proof open | [11 Type Safety And Ownership Hardening](workpacks/11-type-safety-and-ownership-hardening.md) | 63-68        | P2/P3 hardening                | Accepted EventEnvelope/store/decode helper now binds the live boundary and revalidates contract/aggregate/idempotency identity; focused negative/audit test families and retained proof remain open. |
