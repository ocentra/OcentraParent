...
| open | [06 Journal Replay And Lineage](workpacks/06-journal-replay-and-lineage.md)                         | 36-41, 69-78 | P3_GENERIC_JOURNAL_REPLAY      | Reopened as the exact prerequisite for enforcement WP11: journal/replay and version-skew suites pass, but the cited journal/topology proof and typed WP11 handoff artifacts are absent in this checkout. |
...
| historical | [09 Network Consumer Event Chain](workpacks/09-network-consumer-event-chain.md)               | 57-62        | P6_NETWORK_CONSUMER_READY      | Network consumer/event-chain source surfaces exist, but the cited event-chain proof linkage is absent in this checkout.                     |
| open   | [10 LAN Household Mesh Consumer](workpacks/10-lan-household-mesh-consumer.md)                 | 79-87        | P6_NETWORK_CONSUMER_READY      | `output/eventing-plan-proof/12-household-mesh-consumer/proof-summary.json` is absent in this checkout, and LAN/remote-access handoff proof still needs exact verification. |
