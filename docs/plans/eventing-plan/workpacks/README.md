...
| 32 | Typed response resolution | P2 | Request resolves typed response. |
...
| 65 | RequestEvent associated response proof | P2 | Request response type is bound to the request event and validates before completion. |
