...
| 64   | Typed live envelope versus stored envelope proof                               | [x]    | E-D        | `codex/eventing-network-runtime-implementation` | `crates/ocentra-eventing/src/tests.rs`, proof harness                                                       | Handlers receive typed envelopes; JSON payload stays stored-boundary only.                                 |
