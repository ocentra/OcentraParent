...
- [02 - Real Trigger To Capture Gate](workpacks/02-real-trigger-to-capture-gate.md): 4 open of 9 boxes.
- [10 - Final Rollout And PR Gate](workpacks/10-final-rollout-and-pr-gate.md): 1 open of 8 boxes.
