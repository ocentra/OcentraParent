...
- The Linux child builder now uses child-owned `OCENTRA_CHILD_LINUX_*` version/baseline/staging controls and rejects legacy parent-scoped inputs before packaging; old names remain only in deferred validation/checkpoint references.
