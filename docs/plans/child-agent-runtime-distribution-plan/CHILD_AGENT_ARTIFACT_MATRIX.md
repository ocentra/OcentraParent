...
| Child iOS capability package | Capability/limit contracts and contract tests. | Actual project/bundle/scheme/app/artifact remains parent-labelled. | Canonical child identity and capability-limit simulator/device coverage. | Daemon, background-service, recovery, supervision, signing, store, or parent parity. |
