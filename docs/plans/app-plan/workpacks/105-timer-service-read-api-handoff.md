...
- [x] Cross-record parent-domain service read API handoff schemas, builder, no-claim flags, and state rules.
- [x] Cross-record focused parser/builder tests using the real WP104 proof output.
