...
- [x] Cross-record parent-domain service read API response consumer handoff schemas, builder, no-claim flags, and state rules.
- [x] Cross-record focused parser/builder tests using the real WP106 proof output.
