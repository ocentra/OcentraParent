...
- [x] Cross-record parent-domain service handoff schemas, builder, no-claim flags, and state rules.
- [x] Cross-record focused parser/builder tests using the real WP101 proof output.
