...
Cross-record the shared app/game WP104 parent-domain service event handoff for native apps, consuming WP103 service read-model handoff rows without claiming runtime event emission, read APIs, portal rendering, platform enforcement, or package export readiness.
