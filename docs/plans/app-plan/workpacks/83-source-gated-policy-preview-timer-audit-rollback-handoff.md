...
This app-plan row cross-records the shared app/game WP83 proof for the native
app meaning of source-gated policy preview timer audit/rollback handoff.

## Scope

The parent-domain proof consumes WP82 timer scheduler-persistence rows and
...
plan, and audit/rollback read-model proof before any future runtime scheduling.
Rows blocked by source freshness or compiler decisions remain blocked before
audit/rollback.
...
- `output/app-plan-proof/83-source-gated-policy-preview-timer-audit-rollback-handoff/proof.json`
