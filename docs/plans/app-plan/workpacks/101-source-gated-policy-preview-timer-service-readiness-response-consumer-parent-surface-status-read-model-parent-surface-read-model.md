...
Cross-record the shared app/game WP101 parent-domain parent-surface read-model contract for native apps, consuming WP100 handoff rows without claiming runtime persistence, portal rendering, platform enforcement, or package export readiness.
...
- [x] Cross-record parent-domain parent-surface read-model schemas, builder, no-claim flags, and state rules.
- [x] Cross-record focused parser/builder tests using the real WP100 proof output.
