...
| 03   | [Current app snapshot and gap map](workpacks/03-current-app-snapshot-and-gap-map.md)                                         | [ ]    |            |                  |                   |                        |
| 04   | [App identity model](workpacks/04-app-identity-model.md)                                                                     | [ ]    |            |                  |                   |                        |
| 05   | [Installed app inventory model](workpacks/05-installed-app-inventory-model.md)                                               | [ ]    |            |                  |                   |                        |
| 06   | [Windows installed app inventory adapter](workpacks/06-windows-installed-app-inventory-adapter.md)                           | [ ]    |            |                  |                   |                        |
| 07   | [Windows Store UWP AppX inventory adapter](workpacks/07-windows-store-uwp-appx-inventory-adapter.md)                         | [ ]    |            |                  |                   |                        |
| 08   | [Windows process runtime evidence adapter](workpacks/08-windows-process-runtime-evidence-adapter.md)                         | [ ]    |            |                  |                   |                        |
| 09   | [Windows foreground app evidence adapter](workpacks/09-windows-foreground-app-evidence-adapter.md)                           | [ ]    |            |                  |                   |                        |
| 10   | [Cross-platform authority matrix](workpacks/10-cross-platform-authority-matrix.md)                                           | [ ]    |            |                  |                   |                        |
| 11   | [App category and risk taxonomy](workpacks/11-app-category-and-risk-taxonomy.md)                                             | [ ]    |            |                  |                   |                        |
| 12   | [App sessionization and duration engine](workpacks/12-app-sessionization-and-duration-engine.md)                             | [ ]    |            |                  |                   |                        |
| 13   | [Journal and SQLite app ingest](workpacks/13-journal-and-sqlite-app-ingest.md)                                               | [ ]    |            |                  |                   |                        |
| 14   | [App read models and service events](workpacks/14-app-read-models-and-service-events.md)                                     | [ ]    |            |                  |                   |                        |
| 15   | [Parent portal app inventory running session surfaces](workpacks/15-parent-portal-app-inventory-running-session-surfaces.md) | [ ]    |            |                  |                   |                        |
| 16   | [New app and unknown app approval flow](workpacks/16-new-app-and-unknown-app-approval-flow.md)                               | [ ]    |            |                  |                   |                        |
| 17   | [Risk app detection](workpacks/17-risk-app-detection.md)                                                                     | [ ]    |            |                  |                   |                        |
| 18   | [Policy target compiler for app rules](workpacks/18-policy-target-compiler-for-app-rules.md)                                 | [ ]    |            |                  |                   |                        |
