...
- [AGENTS.md](AGENTS.md): local route and ownership contract.
- [PLAN_STATE.md](PLAN_STATE.md): current architecture state and evidence.
- [DECISIONS.md](DECISIONS.md): PSP-001 through PSP-012.
- [PLAN_EXECUTION_BLUEPRINT.md](PLAN_EXECUTION_BLUEPRINT.md): code-to-proof slice order.
