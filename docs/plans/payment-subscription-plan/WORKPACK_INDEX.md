...
| blocked / source reviewed / no provider adapters, non-test lifecycle caller, expected tests, or proof | [WP08 Provider Adapter Portability](workpacks/08-provider-adapter-portability.md) | 0/12 | `output/payment-subscription-plan-proof/08-provider-adapter-portability/` |
| blocked / source reviewed / strategy-only matrix, no regional selector, expected tests, or proof | [WP09 Regional Payment Rollout](workpacks/09-regional-payment-rollout.md) | 0/12 | `output/payment-subscription-plan-proof/09-regional-payment-rollout/` |
