...
| open | [WP01 Product Pricing Entitlement](workpacks/01-product-pricing-entitlement.md) | 0/12 | `output/payment-subscription-plan-proof/01-product-pricing-entitlement/` |
| open | [WP02 Checkout Billing Portal](workpacks/02-checkout-billing-portal.md) | 0/12 | `output/payment-subscription-plan-proof/02-checkout-billing-portal/` |
| open | [WP03 Subscription Webhook Lifecycle](workpacks/03-subscription-webhook-lifecycle.md) | 0/12 | `output/payment-subscription-plan-proof/03-subscription-webhook-lifecycle/` |
| open | [WP04 Entitlement Delivery Gates](workpacks/04-entitlement-delivery-gates.md) | 0/12 | `output/payment-subscription-plan-proof/04-entitlement-delivery-gates/` |
