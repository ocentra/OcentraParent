...
| --- | --- | ---: | --- |
| blocked / proof-required | [WP00 Cloudflare Control Plane Handoff](workpacks/00-cloudflare-control-plane-handoff.md) | 8/8 | `output/payment-subscription-plan-proof/00-cloudflare-control-plane-handoff/` |
