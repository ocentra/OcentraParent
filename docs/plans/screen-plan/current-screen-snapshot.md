...
- Service-persisted parent opt-in controls and product-complete retention
  controls.
...
- PaddleOCR runtime error resolution/quality comparison and live VLM
  provider/runtime quality measurement.
