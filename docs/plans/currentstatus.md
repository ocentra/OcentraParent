...
4. Continue `eventing-plan` `WP11-WP12`, because WP02 now has public strong-ID coverage plus fail-closed `SchemaVersion` serde behavior and the remaining gap is live-vs-stored, associated-response, fixture-parity, and consumer-proof reconciliation rather than more core bus scaffolding.
