...
| `parent-desktop-runtime-package-plan` | missing                                                                  | no implementation checklist | 10/20 open                                                                   | [PLAN_HEALTH.md](plans/parent-desktop-runtime-package-plan/PLAN_HEALTH.md) |
