...
| Payment/subscription | 13 | 8/2/0/0/3/0 | 49 / 39 | 13 / 13 | Fully code-mapped; WP00 is complete for Phase 1 code/expected-test writing, while twelve workpacks retain concrete code/test gaps. |
