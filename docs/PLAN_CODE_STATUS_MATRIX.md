...
| Device trust bootstrap | 9 | 6/0/3/0/0 | 110/36 | 0/3/0/0/6/0 | WP03 is blocked with two missing planned owners. The route is Account WP08 -> target-aware Account WP02 -> Cloudflare WP06 -> WP03, alongside WP01 foundation; Device Trust WP02 remains only the conditional sealing gate. Expected tests, ceremony/provider/runtime callers, proof, and completion remain open. |
