...
code map, not from plan checkboxes. The graph currently contains 707 nodes, 803
edges, 23 plans, and 683 workpacks. It maps 3,077 implementation files and 1,146
...
expectations match for 664/683 workpacks.
Derived state is 360 planned, 36 blocked, 3 ready, 8 active, 275 in
