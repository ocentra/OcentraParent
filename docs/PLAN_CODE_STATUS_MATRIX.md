...
| Setup/install/provisioning | 7 | 0/1/0/0/6/0 | 577 / 197 | 7 / 7 | Fully code-mapped; WP07 now has a Rust-owned source boundary and canonical LAN route guard, but remains manual-required/unavailable with authenticated owner composition plus expected tests and proof deferred. |
