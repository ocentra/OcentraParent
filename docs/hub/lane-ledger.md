...
Updated: `2026-06-09T20:31:37.2159136-04:00`

| Lane      | Work                                              | Branch                                                       |  PR | Status           | Current Meaning                                                                                          | Next Action                                                                                                                 |
| --------- | ------------------------------------------------- | ------------------------------------------------------------ | --: | ---------------- | -------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| `primary` | Docs/hub-only fast CI required-check preservation | `codex/docs-hub-fast-ci`                                     |   - | `dirty-local`    | CI workflow branch adds a lightweight docs/.hub/root-md-only path while preserving required check names. | Commit, push, and open a PR; this CI-infrastructure PR must run the full matrix once before future docs-only PRs fast-pass. |
