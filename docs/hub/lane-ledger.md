...
Updated: `2026-06-09T20:52:00.0000000-04:00`

| Lane      | Work                                              | Branch                                                       |  PR | Status           | Current Meaning                                                                                                          | Next Action                                                                                                     |
| --------- | ------------------------------------------------- | ------------------------------------------------------------ | --: | ---------------- | ------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------- |
| `primary` | Docs/hub-only fast CI required-check preservation | `codex/docs-hub-fast-ci`                                     |   - | `dirty-local`    | CI workflow branch adds a lightweight docs/.hub/root-md-only path and records the repo-domain organization cleanup TODO. | Commit and push; this CI-infrastructure PR must run the full matrix once before future docs-only PRs fast-pass. |
...
| `E-D`     | Network live capture execution proof              | `codex/network-live-capture-execution-proof`                 | 546 | `blocked`        | PR546 has most checks green but Windows Real Portal To Rust E2E failed.                                                  | When selected, route Windows E2E fix to E-D, then rerun CI before merge.                                        |
