...
Supporting expectation files: [platforms](platforms.md), [platform deliverables](platform-deliverables.md), [capture](capture.md), [evidence storage](evidence-storage.md), and [release installer](release-installer.md).
...
- Include platform-specific smoke tests, permission/capability evidence, contract parity, and release/package checks for each supported platform.
