...
Supporting expectation files: [evidence storage](evidence-storage.md),
[capture](capture.md), [portal](portal.md), [family setup](family-setup.md),
[policy](policy.md), [release installer](release-installer.md),
[platforms](platforms.md), and
[platform deliverables](platform-deliverables.md).
