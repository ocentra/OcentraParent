...
0001. Use parent-enabled setting;?
...
0002. Use local capture of the approved scope;?
...
0003. Use deletion of the raw image or frame data?
...
0004. Use full screen or display;?
...
0006. Use managed browser window;?
...
0010. Represent foreground app/window evidence;.
...
0011. Represent app/game session evidence;.
...
0012. Represent network digest evidence;.
...
0013. Use parent setting version;?
...
0014. Use capture only the Ocentra-managed browser window;?
...
0015. Use capture only an approved app window;?
...
0016. Use correlate capture with managed session id, window id, process id, and evidence refs?
...
0017. Use a managed browser screenshot is still not the source of exact URL truth;?
...
0018. Use window title and visible pixels can be stale or misleading;?
...
0019. Represent foreground process/window evidence;.
...
0020. Represent managed browser session and tab evidence;.
...
0021. Represent app/game session summary;.
...
0023. Use app duration from repeated screenshots alone;?
...
0024. Use network destination from visible content alone;?
...
0025. Use child intent from category alone?
...
0026. Use portal-rendered question/option UI?
...
0027. Use local screenshot or frame capture only after explicit enablement?
...
0028. Use small patch updates from Portal?
...
0029. Use deterministic compile into an effective local execution plan?
...
0030. Represent effect Schema validation.
...
0031. Represent branded ids from schema brands, not manual brands.
...
0033. Represent rust protocol parity only after the TypeScript contracts are explicit and test-backed.
...
0034. Represent do not let Portal define arbitrary JSON paths. `writesTo` paths should be schema-known authoring paths.
...
0035. Represent add Rust parity only for Rust-crossing commands/events after TypeScript contracts and tests are stable.
...
0036. Should screen recording be allowed?
...
0037. What is the maximum local recording segment length?
...
0038. Allow continuous screen recording?
...
0039. When should capture pause?
...
0046. Represent control kind: read-only-status.
...
0047. Represent condition kind: equals.
...
0048. Represent condition kind: notEquals.
...
0049. Represent condition kind: includes.
...
0050. Represent condition kind: notIncludes.
...
0051. Represent condition kind: all.
...
0052. Represent condition kind: any.
...
0053. Use parent policy outcome without a typed parent rule?
...
0054. Use exact URL and title require browser evidence from CDP, extension, browser policy, or another approved browser integration;?
...
0055. Use parent rule and setting version?
...
0056. Use show policy use as observe-only, dry-run, enforcement-eligible, or disabled;?
...
0057. Use local observe-only summaries;?
...
0059. Use manual parent test capture;?
...
0060. Represent child-agent local persisted policy.
...
0061. Use offline operation from the last valid policy?
...
0062. Represent use Effect Schema to validate the full policy after every patch.
...
0063. Represent compile the effective policy in the child-agent/service boundary, not in Portal.
...
0064. Represent add explicit tests for offline behavior: child agent continues using the last valid compiled policy when Portal is disconnected.
...
0065. Allow screen summaries to be used by policy?
...
0066. What screen-derived targets may policy match?
...
0067. Which evidence refs are required before policy use?
...
0068. Choose rendering rule hideInvisibleFields.
...
0069. Choose rendering rule showDisabledFieldsWithReason.
...
0070. Choose rendering rule neverInventFieldsOutsideManifest.
...
0071. Choose rendering rule writeOnlyThroughWritesToPath.
...
0072. Choose rendering rule previewBeforeApply.
...
0073. Choose rendering rule showCapabilityStateBesideSensitiveControls.
...
0076. Support screen-policy.preview.requested?
...
0077. Choose agent rule validateFullPolicyAfterPatch.
...
0078. Choose agent rule compileFullEffectivePolicyAfterEveryAcceptedChange.
...
0079. Choose agent rule runCaptureOnlyInChildAgent.
...
0080. Choose agent rule enforceLocallyWhenPortalOffline.
...
0081. Choose agent rule rejectUnknownPaths.
...
0082. Choose agent rule rejectInvalidEnumValues.
...
0083. Choose agent rule rejectHostedProcessingForSchemaVersionOne.
...
0084. Choose agent rule recordSkippedAttemptsAsCapabilityEvents.
...
0085. Choose visible category target school.
...
0086. Choose visible category target video.
...
0087. Choose visible category target chat.
...
0088. Choose visible category target game.
...
0089. Choose visible category target adult-content.
...
0090. Choose visible category target violence.
...
0091. Choose visible category target bypass-tool.
...
0092. Choose visible category target unknown.
...
0093. Represent local model/runtime status;.
...
0094. Use the parent explicitly enabled screen analysis for the child/device/schedule;?
...
0095. Use one-time manual parent test capture during setup;?
...
0096. Use cadence capture with conservative intervals;?
...
0097. Use event-triggered capture after foreground app change, managed URL change, app/game foreground start, unusual network digest, policy ambiguity, or local AI uncertainty;?
...
0098. Use event-triggered frame sampling for transitions;?
...
0099. Use bandwidth, CPU/GPU, battery, and model runtime load are higher;?
...
0100. Use model/runtime ref and prompt/template version;?
...
0102. Use conservative interval such as several minutes;?
...
0103. Use stricter shorter interval only when explicitly enabled;?
...
0104. Use schedule-aware capture windows;?
...
0105. Use pause during sleep, lock, protected surface, permission-required state, or battery/resource pressure?
...
0106. Use foreground app change;?
...
0108. Use managed browser URL change;?
...
0109. Use app/game foreground start;?
...
0110. Use unusual network digest;?
...
0113. Use child ask-parent flow;?
...
0114. Use manual parent setup/test capture?
...
0115. Use capture support must be checked at runtime;?
...
0116. Choose screen Time frameworks.
...
0117. Use managed Settings shields and Device Activity schedules/events;?
...
0118. Use web-domain and app/category usage controls through Screen Time tokens?
...
0119. Use screen Time APIs are privacy-preserving and entitlement/review-gated;?
...
0120. Use iOS child-device support should rely on approved Screen Time/Device Activity/Managed Settings paths rather than desktop-style pixel capture unless a specific Apple-approved capability is proven?
...
0121. Represent local model/runtime status;.
...
0122. Represent reason text for warnings, asks, blocks, or time limits;.
...
0123. Represent local model/runtime status;.
...
0124. Use capability state at capture time;?
...
0125. Use local model/runtime ref;?
...
0126. Use show cadence and triggers separately;?
...
0127. Use show local model/runtime status;?
...
0129. Use cadence plus trigger capture;?
...
0130. Represent capability Prove duration: full screen No, single point in time; active window No, single point in time; managed browser/window No, single point in time; local OCR/vision No; important limit Duration belongs to app/game/window/session evidence or recording-specific proof..
...
0131. Use no naked domain strings in app/runtime code?
...
0132. Use keep authoring manifest ids, field ids, section ids, option ids, policy ids, rule ids, schedule ids, trigger ids, queue job ids, result ids, capability ids, custody labels, and evidence refs branded?
...
0133. Use treat the authoring manifest as UI guidance only. Runtime capture, queue, analysis, policy, and enforcement must rely on validated policy and compiled effective policy?
...
0134. Use add explicit tests for hidden/visible branch behavior so UI cannot show cadence, OCR snippet storage, strict mode, or enforcement eligibility controls when screen analysis is disabled?
...
0136. How often may scheduled capture run?
...
0137. Allow the shortest supported cadence?
...
0138. Enable event-triggered capture?
...
0139. Which events may request screen analysis?
...
0140. How long should repeated triggers wait?
...
0141. What is the maximum number of screen analysis jobs per hour?
...
0143. Represent capability windows-graphics-capture-full-screen: kind capture-scope; state manual-required; proof real-host-permission-and-capture-proof-required; affects fields capture.allowedScopes, schedule.cadenceCaptureEnabled.
...
0144. Represent capability managed-browser-window-correlation: kind source-correlation; state ready; proof runtime-read-model-required; affects fields capture.requireManagedBrowserCorrelationForWebClaims, policy.requireEvidenceRefs.
...
0145. Represent capability foreground-app-window-correlation: kind source-correlation; state ready; proof runtime-read-model-required; affects fields capture.requireAppWindowCorrelation, policy.requireEvidenceRefs.
...
0146. Represent capability local-ocr-runtime: kind local-analysis; state manual-required; proof local-model-runtime-proof-required; affects fields analysis.allowedTasks, analysis.ocrTextEnabled, analysis.minimumPolicyConfidence.
...
0147. Represent capability local-vision-classifier: kind local-analysis; state manual-required; proof local-model-runtime-proof-required; affects fields analysis.allowedTasks, analysis.minimumPolicyConfidence, policy.allowedTargetTypes.
...
0148. Represent capability screen-redaction-runtime: kind redaction; state manual-required; proof redaction-validation-required; affects fields redaction.mode, redaction.neverStore, redaction.whenUnavailable.
...
0149. Represent capability ios-screentime-managed-settings: kind platform-policy; state manual-required; proof apple-entitlement-and-device-proof-required; affects fields policy.allowedTargetTypes, reports.visibleFields.
...
0150. Show ready capability state?
...
0151. Show model-unavailable capability state?
...
0152. Choose agent rule persistPolicyBeforeSchedulerSwitch.
...
0153. Choose fallback lowConfidence.
...
0154. Choose fallback policyUse.lowConfidenceFallback.
...
0155. Use risk signals such as possible credential prompt, explicit content signal, bypass tool, unsafe visible content, self-harm signal, suspicious login, or unknown;?
...
0156. Represent correlation with foreground app, active window title, managed browser state, app/game session, and network digest refs;.
...
0157. Represent exact active browser URL unless managed browser evidence proves it;.
...
0158. Use what the child typed before or after the frame;?
...
0160. Use whether visible text came from a webpage, chat, image, ad, overlay, or stale window;?
...
0161. Use hidden background tabs or background apps;?
...
0162. Use decrypted network content;?
...
0163. Use app identity without OS process/window correlation;?
...
0164. Use recording creates more raw sensitive data than screenshots;?
...
0165. Represent policy or AI decision that consumed the summary.
...
0166. Represent platform parity before real OS/device proof;.
...
0167. Use queue lifecycle and deletion proof?
...
0168. Represent product claims should follow real host proof, not contract presence.
...
0169. Use macOS parity requires real host proof, not package scaffold proof?
...
0170. Represent foreground-window proof varies by compositor and desktop environment;.
...
0171. Represent linux support needs distro/backend-specific proof.
...
0172. Represent policy/AI decisions that consumed the screen summary;.
...
0173. Use parent setting version and actor ref;?
...
0174. Use capture reason and scope;?
...
0175. Use queue job id and image digest;?
...
0176. Use encryption and deletion lifecycle;?
...
0178. Represent summary/result id;.
...
0180. Use enforcement result if any;?
...
0182. Use retention/deletion state;?
...
0183. Use adapter errors or permission changes?
...
0184. Use parent setting enabled through typed contracts;?
...
0185. Represent child-device agent or service detects capability and permission state;.
...
0186. Use capture occurs only inside approved scope;?
...
0187. Use image/frame enters encrypted temp queue;?
...
0188. Use local OCR/vision analyzes it;?
...
0189. Use schema validation accepts/rejects output correctly;?
...
0190. Use raw image deletes after success or TTL expiry;?
...
0191. Represent journal and SQLite expose summary/read model;.
...
0192. Use portal renders settings, status, summary, refs, custody, and deletion state;?
...
0193. Use no Ocentra-hosted upload happens by default;?
...
0194. Use protected/permission-required cases are visible as unavailable, not fake success?
...
0195. Use show exact proof requirement before screen-derived rules can enforce;?
...
0198. Represent capability Prove exact URL: full screen No; active window No; managed browser/window Only if browser evidence proves it separately; local OCR/vision No; important limit Pixels can show text that looks like a URL, but that is not managed tab proof..
...
0199. Represent capability Feed enforcement: full screen Not directly; active window Not directly; managed browser/window Not directly; local OCR/vision Not directly; important limit Enforcement requires typed policy decision and audit..
...
0200. Represent local child-agent persistence, queue encryption/deletion, compile, rollback, and audit behavior.
...
0201. Choose reject partial states. For example, `policyUse.enabled.
...
0202. What if screen proof is unavailable?
...
0203. Which audit fields are required?
...
0204. Audit every capture attempt, including skipped attempts?
...
0205. Audit every delete-pending or delete-failed state?
...
0206. Represent condition kind: proofAtLeast.
...
0207. Represent capability windows-graphics-capture-active-window: kind capture-scope; state manual-required; proof real-host-permission-and-capture-proof-required; affects fields capture.allowedScopes, capture.defaultScope, policy.allowedTargetTypes.
...
0208. Represent capability windows-graphics-capture-recording-stream: kind recording; state manual-required; proof real-host-recording-stream-retention-and-deletion-proof-required; affects fields recording.mode, recording.maxSegmentSeconds, recording.frameSamplingMode.
...
0209. Represent capability encrypted-screen-temp-queue: kind queue; state ready; proof queue-encryption-deletion-tests-required; affects fields queue.temporaryImageTtlSeconds, queue.maxRetryCount, queue.deleteAfterSuccess, queue.deleteAfterExpiry.
...
0210. Represent capability macos-screencapturekit: kind platform-capture; state manual-required; proof macos-host-screen-recording-permission-proof-required; affects fields capture.allowedScopes.
...
0211. Represent capability linux-xdg-desktop-portal-screencast: kind platform-capture; state manual-required; proof distro-desktop-portal-pipewire-proof-required; affects fields capture.allowedScopes.
...
0212. Represent capability android-media-projection: kind platform-capture; state manual-required; proof android-user-consent-foreground-service-proof-required; affects fields capture.allowedScopes, screen.requiredDisclosure, recording.mode.
...
0213. Show adapter-error capability state?
...
0214. Show manual-required capability state?
...
0215. Choose agent rule rejectPolicyUseWithoutDeletionProof.
...
0216. Choose fallback protectedSurface.
...
0217. Choose fallback screenLocked.
...
0218. Represent proof requirement screenPolicyUse: validated-screen-summary-with-deleted-image.
...
0219. Represent proof requirement exactWebClaims: managed-browser-evidence-required.
...
0220. Represent proof requirement appWindowClaims: foreground-app-window-evidence-required.
...
0221. Represent proof requirement riskSignalRules: validated-screen-summary-confidence-threshold.
...
0222. Represent proof requirement enforcementEligibility: typed-policy-decision-with-screen-evidence-ref.
...
0223. Represent proof requirement reportOnly: stale-or-degraded-allowed.
...
0224. Choose effective fallback proofUnavailable.
...
0225. Choose effective fallback staleEvidence.
...
0226. Choose effective fallback screenLocked.
...
0227. Choose effective fallback protectedSurface.
...
0228. Choose effective fallback modelUnavailable.
...
0229. Choose effective fallback queueUnavailable.
...
0230. Choose effective fallback adapterError.
...
0231. Choose effective fallback deleteFailed.
...
0232. Choose effective rule parent-request-explicit-content-signal.
...
0233. Choose effective rule warn-bypass-tool-visible.
...
0234. Choose effective rule unknown-screen-state-ask.
...
0235. Use child-facing disclosure must be clearer;?
...
0236. Use local redaction before journal/report storage;?
...
0238. Use play policy and user disclosure constraints matter?
...
0239. Represent parent setting state visible in the parent portal;.
...
0240. Use child-facing disclosure that screen analysis may run locally;?
...
0241. Use clear difference between observe-only, dry-run, and enforcement-eligible modes;?
...
0242. Use current permission-required or disabled state;?
...
0243. Use no hidden background capture claims?
...
0244. Represent setting state and who changed it;.
...
0245. Use capture reason and scope;?
...
0246. Use category candidates and confidence;?
...
0247. Use risk signals and confidence;?
...
0248. Use bounded OCR snippets only when enabled and redacted;?
...
0249. Represent source evidence refs;.
...
0251. Use deletion state and image digest;?
...
0252. Use unavailable, protected, permission-required, low-confidence, stale, expired, invalid, delete-pending, or delete-failed states?
...
0253. Use keep parent reports evidence-cited and custody-labeled?
...
0254. Represent capability Show parent report: full screen Summary, confidence, refs, deletion state; active window Same; managed browser/window Same; local OCR/vision Same; important limit Raw screenshot hidden by default..
...
0255. Which disclosure requirements apply before capture?
...
0256. What must never be stored in summaries or reports?
...
0257. Which fields should parent reports show?
...
0258. Show raw screenshots in parent reports by default?
...
0259. Choose rendering rule showDisclosureBeforeEnable.
...
0260. Choose fallback childDeviceOffline.
...
0261. Use encrypted temporary queue storage;?
...
0262. Use credential-like text redaction;?
...
0264. Use the raw image or frame is stored only in an encrypted temporary local queue;?
...
0265. Use confidence, category, risk signal, redaction, custody, and deletion states validate;?
...
0266. Represent the stored long-lived evidence is a summary plus refs, not raw pixels;.
...
0267. Use oCR snippets when parent settings allow them and local redaction permits storage;?
...
0268. Use storage, deletion, and failure handling are harder to prove;?
...
0269. Use disabled unless parent enables snippet storage or local analysis needs transient text;?
...
0270. Use invalid output rejection before storage or policy use?
...
0271. Use no raw screenshot shown by default;?
...
0272. Use no raw local file paths in portal copy/debug output;?
...
0273. Use no encrypted image refs outside the child agent;?
...
0274. Use oCR snippets bounded and redacted;?
...
0275. Use credential-like text, passwords, tokens, payment fields, private keys, recovery codes, and session values redacted or omitted;?
...
0276. Use protected regions skipped where the platform or local detector can identify them;?
...
0277. Represent uncertain redaction state degrades policy eligibility.
...
0279. Represent stored summary: local journal and SQLite query store;.
...
0280. Choose parent cache/export.
...
0281. Choose ocentra-hosted storage.
...
0282. Use `child-device-temp-queue`;?
...
0284. Use `child-device-query-store`;?
...
0285. Use `live-local-child-agent`;?
...
0289. Use `ocentra-hosted-non-activity`;?
...
0292. Use redaction unavailable;?
...
0293. Use encrypted temporary queue and journal/SQLite read model;?
...
0294. Represent encrypted local queue and summary storage.
...
0295. Use restore/persistent permission behavior differs across desktop portals;?
...
0296. Use show whether OCR snippet storage is enabled;?
...
0297. Use show redaction mode and redaction failures;?
...
0298. Use show queue health and deletion health;?
...
0299. Use show raw capture retention as off by default;?
...
0300. Represent show capability state close to each action: ready, unsupported, permission-required, permission-limited, protected-surface, model-unavailable, queue-unavailable, adapter-error, degraded, disabled-by-parent, or manual-required;.
...
0301. Use strict deletion and no raw image retention by default?
...
0302. Represent capability Retain raw capture: full screen No by default; active window No by default; managed browser/window No by default; local OCR/vision No by default; important limit Future retention needs separate custody/legal/privacy design..
...
0303. Use encrypted temporary image queueing?
...
0304. Use typed summary storage with evidence refs and deletion state?
...
0305. Represent tests for every parser, authoring manifest field, policy value shape, compile rule, patch command, capability state, queue state, deletion state, confidence value, and invalid-state rejection.
...
0306. Use add explicit tests that invalid confidence, missing source refs, missing deletion state, protected surfaces, and delete failures cannot produce enforcement-eligible screen summaries?
...
0307. Store bounded OCR text snippets in summaries?
...
0308. How should visible text and sensitive regions be redacted?
...
0309. What if redaction is unavailable?
...
0310. How long may a temporary image remain queued?
...
0311. How many local analysis retries are allowed before deletion?
...
0312. Delete raw image after successful analysis?
...
0313. Delete raw image after TTL expiry?
...
0314. Retain raw screenshots or recordings?
...
0315. Allow Ocentra-hosted processing of child screen images?
...
0316. Choose rendering rule showRawCaptureRetentionAsOffByDefault.
...
0318. Show queue-unavailable capability state?
...
0319. Choose agent rule deleteQueuedImagesOnInvalidOutput.
...
0320. Choose fallback queueUnavailable.
...
0321. Choose fallback modelUnavailable.
...
0322. Choose fallback redactionUnavailable.
...
0323. Choose fallback invalidModelOutput.
...
0324. Choose fallback deleteFailed.
...
0325. Use local OCR/vision analysis;?
...
0326. Use schema-valid summary, category candidates, risk signals, confidence, evidence refs, digest, and deletion state;?
...
0327. Use protected or unsupported scope represented as unavailable, not captured?
...
0328. Use visible text snippets;?
...
0330. Use unsafe phrase or bypass-tool signals;?
...
0331. Use policy explanation references?
...
0332. Represent managed browser URL/tab evidence where available;.
...
0333. Use the current platform adapter supports the requested scope;?
...
0334. Use required OS permission or management state is present;?
...
0335. Use protected surfaces are skipped or represented as unavailable;?
...
0336. Use local OCR/vision returns schema-valid output;?
...
0337. Represent policy and enforcement consume only typed summaries and evidence refs.
...
0339. Use cloud/API AI screenshot processing by default;?
...
0340. Use permanent screenshot history by default;?
...
0341. Use exact page, URL, chat, password, or intent from pixels alone;?
...
0342. Use enforcement from raw model text or unvalidated image classification?
...
0343. Use visible activity categories such as school, video, chat, game, shopping, productivity, adult content, violence, bypass tool, unknown, or low confidence;?
...
0344. Use short rolling local analysis buffer that never becomes a retained video archive;?
...
0345. Use accessibility-like visible flow analysis where the platform permits it?
...
0346. Use protected media and secure surfaces may appear black, unavailable, omitted, or blocked depending on OS;?
...
0347. Use bounded snippet count and character length;?
...
0348. Use sensitive tokens, passwords, credential-like text, payment data, and secrets redacted or skipped;?
...
0349. Use oCR-disabled state represented explicitly;?
...
0350. Use unsupported language, low resolution, or low confidence represented as unknown/degraded?
...
0351. Use enum-backed categories and risk signals, not open-ended model prose;?
...
0354. Represent source evidence refs;.
...
0355. Use policy eligibility flag;?
...
0361. Represent permission limited;.
...
0369. Use local OCR through Windows OCR APIs or another local model boundary where packaged/available;?
...
0370. Use local vision classification through an Ocentra-owned local model/provider boundary;?
...
0371. Use secure desktop, lock screen, UAC prompts, credential surfaces, protected media, or DRM-protected content must be skipped or represented as protected/unavailable;?
...
0372. Use local Vision framework OCR/classification or Ocentra local model boundary;?
...
0373. Use protected windows or windows that opt out of sharing may be unavailable or omitted;?
...
0374. Use local OCR/vision through Ocentra-owned local model/provider boundary;?
...
0375. Use available source types vary by backend;?
...
0376. Use on-device ML Kit or Ocentra local model boundary for OCR/image labeling where allowed;?
...
0377. Use third-party parental-control apps should not claim arbitrary hidden screenshot or screen-recording access;?
...
0378. Use exact URL from window title or OCR alone;?
...
0379. Use show screen analysis disabled by default;?
...
0380. Use show capture scope as full screen, active display, active window, managed browser/window, app window, or unavailable;?
...
0382. Use local enforcement-eligible summaries with confidence thresholds;?
...
0383. Use oCR snippets off or bounded/on;?
...
0384. Represent capability Classify visible activity: full screen Broad but sensitive; active window Narrower and usually more relevant; managed browser/window Narrowest for web/app context; local OCR/vision Yes, with confidence; important limit Category is not policy authority..
...
0385. Represent capability Extract OCR snippets: full screen Possible; active window Possible; managed browser/window Possible; local OCR/vision Yes, if enabled; important limit Snippets must be bounded and redacted..
...
0386. Represent capability Prove app/window context: full screen Correlate with foreground evidence; active window Stronger when captured source is a window; managed browser/window Strong if managed session/window id is linked; local OCR/vision No by itself; important limit Capture source ids must be recorded..
...
0387. Represent capability Detect protected surfaces: full screen Platform dependent; active window Platform dependent; managed browser/window Platform dependent; local OCR/vision Not after the fact reliably; important limit Protected/secure/credential states must fail closed..
...
0388. Represent capability Feed local AI: full screen Summary/ref only by default; active window Summary/ref only by default; managed browser/window Summary/ref only by default; local OCR/vision Yes after schema validation; important limit Raw image is not normal AI context-builder input..
...
0389. Represent capability Feed policy: full screen Only via summary/ref; active window Only via summary/ref; managed browser/window Only via summary/ref; local OCR/vision Yes, after validation; important limit Requires parent rule and confidence threshold..
...
0390. Use parent-authored screen analysis settings?
...
0391. Use local OCR/vision analysis?
...
0392. Represent start with domain contracts before Portal UI.
...
0393. Use persist both policy revision and compiled effective policy hash?
...
0394. Represent keep `retainRawCapture` and `hostedProcessingAllowed` false for this schema version.
...
0395. Enable local screen evidence analysis?
...
0396. How should screen analysis be used?
...
0397. Where should screen analysis run?
...
0398. Require managed browser evidence for exact web claims?
...
0399. How may recording frames be used for analysis?
...
0400. How should raw recording data be retained?
...
0401. When may screen analysis run?
...
0402. Require local OCR/vision for screen analysis?
...
0403. Which local analysis tasks are allowed?
...
0404. How many OCR snippets may be retained per summary?
...
0405. What is the maximum length of each retained OCR snippet?
...
0406. What confidence is required before screen summaries can affect policy?
...
0407. What if the local model returns invalid output?
...
0408. Represent condition kind: capabilityAvailable.
...
0409. Show unsupported-scope capability state?
...
0410. Show degraded capability state?
...
0411. Support screen-policy.get.requested?
...
0412. Support screen-policy.patch.requested?
...
0413. Support screen-policy.rollback.requested?
...
0414. Choose agent rule keepPreviousValidRevision.
...
0415. Choose agent rule rollbackOnCompileFailure.
...
0416. Choose agent rule runOcrVisionOnlyInChildAgent.
...
0417. Choose agent rule rejectConfidenceOutsideZeroOne.
...
0418. Choose agent rule rejectRetainRawCaptureForSchemaVersionOne.
...
0419. Choose agent rule rejectExactWebClaimsWithoutManagedBrowserEvidence.
...
0420. Choose fallback permissionDenied.
...
0421. Choose fallback unsupportedScope.
...
0422. Choose fallback platformUnsupported.
...
0423. Choose fallback policyUse.protectedSurfaceFallback.
...
0424. Choose fallback policyUse.invalidOutputFallback.
...
0425. Choose fallback portalAi.fallbackWhenUnavailable.
...
0426. Use short parent test session during setup;?
...
0427. Use full policy replacement during setup/import/reset?
...
0428. Show disabled-by-parent capability state?
...
0429. Support screen-policy.replace.requested?
...
0430. Support screen-policy.manual-test-capture.requested?
...
0431. Represent platform capability and permission check;.
...
0432. Represent platform consent prompts and indicators are common and must not be bypassed;.
...
0433. Represent iOS and Android have especially strong user-consent and OS-policy limits.
...
0434. Use exclude the Ocentra app window where the platform supports exclusion filters;?
...
0435. Use window capture can miss popups, overlays, system prompts, or secondary windows;?
...
0436. Use active window capture can break on virtual desktops, minimized windows, DRM/protected content, or permission changes?
...
0437. Use windows Graphics Capture for display or application-window capture with system UI consent;?
...
0438. Use screenshot or frame capture from an approved display/window scope;?
...
0439. Represent foreground process/window evidence from the Rust agent;.
...
0440. Represent managed browser/window correlation through managed browser evidence and process/window refs.
...
0441. Use consent, notification border, packaged app identity, service/session boundaries, and user desktop state affect what can be captured;?
...
0442. Use service capture from a non-interactive session is not the same as user desktop capture;?
...
0443. Use screenCaptureKit display/app/window streams;?
...
0444. Use macOS Screen Recording permission;?
...
0445. Use process/window correlation where permissions and APIs allow;?
...
0446. Use screen Recording permission, app restart after first grant, sandboxing, app bundle identity, TCC state, and signing/notarization affect real behavior;?
...
0447. Use xDG Desktop Portal ScreenCast for monitors, windows, or virtual sources where a portal backend supports them;?
...
0448. Use pipeWire stream capture on Wayland-backed desktops;?
...
0449. Use x11 screenshot paths where still supported;?
...
0450. Use process/window correlation depending on desktop environment?
...
0451. Use wayland commonly requires a portal-mediated user selection flow;?
...
0452. Use mediaProjection for screen or, on modern Android, selected app-window sharing;?
...
0453. Use foreground service requirements for active capture;?
...
0454. Use usageStats, accessibility, VPN/DNS, device owner, or managed profile only where explicitly approved and enabled;?
...
0455. Represent package lifecycle and policy state from DevicePolicyManager where device-owner/profile-owner setup exists.
...
0456. Use mediaProjection requires user consent and can be revoked;?
...
0457. Use android 14 app-window sharing can restrict capture to a selected app and exclude system UI;?
...
0458. Represent normal apps cannot silently monitor arbitrary screen content in the background as a parental-control agent;.
...
0459. Represent device-owner/profile-owner state changes what is possible;.
...
0460. Use screen capture may be disabled by policy or protected by app/window flags;?
...
0461. Use replayKit for user-initiated app/screen recording or broadcasting flows;?
...
0462. Use replayKit is user-consent oriented and not a stealth child-monitoring API;?
...
0463. Which capture scopes are allowed?
...
0464. What scope should be tried first?
...
0465. What should happen on protected surfaces?
...
0466. Require app or window evidence before policy can use screen summaries?
...
0467. Represent condition kind: platformIn.
...
0468. Represent condition kind: permissionStateIn.
...
0469. Show unsupported-platform capability state?
...
0470. Show permission-required capability state?
...
0471. Show permission-limited capability state?
...
0472. Show protected-surface capability state?
...
0473. Choose fallback permissionRequired.
...
0474. Choose fallback permissionLimited.
