...
export function parentRouteFromHashPath(routeHash: string): ParentRouteId | null {
  const routeHashMarker = ParentHostBridgeRuntime.RouteHashPrefix.slice(0, 1);
  const hashWithoutPrefix = routeHash.startsWith(ParentHostBridgeRuntime.RouteHashPrefix)
    ...
    : routeHash.startsWith(routeHashMarker)
      ? routeHash.slice(routeHashMarker.length)
      : routeHash;
...
export interface ParentRouteLiveActivitySnapshot {
  ...
  readonly activityAppGamePlatformExtensionReadModel?: ParentUnknownRecord | null;
...
export interface ParentAppGameTimerParentSurfacePanelSnapshot {
  ...
  readonly localHandoffArtifactRows: readonly ParentAppGamePanelRowSnapshot[];
  readonly rows: readonly ParentAppGamePanelRowSnapshot[];
  readonly emptyMessage: string;
  readonly productClaim: string;
}
...
export const ParentServiceHealthState = {
  Ready: 'ready',
  Degraded: 'degraded',
  Unavailable: 'unavailable',
} as const;
export type ParentServiceHealthState =
  (typeof ParentServiceHealthState)[keyof typeof ParentServiceHealthState];

export const ParentServiceHealthRoute = {
  Localhost: 'localhost',
  LocalNetwork: 'local-network',
  CloudRelay: 'cloud-relay',
} as const;
export type ParentServiceHealthRoute =
  (typeof ParentServiceHealthRoute)[keyof typeof ParentServiceHealthRoute];

export const ParentServiceHealthTransport = { Websocket: 'websocket' } as const;
export type ParentServiceHealthTransport =
  (typeof ParentServiceHealthTransport)[keyof typeof ParentServiceHealthTransport];

export const ParentServiceHealthAuthenticationState = {
  Authenticated: 'authenticated',
  Unauthenticated: 'unauthenticated',
  Unavailable: 'unavailable',
} as const;
export type ParentServiceHealthAuthenticationState =
  (typeof ParentServiceHealthAuthenticationState)[keyof typeof ParentServiceHealthAuthenticationState];

export const ParentServiceHealthReason = {
  Ready: 'ready',
  TransportUnavailable: 'transport-unavailable',
  RouteDependencyUnavailable: 'route-dependency-unavailable',
  ResponseSchemaMismatch: 'response-schema-mismatch',
  ResponseIdentityMismatch: 'response-identity-mismatch',
  ResponsePayloadMismatch: 'response-payload-mismatch',
  ResponseNonceMismatch: 'response-nonce-mismatch',
  ResponseEventIdMismatch: 'response-event-id-mismatch',
  ResponseTimestampMissing: 'response-timestamp-missing',
  ResponseTimestampStale: 'response-timestamp-stale',
  ServiceVersionMissing: 'service-version-missing',
} as const;
export type ParentServiceHealthReason =
  (typeof ParentServiceHealthReason)[keyof typeof ParentServiceHealthReason];
...
export const ParentDesktopDistributionRuntime = {
  PayloadSource: 'rust-parent-runtime',
  SourceCustodyState: 'source-custody-manual-required',
  ProductClaimState: 'read-only-contract-status-no-execution-owner',
  NoClaim: 'no-installer-updater-rollback-signing-notarization-store-execution',
  PackageFrontendState: 'built-portal-dist',
  PackageServiceManagerState: 'package-installs-auto-start-service',
  PackageHealthProbeState: 'package-health-probe-required',
  PackagePreviewState: 'unsigned-package-preview',
  UpdateChannelState: 'update-channel-scaffold',
  RollbackState: 'rollback-unavailable',
  SigningState: 'signing-manual-required',
  NotarizationState: 'notarization-manual-required',
  StoreDistributionState: 'store-distribution-manual-required',
  PlatformMatrixState: 'platform-matrix-split-proof-rows',
  ReleaseBranchState: 'production-promotion-required',
  ArtifactProofState: 'ci-package-preview-artifact-proof',
  ActionsAvailable: false,
} as const;

export interface ParentDesktopDistributionSnapshot {
  readonly payloadSource: typeof ParentDesktopDistributionRuntime.PayloadSource;
  readonly sourceCustodyState: typeof ParentDesktopDistributionRuntime.SourceCustodyState;
  readonly productClaimState: typeof ParentDesktopDistributionRuntime.ProductClaimState;
  readonly noClaim: typeof ParentDesktopDistributionRuntime.NoClaim;
  readonly packageFrontendState: typeof ParentDesktopDistributionRuntime.PackageFrontendState;
  readonly packageServiceManagerState: typeof ParentDesktopDistributionRuntime.PackageServiceManagerState;
  readonly packageHealthProbeState: typeof ParentDesktopDistributionRuntime.PackageHealthProbeState;
  readonly packagePreviewState: typeof ParentDesktopDistributionRuntime.PackagePreviewState;
  readonly updateChannelState: typeof ParentDesktopDistributionRuntime.UpdateChannelState;
  readonly rollbackState: typeof ParentDesktopDistributionRuntime.RollbackState;
  readonly signingState: typeof ParentDesktopDistributionRuntime.SigningState;
  readonly notarizationState: typeof ParentDesktopDistributionRuntime.NotarizationState;
  readonly storeDistributionState: typeof ParentDesktopDistributionRuntime.StoreDistributionState;
  readonly platformMatrixState: typeof ParentDesktopDistributionRuntime.PlatformMatrixState;
  readonly releaseBranchState: typeof ParentDesktopDistributionRuntime.ReleaseBranchState;
  readonly artifactProofState: typeof ParentDesktopDistributionRuntime.ArtifactProofState;
  readonly actionsAvailable: typeof ParentDesktopDistributionRuntime.ActionsAvailable;
}
