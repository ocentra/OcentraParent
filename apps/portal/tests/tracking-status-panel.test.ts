...
describe('tracking status proof surface', () => {
  ...
  it('summarizes the live service-backed tracking read model without product completion claims', () => {
    ...
    expect(trackingStatusLiveSummary(liveActivity)).toEqual({
      ...
      generatedAt: '2026-06-03T07:25:00Z',
      rowsReturned: '2',
      retentionTombstones: '1',
      lastObserved: '2026-06-03T07:25:00Z',
      eventId: 'tracking-retention-delete-event-1',
      capability: 'recent',
      custody: 'child-device-query-store',
      evidenceReferences: 'retention-tombstone-evidence-1 | tracking-evidence-1',
      deletedEvidence: 'retention-tombstone-evidence-1',
      latestRowKind: 'activity.tracking.retention.deleted',
      latestRowSubject: 'Tracking retention window',
      latestRowSubjectKind: 'retention',
      latestRowSubjectId: 'tracking-retention-window',
      latestRowDevice: 'child-device-1',
      latestRowPlatform: 'android',
      latestRowObserver: 'tracking-engine',
      latestRowEvidenceReferences: 'retention-tombstone-evidence-1',
      parserReason: null,
      productClaim: 'No product claim',
    });
  });
