...
} from '@ocentra-parent/activity-domain/screen-child-disclosure-ux';
      ...
      <article aria-label={title} className={screenChildDisclosureCardClassName()}>
        ...
        <dl className={PortalDom.Classes.TrackingStatusOverlayMeta}>
          <ScreenChildDisclosureDetail
            ...
            value={readableBoolean(proof.hiddenCaptureAllowed)}
          />
          <ScreenChildDisclosureDetail
...
function ScreenChildDisclosureStatusCard({ status }: { readonly status: ScreenChildDisclosureStatus }): ReactElement {
